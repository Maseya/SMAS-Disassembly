...
CODE_0E802D:        AA            TAX                       ;
CODE_0E802E:        BF 6D E0 0F   LDA $0FE06D,x             ;
...
CODE_0E812A:        A9 00 80      LDA #$8000                ;
CODE_0E812D:        85 02         STA $02                   ;
CODE_0E812F:        A0 10         LDY #$10                  ;
CODE_0E8131:        84 04         STY $04                   ;
CODE_0E8133:        A9 00 40      LDA #$4000                ;
...
CODE_0E8216:        AA            TAX                       ;
CODE_0E8217:        BF 80 97 00   LDA $009780,x             ;
...
CODE_0E8243:        AA            TAX                       ;
CODE_0E8244:        BF FF 96 00   LDA $0096FF,x             ;
...
CODE_0E8640:        A8            TAY                       ;
CODE_0E8641:        FA            PLX                       ;
CODE_0E8642:        B9 6D BB      LDA $BB6D,y               ;
CODE_0E8645:        9F 04 20 7F   STA $7F2004,x             ;
CODE_0E8649:        B9 6F BB      LDA $BB6F,y               ;
CODE_0E864C:        9F 06 20 7F   STA $7F2006,x             ;
CODE_0E8650:        B9 71 BB      LDA $BB71,y               ;
CODE_0E8653:        9F 3E 20 7F   STA $7F203E,x             ;
CODE_0E8657:        B9 73 BB      LDA $BB73,y               ;
...
CODE_0E878F:        A8            TAY                       ;
CODE_0E8790:        B9 79 87      LDA $8779,y               ;
...
CODE_0E88B6:        4B            PHK                       ;
CODE_0E88B7:        AB            PLB                       ;
CODE_0E88B8:        B9 A3 88      LDA $88A3,y               ;
...
CODE_0E88DB:        BD EE 88      LDA $88EE,x               ;
CODE_0E88DE:        85 00         STA $00                   ;
CODE_0E88E0:        BD EF 88      LDA $88EF,x               ;
...
CODE_0E8A66:        B9 DC 89      LDA $89DC,y               ;
...
CODE_0E8B6E:        BE 51 8B      LDX $8B51,y               ;
CODE_0E8B71:        B9 48 8B      LDA $8B48,y               ;
CODE_0E8B74:        A8            TAY                       ;
...
DATA_0E8CC3:        db $1B,$1A,$00,$00,$1B,$27,$26,$25
                    db $1B,$2A,$29,$28
...
CODE_0E8CE3:        E8            INX                       ;
CODE_0E8CE4:        B9 C3 8C      LDA $8CC3,y               ;
...
CODE_0E8CF6:        B9 C7 8C      LDA $8CC7,y               ;
CODE_0E8CF9:        9D A1 06      STA $06A1,x               ;
CODE_0E8CFC:        B9 CB 8C      LDA $8CCB,y               ;
...
CODE_0E8D42:        BD 11 9B      LDA $9B11,x               ;
...
CODE_0E8D51:        BD 9F 9A      LDA $9A9F,x               ;
...
CODE_0E8D63:        BD A3 9B      LDA $9BA3,x               ;
...
CODE_0E8F3B:        B9 37 8E      LDA $8E37,y               ;
...
CODE_0E8F5C:        88            DEY                       ;
CODE_0E8F5D:        B9 7F 8E      LDA $8E7F,y               ;
...
CODE_0E8FF1:        BD 0F 9C      LDA $9C0F,x               ;
...
CODE_0E9008:        AA            TAX                       ;
CODE_0E9009:        BD CF 8D      LDA $8DCF,x               ;
CODE_0E900C:        AA            TAX                       ;
CODE_0E900D:        BD 4D 9C      LDA $9C4D,x               ;
...
CODE_0E902A:        BD D3 AB      LDA $ABD3,x               ;
...
CODE_0E904F:        BD FF AB      LDA $ABFF,x               ;
...
CODE_0E9171:        A9 40 91      LDA #$9140                ;
CODE_0E9174:        8D 22 43      STA $4322                 ;
CODE_0E9177:        A2 0E         LDX #$0E                  ;
...
CODE_0E9253:        B9 64 92      LDA $9264,y               ;
...
CODE_0E936A:        BD E7 B4      LDA $B4E7,x               ;
...
CODE_0E938E:        E8            INX                       ;
CODE_0E938F:        BD E7 B4      LDA $B4E7,x               ;
...
CODE_0E98F2:        B9 28 98      LDA $9828,y               ;
...
CODE_0E9954:        B9 38 98      LDA $9838,y               ;
CODE_0E9957:        9D E0 11      STA $11E0,x               ;
CODE_0E995A:        B9 48 98      LDA $9848,y               ;
...
CODE_0EC389:        B9 99 C4      LDA $C499,y               ;
CODE_0EC38C:        18            CLC                       ;
CODE_0EC38D:        6D 60 07      ADC $0760                 ;
CODE_0EC390:        A8            TAY                       ;
CODE_0EC391:        B9 A6 C4      LDA $C4A6,y               ;
CODE_0EC394:        AB            PLB                       ;
CODE_0EC395:        6B            RTL                       ;
...
DATA_0EC4A6:        db $29,$40,$21,$60,$22,$23,$24,$61
...
CODE_0EC61A:        B9 10 C6      LDA $C610,y               ;
CODE_0EC61D:        99 64 9F      STA $9F64,y               ;...I doubt that this really stores to the ROM.
CODE_0EC620:        88            DEY                       ;Nothing jumps here either. What's going on? o_O
