...
CODE_05805F:        LDA $B557,x               ; |
CODE_058062:        STA $04                   ; |
CODE_058064:        INC $02                   ; |increase pointer to read next word next time.
CODE_058066:        INC $02                   ; |
...
CODE_0580CA:        TAX                       ;
CODE_0580CB:        LDA $DB                   ;\
CODE_0580CD:        ASL A                     ; |background to index
CODE_0580CE:        TAY                       ;/
...
CODE_058EDC:        STA $7ED000,x             ;code which is also used as a table??
