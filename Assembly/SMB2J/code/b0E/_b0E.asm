...
; DMA source: DATA_108000
LDA.w #DATA_108000      ; $0E:812A: A9 00 80
STA $02                 ; $0E:812D: 85 02
LDY.b #DATA_108000>>16  ; $0E:812F: A0 10
STY $04                 ; $0E:8131: 84 04

; $4000 bytes to transfer
LDA #$4000              ; $0E:8133: A9 00 40
...
CODE_0E819D:
JSL CODE_0FDA18         ; $0E:819D: 22 18 DA 0F
...
CODE_0E81C0:
INC $075F               ; $0E:81C0: EE 5F 07

CODE_0E81C3:
LDA #$22                ; $0E:81C3: A9 22
...
CODE_0E82B3:
STA $7FF000,x           ; $0E:82B3: 9F 00 F0 7F

CODE_0E82B7:
LDA $96                 ; $0E:82B7: A5 96
CLC                     ; $0E:82B9: 18
...
CODE_0E82D0:
STA $7FF000,x           ; $0E:82D0: 9F 00 F0 7F

CODE_0E82D4:
INC $90                 ; $0E:82D4: E6 90
...
CODE_0E82E4:
JMP CODE_0E8227         ; $0E:82E4: 4C 27 82

CODE_0E82E7:
SEP #$30                ; $0E:82E7: E2 30
...
CODE_0E82EE:
SEP #$10                ; $0E:82EE: E2 10
LDX #$00                ; $0E:82F0: A2 00

CODE_0E82F2:
STZ $05D0,x             ; $0E:82F2: 9E D0 05
...
CODE_0E86E6:
LDA #$2C2E              ; $0E:86E6: A9 2E 2C
LDY #$2C2F              ; $0E:86E9: A0 2F 2C

CODE_0E86EC:
STA $1A06,x             ; $0E:86EC: 9D 06 1A
TYA                     ; $0E:86EF: 98
...
CODE_0E871E:
LDA #$5C                ; $0E:871E: A9 5C

CODE_0E8720:
STA $F3                 ; $0E:8720: 85 F3
...
CODE_0E88A6:
JSL CODE_0DAAA4         ; $0E:88A6: 22 A4 AA 0D
...
CODE_0E8970:
JSR CODE_0E8D11         ; $0E:8970: 20 11 8D
...
CODE_0E8980:
JSR CODE_0E8D11         ; $0E:8980: 20 11 8D
...
CODE_0E8990:
JSR CODE_0E8D11         ; $0E:8990: 20 11 8D
...
CODE_0E89A0:
LDA #$01                ; $0E:89A0: A9 01
BNE CODE_0E89A6         ; $0E:89A2: D0 02

CODE_0E89A4:
LDA #$04                ; $0E:89A4: A9 04

CODE_0E89A6:
JSL CODE_0DAACC         ; $0E:89A6: 22 CC AA 0D
...
CODE_0E8A4A:
JSR CODE_0E8D11         ; $0E:8A4A: 20 11 8D
...
CODE_0E8A66:
LDA DATA_0E89DC,y       ; $0E:8A66: B9 DC 89
...
CODE_0E8AF7:
LDA #$06                ; $0E:8AF7: A9 06
BRA CODE_0E8B01         ; $0E:8AF9: 80 06

CODE_0E8AFB:
LDA #$07                ; $0E:8AFB: A9 07
BRA CODE_0E8B01         ; $0E:8AFD: 80 02

CODE_0E8AFF:
LDA #$09                ; $0E:8AFF: A9 09
...
CODE_0E8B11:
JSR CODE_0E8D11         ; $0E:8B11: 20 11 8D
...
CODE_0E8B5A:
JSR CODE_0E8D11         ; $0E:8B5A: 20 11 8D
...
CODE_0E8B7D:
JSR CODE_0E8D11         ; $0E:8B7D: 20 11 8D
...
CODE_0E8BB9:
JSR CODE_0E8D11         ; $0E:8BB9: 20 11 8D
...
CODE_0E8BDF:
JSR CODE_0E8D11         ; $0E:8BDF: 20 11 8D
...
CODE_0E8C01:
JSR CODE_0E8D11         ; $0E:8C01: 20 11 8D
...
CODE_0E8C2A:
JSR CODE_0E8D11         ; $0E:8C2A: 20 11 8D
...
CODE_0E8C56:
LDA #$EC                ; $0E:8C56: A9 EC

CODE_0E8C58:
STA $06A1,y             ; $0E:8C58: 99 A1 06
...
CODE_0E8C67:
JSR CODE_0E8D11         ; $0E:8C67: 20 11 8D
...
CODE_0E8C80:
LDA #$67                ; $0E:8C80: A9 67
INY                     ; $0E:8C82: C8
INY                     ; $0E:8C83: C8

CODE_0E8C84:
STA $06A1,y             ; $0E:8C84: 99 A1 06
INY                     ; $0E:8C87: C8
...
CODE_0E8D04:
JSR CODE_0E8D11         ; $0E:8D04: 20 11 8D
...
CODE_0E8D42:
LDA DATA_0E9B11,x       ; $0E:8D42: BD 11 9B
...
CODE_0E8D51:
LDA DATA_0E9A9F,x       ; $0E:8D51: BD 9F 9A
...
CODE_0E8D60:
LDX #$0000              ; $0E:8D60: A2 00 00

CODE_0E8D63:
LDA DATA_0E9BA3,x       ; $0E:8D63: BD A3 9B
...
CODE_0E8F50:
JSL CODE_0E8F35         ; $0E:8F50: 22 35 8F 0E
...
CODE_0E8FF1:
LDA DATA_0E9C0F,x       ; $0E:8FF1: BD 0F 9C
...
CODE_0E900D:
LDA DATA_0E9C4D,x       ; $0E:900D: BD 4D 9C
...
CODE_0E902A:
LDA DATA_0EABD3,x       ; $0E:902A: BD D3 AB
...
CODE_0E904F:
LDA DATA_0EABFF,x       ; $0E:904F: BD FF AB
...
CODE_0E909F:
JSL CODE_0E98C3         ; $0E:909F: 22 C3 98 0E
...
CODE_0E91B2:
LDA #$AF                ; $0E:91B2: A9 AF
STA $0EF2               ; $0E:91B4: 8D F2 0E
LDA #$01                ; $0E:91B7: A9 01
STA $0EDE               ; $0E:91B9: 8D DE 0E

CODE_0E91BC:
JSR CODE_0E91C1         ; $0E:91BC: 20 C1 91
PLB                     ; $0E:91BF: AB
RTL                     ; $0E:91C0: 6B

CODE_0E91C1:
LDA $0E65               ; $0E:91C1: AD 65 0E
...
CODE_0E9220:
LDA DATA_0EAD27,y       ; $0E:9220: B9 27 AD
...
CODE_0E9253:
LDA DATA_0E9264,y       ; $0E:9253: B9 64 92
...
CODE_0E92EE:
JSL CODE_0E85D8         ; $0E:92EE: 22 D8 85 0E
...
CODE_0E98F2:
LDA DATA_0E9828,y       ; $0E:98F2: B9 28 98

CODE_0E98F5:
STA $1000               ; $0E:98F5: 8D 00 10
...
CODE_0E9950:
REP #$20                ; $0E:9950: C2 20
LDX #$00                ; $0E:9952: A2 00

CODE_0E9954:
LDA DATA_0E9838,y       ; $0E:9954: B9 38 98
...
CODE_0E9982:
STA $0ED0               ; $0E:9982: 8D D0 0E

CODE_0E9985:
STA $F3                 ; $0E:9985: 85 F3
...
CODE_0E99C4:
LDA #$14                ; $0E:99C4: A9 14

CODE_0E99C6:
STA $01                 ; $0E:99C6: 85 01
...
CODE_0E9A01:
LDA #$10                ; $0E:9A01: A9 10

CODE_0E9A03:
STA $01                 ; $0E:9A03: 85 01
RTS                     ; $0E:9A05: 60

CODE_0E9A06:
REP #$30                ; $0E:9A06: C2 30
...
CODE_0E9A1B:
LDA $7F0000             ; $0E:9A1B: AF 00 00 7F
TAY                     ; $0E:9A1F: A8

CODE_0E9A20:
LDA $00                 ; $0E:9A20: A5 00
...
CODE_0E9A58:
LDX $0EF7               ; $0E:9A58: AE F7 0E
STX $04                 ; $0E:9A5B: 86 04

CODE_0E9A5D:
LDA $7E2000,x           ; $0E:9A5D: BF 00 20 7E
TYX                     ; $0E:9A61: BB
...
DATA_0EC316:
db $38,$11,$0F,$F6,$20,$AD,$40,$3D
db $C7,$FD

DATA_0EC320:
db $10,$00,$0B,$13,$5B,$14,$6A,$42
...
CODE_0EC389:
LDA DATA_0EC499,y       ; $0E:C389: B9 99 C4
CLC                     ; $0E:C38C: 18
...
CODE_0EC3B7:
LDA #$09                ; $0E:C3B7: A9 09
RTS                     ; $0E:C3B9: 60

CODE_0EC3BA:
LDA #$1B                ; $0E:C3BA: A9 1B
RTS                     ; $0E:C3BC: 60
...
CODE_0EC48F:
LDA $42                 ; $0E:C48F: A5 42
BNE CODE_0EC498         ; $0E:C491: D0 05

CODE_0EC493:
LDA #$01                ; $0E:C493: A9 01
...
CODE_0EC61A:
LDA DATA_0EC610,y       ; $0E:C61A: B9 10 C6

; INVALID: ???
STA $9F64,y             ; $0E:C61D: 99 64 9F
DEY                     ; $0E:C620: 88
BPL CODE_0EC61A         ; $0E:C621: 10 F7
RTS                     ; $0E:C623: 60

DATA_0EC624:
db $35,$9D,$55,$9B,$C9,$1B,$59,$9D
db $45,$9B,$C5,$1B,$26,$80,$45,$1B
db $B9,$1D,$F0,$15,$59,$9D,$0F,$08
db $78,$2D,$96,$28,$90,$B5,$FF

DATA_0EC643:
db $74,$80,$F0,$38,$A0,$BB,$40,$BC
...
DATA_0EC66A:
db $0F,$04,$9C,$0C,$0F,$07,$C5,$1B
db $65,$9D,$49,$9D,$5C,$8C,$78,$2D
db $90,$B5,$FF

DATA_0EC67D:
db $49,$9F,$67,$03,$79,$9D,$A0,$3A
...
DATA_0EC75A:
db $C0,$BE,$0F,$03,$38,$0E,$15,$8F
db $AA,$83,$F8,$07,$0F,$07,$96,$10
db $0F,$09,$48,$10,$BA,$03,$FF

DATA_0EC771:
db $87,$85,$A3,$05,$DB,$83,$FB,$03
...
DATA_0EC7C0:
db $E2,$91,$0F,$03,$42,$11,$0F,$06
db $72,$11,$0F,$08,$EE,$02,$60,$02
db $91,$EE,$B3,$60,$D3,$86,$FF

DATA_0EC7D7:
db $0F,$02,$9B,$02,$AB,$02,$0F,$04
...
DATA_0EC84E:
db $09,$A9,$19,$A9,$DE,$42,$02,$7B
db $83,$FF

DATA_0EC858:
db $1E,$A0,$0A,$1E,$23,$2B,$1E,$28
db $6B,$0F,$03,$1E,$40,$08,$1E,$25
db $4E,$0F,$06,$1E,$22,$25,$1E,$25
db $45,$FF

DATA_0EC872:
db $0F,$01,$2A,$07,$2E,$3B,$41,$E9
...
DATA_0EC898:
db $1E,$A7,$6A,$5B,$82,$74,$07,$D8
db $07,$E8,$02,$0F,$04,$26,$07,$FF

DATA_0EC8A8:
db $9B,$07,$0F,$52,$32,$0F,$63,$32
...
DATA_0ED4F5:
db $0F,$02,$28,$10,$E6,$03,$D8,$90
db $0F,$05,$85,$0F,$78,$83,$C8,$10
db $18,$83,$58,$83,$F7,$90,$0F,$0C
db $43,$0F,$73,$8F,$FF

DATA_0ED512:
db $A7,$83,$D7,$03,$0F,$03,$6B,$00
...
DATA_0ED56F:
db $0F,$04,$A3,$10,$0F,$09,$E3,$29
db $0F,$0D,$55,$24,$A9,$24,$0F,$11
db $59,$1D,$A9,$1B,$23,$8F,$15,$9B
db $FF

DATA_0ED588:
db $0F,$01,$DB,$02,$30,$B7,$80,$3B
...
DATA_0ED625:
db $1E,$AF,$CA,$1E,$2C,$85,$0F,$04
db $1E,$2D,$A7,$1E,$2F,$CE,$1E,$35
db $E5,$0F,$07,$1E,$2B,$87,$1E,$30
db $C5,$FF

DATA_0ED63F:
db $0F,$01,$2E,$3B,$A1,$5B,$07,$AB
...
DATA_0ED66F:
db $07,$9B,$0A,$07,$B9,$1B,$66,$9B
db $78,$07,$AE,$67,$E5,$FF

DATA_0ED67D:
db $97,$87,$CB,$00,$EE,$2B,$F8,$FE
db $2D,$AD,$75,$87,$D3,$27,$D9,$27
db $0F,$04,$56,$0F,$FF

DATA_0ED692:
db $9B,$09,$0F,$52,$32,$0F,$63,$32
...
DATA_0EE409:
db $3B,$86,$7B,$00,$BB,$02,$2B,$8E
db $7A,$05,$57,$87,$27,$8F,$9A,$0C
db $FF

DATA_0EE41A:
db $55,$31,$0D,$01,$CF,$F3,$30,$FE
...
DATA_0EE761:
db $0F,$04,$66,$07,$0F,$06,$86,$10
db $0F,$08,$55,$0F,$E5,$8F,$FF

DATA_0EE770:
db $70,$B7,$CA,$00,$66,$80,$0F,$04
...
DATA_0EE89B:
db $BB,$A9,$1B,$A9,$69,$29,$B8,$29
db $59,$A9,$8D,$A8,$0F,$07,$15,$29
db $55,$AC,$6B,$85,$0E,$BE,$01,$67
db $34,$FF

DATA_0EE8B5:
db $1E,$A0,$09,$1E,$27,$67,$0F,$03
db $1E,$28,$68,$0F,$05,$1E,$24,$48
db $1E,$6D,$68,$FF

DATA_0EE8C9:
db $EE,$BE,$21,$26,$87,$F3,$0E,$66
...
DATA_0EF2F6:
db $00,$C1,$4C,$00,$02,$C9,$BA,$49
db $62,$C9,$A4,$20,$A5,$20,$1A,$C9
db $A3,$2C,$B2,$49,$56,$C2,$6E,$00
db $95,$41,$AD,$C7,$FD

DATA_0EF313:
db $48,$8F,$1E,$01,$4E,$02,$00,$8C
