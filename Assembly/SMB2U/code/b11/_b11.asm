...
CODE_118000:
JMP CODE_11803C         ; $11:8000: 4C 3C 80

CODE_118003:
JMP CODE_1191C2         ; $11:8003: 4C C2 91

CODE_118006:
JMP CODE_11956C         ; $11:8006: 4C 6C 95

; No HDMA enable.

CODE_118009:
STZ $023A               ; $11:8009: 9C 3A 02

; Force blank
LDA #$80                ; $11:800C: A9 80

; Jump to $118012.
BRA CODE_118012         ; $11:800E: 80 02

; Full brightness.

CODE_118010:
LDA #$0F                ; $11:8010: A9 0F

; $FE = $2100 mirror.

CODE_118012:
STA $FE                 ; $11:8012: 85 FE

CODE_118014:
LDA $11                 ; $11:8014: A5 11
ASL A                   ; $11:8016: 0A
CLC                     ; $11:8017: 18
ADC $11                 ; $11:8018: 65 11

; $11 = Image upload
; Multiply by 2...
; ... add with $11...
; (Result = Multiply by 3)
; Into X.
TAX                     ; $11:801A: AA
LDA.w PNTR_11C1D0,x     ; $11:801B: BD D0 C1

; Get low byte of image.
; <-- $F0 (Low byte of image pointer)
STA $F0                 ; $11:801E: 85 F0
LDA.w PNTR_11C1D0+1,x   ; $11:8020: BD D1 C1

; Get middle byte of image.
; <-- $F1 (Middle byte of image pointer)
STA $F1                 ; $11:8023: 85 F1
LDA.w PNTR_11C1D0+2,x   ; $11:8025: BD D2 C1

; Get high byte of image.
; <-- $F2 (High byte of image pointer)
STA $F2                 ; $11:8028: 85 F2
STZ $0154               ; $11:802A: 9C 54 01

CODE_11802D:
LDA $0154               ; $11:802D: AD 54 01
...
CODE_118038:
JML CODE_009641         ; $11:8038: 5C 41 96 00
...
;
;
; Prevents SRAM from being expanded.
BNE CODE_118038         ; $11:8054: D0 E2

; Set interrupt disable
SEI                     ; $11:8056: 78

; NMI disabled, IRQ disabled, Auto-Joypad Read disabled.
STZ $4200               ; $11:8057: 9C 00 42

; No HDMA
STZ $420C               ; $11:805A: 9C 0C 42

; No DMA.
STZ $420B               ; $11:805D: 9C 0B 42
STZ $2140               ; $11:8060: 9C 40 21
STZ $2141               ; $11:8063: 9C 41 21
STZ $2142               ; $11:8066: 9C 42 21

; Clear SPC ports.
STZ $2143               ; $11:8069: 9C 43 21
LDA #$80                ; $11:806C: A9 80
...
; Preserve DP register.
PHD                     ; $11:8074: 0B
LDA #$21                ; $11:8075: A9 21
XBA                     ; $11:8077: EB
LDA #$00                ; $11:8078: A9 00

; New DP = $2100
TCD                     ; $11:807A: 5B
LDA #$03                ; $11:807B: A9 03

; Character data = $C000-$FFFF for sprites.
STA $01                 ; $11:807D: 85 01
LDA #$01                ; $11:807F: A9 01

; BG Mode = 01
; <-- $2105
STA $05                 ; $11:8081: 85 05

; $0775 = $2105 mirror.
STA $0775               ; $11:8083: 8D 75 07
STZ $06                 ; $11:8086: 64 06
LDA #$03                ; $11:8088: A9 03
STA $07                 ; $11:808A: 85 07

; Tilemap Layer 1 = $0000-$1FFF.
STA $024C               ; $11:808C: 8D 4C 02
LDA #$13                ; $11:808F: A9 13

; Tilemap Layer 2 = $2000-$3FFF.
STA $08                 ; $11:8091: 85 08
LDA #$4B                ; $11:8093: A9 4B

; Tilemap Layer 3 = $9000-$9FFF.
STA $09                 ; $11:8095: 85 09

; No tilemap Layer 4.
STZ $0A                 ; $11:8097: 64 0A
LDA #$22                ; $11:8099: A9 22

; Character data = $4000-$8FFF for Layers 1 and 2.
STA $0B                 ; $11:809B: 85 0B
LDA #$05                ; $11:809D: A9 05

; Character data = $A000-$BFFF for Layer 3, no character data Layer 4.
STA $0C                 ; $11:809F: 85 0C
LDA #$13                ; $11:80A1: A9 13
STA $2C                 ; $11:80A3: 85 2C

; Layers 1, 2 and object layer on main screen designation.
STA $0243               ; $11:80A5: 8D 43 02

; None on subscreen designation.
STZ $2D                 ; $11:80A8: 64 2D
...
; Color addition select = #$00.
STZ $30                 ; $11:80B4: 64 30

; CGADSUB = #$00 ($2131).
STZ $31                 ; $11:80B6: 64 31
LDA #$E0                ; $11:80B8: A9 E0

; No intensity for fixed colour data ($2132)
...
; Color addition select mirror = #$00.
STZ $0238               ; $11:80C7: 9C 38 02

; CGADSUB mirror = #$00.
STZ $0239               ; $11:80CA: 9C 39 02

; HDMA Enable mirror = #$00.
STZ $023A               ; $11:80CD: 9C 3A 02
STZ $023B               ; $11:80D0: 9C 3B 02
STZ $023C               ; $11:80D3: 9C 3C 02
LDA #$20                ; $11:80D6: A9 20

; No intensity for red colour.
; <-- $023D (One of three mirrors for $2132)
STA $023D               ; $11:80D8: 8D 3D 02
LDA #$40                ; $11:80DB: A9 40

; No intensity for green colour.
; <-- $023E (One of three mirrors for $2132)
STA $023E               ; $11:80DD: 8D 3E 02
LDA #$80                ; $11:80E0: A9 80

; No intensity for blue colour.
; <-- $023F (One of three mirrors for $2132)
STA $023F               ; $11:80E2: 8D 3F 02

; Get old DP register back.
PLD                     ; $11:80E5: 2B
LDA #$FF                ; $11:80E6: A9 FF
STA $0302               ; $11:80E8: 8D 02 03
STA $7F0002             ; $11:80EB: 8F 02 00 7F

; No upload through VRAM tables.
STA $7F0802             ; $11:80EF: 8F 02 08 7F

; V-Count mirror = #$00.
STZ $024B               ; $11:80F3: 9C 4B 02
...
LDA $7FFB00             ; $11:8122: AF 00 FB 7F

; $7FFB00...
; into World number.
STA $0635               ; $11:8126: 8D 35 06
ASL A                   ; $11:8129: 0A
CLC                     ; $11:812A: 18
ADC $7FFB00             ; $11:812B: 6F 00 FB 7F
CLC                     ; $11:812F: 18
ADC $7FFB01             ; $11:8130: 6F 01 FB 7F

; *3
;
; Add $7FFB01 to it...
; (preserved level num?)
; Into accumulative level number.
STA $0533               ; $11:8134: 8D 33 05

; $0533 - 1...
DEC A                   ; $11:8137: 3A

; Into $04E8 (level number after death?)
STA $04E8               ; $11:8138: 8D E8 04
LDA $7FFB02             ; $11:813B: AF 02 FB 7F

; Get preserved live count?
; Into live counter.
STA $04EE               ; $11:813F: 8D EE 04
LDX #$03                ; $11:8142: A2 03

CODE_118144:
LDA $7FFB03,x           ; $11:8144: BF 03 FB 7F
...
CODE_11816B:
LDA #$05                ; $11:816B: A9 05

; Amount of lives...
; after Game Over.
STA $04EE               ; $11:816D: 8D EE 04
BRA CODE_11817F         ; $11:8170: 80 0D

CODE_118172:
LDX $0635               ; $11:8172: AE 35 06
LDA.l DATA_11C9B4,x     ; $11:8175: BF B4 C9 11
STA $0533               ; $11:8179: 8D 33 05

; Get world number into index...
; Get accumulative level number of x-1, where x = world number.
; Store into accumulative level number.
; And here.
STA $04E8               ; $11:817C: 8D E8 04

CODE_11817F:
STZ $0217               ; $11:817F: 9C 17 02
...
CODE_1181A8:
LDA $FE                 ; $11:81A8: A5 FE
AND #$80                ; $11:81AA: 29 80

; Check if force blank...
; <--
; If on, branch.
BNE CODE_1181B5         ; $11:81AC: D0 07
JSR CODE_118AD2         ; $11:81AE: 20 D2 8A
JSL CODE_118009         ; $11:81B1: 22 09 80 11

CODE_1181B5:
LDA #$B0                ; $11:81B5: A9 B0
ORA $0201               ; $11:81B7: 0D 01 02
LDY $EB                 ; $11:81BA: A4 EB

; If horizontal level...
; ...branch, do not run the following two lines.
BNE CODE_1181C3         ; $11:81BC: D0 05
AND #$FE                ; $11:81BE: 29 FE
ORA $0207               ; $11:81C0: 0D 07 02

CODE_1181C3:
STA $FF                 ; $11:81C3: 85 FF
...
JSL CODE_13873D         ; $11:81F7: 22 3D 87 13
JSL CODE_1385DA         ; $11:81FB: 22 DA 85 13
JSL CODE_14E3DE         ; $11:81FF: 22 DE E3 14
JSL CODE_14F64A         ; $11:8203: 22 4A F6 14
JSL CODE_12FAD1         ; $11:8207: 22 D1 FA 12
JSL CODE_12FCF7         ; $11:820B: 22 F7 FC 12
JSL CODE_12FF1A         ; $11:820F: 22 1A FF 12

; Load tiles 200-27F (FG/BG slots).
; Load tiles C0-1FF (FG/BG slots).
; Get sprite data per room into buffer at $1B00.
; Clear Layer 3 tilemap.
JSL CODE_14F500         ; $11:8213: 22 00 F5 14
LDA $0772               ; $11:8217: AD 72 07
BEQ CODE_118220         ; $11:821A: F0 04
LDA #$09                ; $11:821C: A9 09

; If $0772 is any non-zero value...
;
; Make Layer 3 have full priority.
BRA CODE_118222         ; $11:821E: 80 02

CODE_118220:
LDA #$01                ; $11:8220: A9 01

; BG Mode 1.
; No Layer 3 priority.

CODE_118222:
STA $0775               ; $11:8222: 8D 75 07
JSL CODE_12F2EF         ; $11:8225: 22 EF F2 12
JSL CODE_14D0F2         ; $11:8229: 22 F2 D0 14
JSL CODE_138780         ; $11:822D: 22 80 87 13

; Clear all OAM.
JSL CODE_14F9F0         ; $11:8231: 22 F0 F9 14
...
; Don't go to a special screen.
STZ $04ED               ; $11:82A6: 9C ED 04
STZ $02AB               ; $11:82A9: 9C AB 02
STZ $0724               ; $11:82AC: 9C 24 07
LDA $024B               ; $11:82AF: AD 4B 02

; If IRQ V-counter is 00...
; Branch.
BEQ CODE_1182C1         ; $11:82B2: F0 0D
LDA #$18                ; $11:82B4: A9 18

; Load starry BG.
STA $11                 ; $11:82B6: 85 11
LDA $0533               ; $11:82B8: AD 33 05
CMP #$0D                ; $11:82BB: C9 0D
BNE CODE_1182C1         ; $11:82BD: D0 02

; If level 5-2...
; Use a different starry BG (different palette)
;
; <--
...
CODE_1182FF:
JSL CODE_14F9F0         ; $11:82FF: 22 F0 F9 14
...
CODE_118329:
STZ $420C               ; $11:8329: 9C 0C 42

; No NMI/IRQ.
STZ $4200               ; $11:832C: 9C 00 42
...
CODE_1183B0:
STZ $0208               ; $11:83B0: 9C 08 02
LDA #$01                ; $11:83B3: A9 01
STA $0209               ; $11:83B5: 8D 09 02

CODE_1183B8:
LDA $0772               ; $11:83B8: AD 72 07
...
CODE_1183CE:
STZ $020A               ; $11:83CE: 9C 0A 02
LDA #$01                ; $11:83D1: A9 01
STA $020B               ; $11:83D3: 8D 0B 02

CODE_1183D6:
JSL CODE_13FC89         ; $11:83D6: 22 89 FC 13
...
CODE_1183E7:
JSL CODE_118014         ; $11:83E7: 22 14 80 11
...
CODE_11840D:
JSL CODE_14F9F0         ; $11:840D: 22 F0 F9 14
...
CODE_1184CD:
JSL CODE_118014         ; $11:84CD: 22 14 80 11
...
CODE_1184EB:
JSL CODE_118014         ; $11:84EB: 22 14 80 11
...
CODE_118505:
JSL CODE_14DAB8         ; $11:8505: 22 B8 DA 14
...
CODE_118566:
LDA #$70                ; $11:8566: A9 70

CODE_118568:
STA $023A               ; $11:8568: 8D 3A 02
...
CODE_118574:
JSL CODE_14F9F0         ; $11:8574: 22 F0 F9 14
...
CODE_118596:
LDA $EB                 ; $11:8596: A5 EB
BNE CODE_11859D         ; $11:8598: D0 03
JMP CODE_1183E7         ; $11:859A: 4C E7 83

CODE_11859D:
JMP CODE_1182CE         ; $11:859D: 4C CE 82

CODE_1185A0:
JSR CODE_118AD2         ; $11:85A0: 20 D2 8A
...
CODE_1185DC:
JSL CODE_12F394         ; $11:85DC: 22 94 F3 12
...
CODE_11867C:
JSL CODE_118014         ; $11:867C: 22 14 80 11

; Clear all OAM.
JSL CODE_14F9F0         ; $11:8680: 22 F0 F9 14
...
CODE_1186B1:
JSL CODE_14D965         ; $11:86B1: 22 65 D9 14

CODE_1186B5:
STZ $0D0B               ; $11:86B5: 9C 0B 0D
...
; Clear all OAM.
JSL CODE_14F9F0         ; $11:86C8: 22 F0 F9 14
...
; Handle 'simple' objects (such as vegetables). Obj -> M16.
JSL CODE_12FAD1         ; $11:8704: 22 D1 FA 12

CODE_118708:
JSL CODE_12FCF7         ; $11:8708: 22 F7 FC 12
...
CODE_11871F:
JSL CODE_118014         ; $11:871F: 22 14 80 11
...
CODE_11873D:
LDA #$20                ; $11:873D: A9 20

; Colour layer affects backdrop.
; (CGADSUB)

CODE_11873F:
STA $0239               ; $11:873F: 8D 39 02
LDA $024B               ; $11:8742: AD 4B 02

; If IRQ V-counter is 00, branch.
BEQ CODE_118754         ; $11:8745: F0 0D
LDA #$18                ; $11:8747: A9 18

; Load starry BG image.
STA $11                 ; $11:8749: 85 11
LDA $0533               ; $11:874B: AD 33 05
...
;
;
; If so, load starry BG with a different palette.
INC $11                 ; $11:8752: E6 11

; HDMA Handler.

CODE_118754:
JSL CODE_13FC89         ; $11:8754: 22 89 FC 13
...
CODE_11876D:
LDX #$08                ; $11:876D: A2 08

CODE_11876F:
STZ $042F,x             ; $11:876F: 9E 2F 04
DEX                     ; $11:8772: CA
BPL CODE_11876F         ; $11:8773: 10 FA
RTS                     ; $11:8775: 60

CODE_118776:
STY $0D                 ; $11:8776: 84 0D
PLY                     ; $11:8778: 7A
...
CODE_118791:
JSR CODE_1190DF         ; $11:8791: 20 DF 90
...
CODE_1187DB:
STA $11B5               ; $11:87DB: 8D B5 11
LDY #$0C                ; $11:87DE: A0 0C

CODE_1187E0:
LDA #$BF                ; $11:87E0: A9 BF
...
CODE_118834:
LDA #$C0                ; $11:8834: A9 C0
STA $0100               ; $11:8836: 8D 00 01
RTS                     ; $11:8839: 60

CODE_11883A:
STZ $0534               ; $11:883A: 9C 34 05
...
CODE_11886B:
JSR CODE_1190A2         ; $11:886B: 20 A2 90
...
; Clear all OAM.
JSL CODE_14F9F0         ; $11:8881: 22 F0 F9 14
...
CODE_1188E0:
LDA #$80                ; $11:88E0: A9 80
STA $0210               ; $11:88E2: 8D 10 02

CODE_1188E5:
JSL CODE_118014         ; $11:88E5: 22 14 80 11
...
CODE_1188FE:
LDA $0768               ; $11:88FE: AD 68 07
BEQ CODE_11890C         ; $11:8901: F0 09

; Handle object -> M16. (Does not apply to objects that only contain 1 M16 tile, like vegetables.)
JSL CODE_12F4D0         ; $11:8903: 22 D0 F4 12
STZ $0768               ; $11:8907: 9C 68 07
BRA CODE_11890F         ; $11:890A: 80 03

CODE_11890C:
JSR CODE_118AD2         ; $11:890C: 20 D2 8A

CODE_11890F:
JSL CODE_118009         ; $11:890F: 22 09 80 11
...
CODE_118927:
JSL CODE_12FA35         ; $11:8927: 22 35 FA 12
...
CODE_118953:
LDA #$09                ; $11:8953: A9 09

CODE_118955:
STX $11B4               ; $11:8955: 8E B4 11
...
; Clear all OAM.
JSL CODE_14F9F0         ; $11:896B: 22 F0 F9 14

CODE_11896F:
JSL CODE_118014         ; $11:896F: 22 14 80 11
...
CODE_1189C0:
JSL CODE_118014         ; $11:89C0: 22 14 80 11
...
CODE_1189CD:
LDA $FA                 ; $11:89CD: A5 FA
AND #$21                ; $11:89CF: 29 21

; Check if pressing Right or Select.
;
; If neither, branch.
BEQ CODE_1189DD         ; $11:89D1: F0 0A

; Remove the highlight from previous player.
JSR CODE_118AAB         ; $11:89D3: 20 AB 8A

; Move to next character. (Move to the right.)
DEC $8F                 ; $11:89D6: C6 8F
LDA #$01                ; $11:89D8: A9 01

; 'Coin get' sound (when you select between players).
STA $1DE3               ; $11:89DA: 8D E3 1D

CODE_1189DD:
LDA $FA                 ; $11:89DD: A5 FA
AND #$02                ; $11:89DF: 29 02

; Check if pressing Left.
;
; If not, branch.
BEQ CODE_1189ED         ; $11:89E1: F0 0A

; Remove the highlight from previous player.
JSR CODE_118AAB         ; $11:89E3: 20 AB 8A

; Move to previous character. (Move to the left.)
INC $8F                 ; $11:89E6: E6 8F
LDA #$01                ; $11:89E8: A9 01

; 'Coin get' sound (when you select between players).
STA $1DE3               ; $11:89EA: 8D E3 1D

CODE_1189ED:
LDA $8F                 ; $11:89ED: A5 8F
...
CODE_118A25:
LDA.l DATA_15EB41,x     ; $11:8A25: BF 41 EB 15
...
CODE_118A37:
JSL CODE_118014         ; $11:8A37: 22 14 80 11
...
CODE_118A49:
JSL CODE_118014         ; $11:8A49: 22 14 80 11
...
CODE_118A5D:
JSL CODE_118014         ; $11:8A5D: 22 14 80 11
...
CODE_118A84:
LDA #$17                ; $11:8A84: A9 17

; Load byte into VRAM table at $0302 #$17 times.
STA $0712               ; $11:8A86: 8D 12 07
LDY $0300               ; $11:8A89: AC 00 03
LDX $8F                 ; $11:8A8C: A6 8F
LDA.l DATA_15EBA1,x     ; $11:8A8E: BF A1 EB 15
TAX                     ; $11:8A92: AA

CODE_118A93:
LDA.l DATA_15EAE1,x     ; $11:8A93: BF E1 EA 15
STA $0302,y             ; $11:8A97: 99 02 03
INX                     ; $11:8A9A: E8
INY                     ; $11:8A9B: C8
DEC $0712               ; $11:8A9C: CE 12 07

; Get to free area in VRAM table.
; Get player into index.
;
; X = position for the table at which the tilemap for each player starts at.
; Load tilemap byte into table at $0302,y.
;
; Get to next byte in both tables.
;
; Loop until $0712 is sub-zero.
BPL CODE_118A93         ; $11:8A9F: 10 F2
LDA #$FF                ; $11:8AA1: A9 FF

; End table.
STA $0302,y             ; $11:8AA3: 99 02 03
TYA                     ; $11:8AA6: 98

; Amount of bytes the table covers up...
; Into $0300. (Header byte)
STA $0300               ; $11:8AA7: 8D 00 03

; Return.
RTL                     ; $11:8AAA: 6B

CODE_118AAB:
LDA #$17                ; $11:8AAB: A9 17

; Load byte into VRAM table at $0302 #$17 times.
STA $0712               ; $11:8AAD: 8D 12 07
LDY $0300               ; $11:8AB0: AC 00 03
LDX $8F                 ; $11:8AB3: A6 8F
LDA.l DATA_15EBA1,x     ; $11:8AB5: BF A1 EB 15
TAX                     ; $11:8AB9: AA

CODE_118ABA:
LDA.l DATA_11C6AB,x     ; $11:8ABA: BF AB C6 11
STA $0302,y             ; $11:8ABE: 99 02 03
INX                     ; $11:8AC1: E8
INY                     ; $11:8AC2: C8
DEC $0712               ; $11:8AC3: CE 12 07
...
; Amount of bytes the table covers up...
; Into $0300. (Header byte)
STA $0300               ; $11:8ACE: 8D 00 03

; Return.
RTS                     ; $11:8AD1: 60

CODE_118AD2:
STZ $02B7               ; $11:8AD2: 9C B7 02

CODE_118AD5:
JSL CODE_118014         ; $11:8AD5: 22 14 80 11
...
CODE_118AFE:
STZ $02B7               ; $11:8AFE: 9C B7 02
STZ $FE                 ; $11:8B01: 64 FE
STZ $04AE               ; $11:8B03: 9C AE 04

CODE_118B06:
JSL CODE_118014         ; $11:8B06: 22 14 80 11
...
CODE_118B19:
LDA $02B7               ; $11:8B19: AD B7 02
BEQ CODE_118B06         ; $11:8B1C: F0 E8
RTS                     ; $11:8B1E: 60

CODE_118B1F:
LDA $0D13               ; $11:8B1F: AD 13 0D
...
CODE_118B2D:
JSR CODE_11945A         ; $11:8B2D: 20 5A 94
RTL                     ; $11:8B30: 6B

CODE_118B31:
LDY $04ED               ; $11:8B31: AC ED 04
...
CODE_118BB3:
STY $06C2               ; $11:8BB3: 8C C2 06
LDA #$0A                ; $11:8BB6: A9 0A
...
CODE_118C38:
JSL CODE_118014         ; $11:8C38: 22 14 80 11
...
CODE_118CBE:
LDA #$13                ; $11:8CBE: A9 13

; Warp Jar music.
STA $1DE2               ; $11:8CC0: 8D E2 1D

; Clear all OAM.
JSL CODE_14F9F0         ; $11:8CC3: 22 F0 F9 14
LDX #$00                ; $11:8CC7: A2 00
JSL CODE_14D345         ; $11:8CC9: 22 45 D3 14

CODE_118CCD:
JSL CODE_118014         ; $11:8CCD: 22 14 80 11
...
LDY $0635               ; $11:8CE5: AC 35 06

; Store original world number into $0405.
STY $0405               ; $11:8CE8: 8C 05 04
LDA.w DATA_11CDB4,y     ; $11:8CEB: B9 B4 CD

; Get new world number to warp to.
STA $0635               ; $11:8CEE: 8D 35 06

; Into Y.
TAY                     ; $11:8CF1: A8

; Player number into X.
LDX $8F                 ; $11:8CF2: A6 8F
LDA.w DATA_11C9B4,y     ; $11:8CF4: B9 B4 C9
STA $0533               ; $11:8CF7: 8D 33 05

; Get appropiate level number. (x-1)
STA $04E8               ; $11:8CFA: 8D E8 04

; World number to warp to into Y.
TYA                     ; $11:8CFD: 98
SEC                     ; $11:8CFE: 38
SBC #$03                ; $11:8CFF: E9 03
ASL A                   ; $11:8D01: 0A

; Subtract 3 from the value. (There are no 'World X' graphics for Worlds 1-3)
;
; Multiply by 2 since we're going to read from a 16-bit table.
; And back into Y again.
TAY                     ; $11:8D02: A8

; A = 16-bit.
REP #$20                ; $11:8D03: C2 20
LDA.w DATA_11CDBB,y     ; $11:8D05: B9 BB CD
STA $11BD               ; $11:8D08: 8D BD 11
LDA.w DATA_11CDC3,y     ; $11:8D0B: B9 C3 CD
STA $11BF               ; $11:8D0E: 8D BF 11
LDA.w DATA_11CDCB,y     ; $11:8D11: B9 CB CD

; $11BD-$11C2 = Tilemap of number in 'World X'.
; TTTTTTTT YXPCCCTT format.
STA $11C1               ; $11:8D14: 8D C1 11

; A = 8-bit.
SEP #$20                ; $11:8D17: E2 20
...
CODE_118D6F:
JSL CODE_118014         ; $11:8D6F: 22 14 80 11
...
CODE_118D9D:
LDA #$80                ; $11:8D9D: A9 80
STA $1DE2               ; $11:8D9F: 8D E2 1D
LDX $8F                 ; $11:8DA2: A6 8F
LDA $062D,x             ; $11:8DA4: BD 2D 06
CMP #$63                ; $11:8DA7: C9 63

; Indexed by character.
; Check if 'Amount of levels completed', indexed by character...
; Is 99.
; If so, branch, don't increment further.
BEQ CODE_118DAE         ; $11:8DA9: F0 03

; Otherwise, increment amount of levels cleared.
INC $062D,x             ; $11:8DAB: FE 2D 06

CODE_118DAE:
LDA $0533               ; $11:8DAE: AD 33 05
CMP #$13                ; $11:8DB1: C9 13

; Level to trigger ending sequence = 7-2.
;
; If not 7-2, branch.
BNE CODE_118DB8         ; $11:8DB3: D0 03
JMP CODE_11905A         ; $11:8DB5: 4C 5A 90

CODE_118DB8:
STY $06C2               ; $11:8DB8: 8C C2 06
STZ $0217               ; $11:8DBB: 9C 17 02
JSR CODE_118AD2         ; $11:8DBE: 20 D2 8A
JSL CODE_118009         ; $11:8DC1: 22 09 80 11

; Clear all OAM.
JSL CODE_14F9F0         ; $11:8DC5: 22 F0 F9 14
...
CODE_118E03:
JSL CODE_14E30F         ; $11:8E03: 22 0F E3 14
...
CODE_118E23:
JSL CODE_14D84E         ; $11:8E23: 22 4E D8 14
...
CODE_118E5D:
JSL CODE_14CD7D         ; $11:8E5D: 22 7D CD 14
...
CODE_118E6E:
LDA $062B               ; $11:8E6E: AD 2B 06
BNE CODE_118EBE         ; $11:8E71: D0 4B

CODE_118E73:
LDX #$5C                ; $11:8E73: A2 5C
LDA #$00                ; $11:8E75: A9 00

CODE_118E77:
STA $0000,x             ; $11:8E77: 9D 00 00
DEX                     ; $11:8E7A: CA
...
; Clear all OAM.
JSL CODE_14F9F0         ; $11:8EB3: 22 F0 F9 14
...
CODE_118ED5:
JSL CODE_118014         ; $11:8ED5: 22 14 80 11

; Clear all OAM.
JSL CODE_14F9F0         ; $11:8ED9: 22 F0 F9 14
...
CODE_118F05:
JSL CODE_14CDA7         ; $11:8F05: 22 A7 CD 14
...
CODE_118F9F:
STA $0697               ; $11:8F9F: 8D 97 06
LDA #$10                ; $11:8FA2: A9 10
...
CODE_118FB2:
JSL CODE_118014         ; $11:8FB2: 22 14 80 11
...
CODE_119038:
JSL CODE_118014         ; $11:9038: 22 14 80 11
...
CODE_119049:
LDA #$50                ; $11:9049: A9 50
BRA CODE_11904F         ; $11:904B: 80 02

CODE_11904D:
LDA #$A0                ; $11:904D: A9 A0

CODE_11904F:
STA $07                 ; $11:904F: 85 07

CODE_119051:
JSL CODE_118010         ; $11:9051: 22 10 80 11
DEC $07                 ; $11:9055: C6 07
BNE CODE_119051         ; $11:9057: D0 F8
RTS                     ; $11:9059: 60

CODE_11905A:
STZ $0607               ; $11:905A: 9C 07 06
...
; Load layer and sprite graphics for credits.
JSL CODE_1388F5         ; $11:908F: 22 F5 88 13
...
CODE_1190DF:
LDA #$81                ; $11:90DF: A9 81
STA $4200               ; $11:90E1: 8D 00 42
RTS                     ; $11:90E4: 60

CODE_1190E5:
JSL CODE_14F92E         ; $11:90E5: 22 2E F9 14
JSL CODE_13DE8C         ; $11:90E9: 22 8C DE 13

CODE_1190ED:
JSL CODE_138D56         ; $11:90ED: 22 56 8D 13
...
CODE_119155:
LDY #$C0                ; $11:9155: A0 C0

CODE_119157:
CMP #$0A                ; $11:9157: C9 0A
...
CODE_11917F:
LDY #$80                ; $11:917F: A0 80

CODE_119181:
CMP #$0A                ; $11:9181: C9 0A
...
CODE_1191A8:
JSR CODE_1194C7         ; $11:91A8: 20 C7 94
...
CODE_119201:
JSR CODE_1194C7         ; $11:9201: 20 C7 94
...
; Pull normal direct page back.

CODE_11930B:
PLD                     ; $11:930B: 2B
LDA $FE                 ; $11:930C: A5 FE

; $FE = Brightness + Force blank mirror.
STA $2100               ; $11:930E: 8D 00 21
LDA $023A               ; $11:9311: AD 3A 02

; $023A = HDMA enable mirror.
...
CODE_119321:
JSR CODE_11939C         ; $11:9321: 20 9C 93
PHD                     ; $11:9324: 0B
...
CODE_119353:
LDA $7FF800             ; $11:9353: AF 00 F8 7F
...
CODE_11939C:
PHD                     ; $11:939C: 0B
LDA #$0A                ; $11:939D: A9 0A
XBA                     ; $11:939F: EB
LDA #$00                ; $11:93A0: A9 00

; Direct page = #$0A00.
TCD                     ; $11:93A2: 5B
LDY #$1C                ; $11:93A3: A0 1C
...
; Y starts out as #$1C, X as #$70.
TAX                     ; $11:93A8: AA
LDA $23,x               ; $11:93A9: B5 23
ASL A                   ; $11:93AB: 0A
ASL A                   ; $11:93AC: 0A
...
; Get general sprite tile sizes from $0A20-$0A9F into $0A00-$0A1F.
...
; Decrement Y by 4 and loop until transfer done.
BPL CODE_1193A5         ; $11:93F1: 10 B2

; Get DP register back.
PLD                     ; $11:93F3: 2B
...
CODE_119457:
SEP #$30                ; $11:9457: E2 30
RTS                     ; $11:9459: 60

CODE_11945A:
LDX #$44                ; $11:945A: A2 44
...
CODE_1194C4:
SEP #$30                ; $11:94C4: E2 30
RTS                     ; $11:94C6: 60

CODE_1194C7:
LDA $F2                 ; $11:94C7: A5 F2
...
CODE_1195C0:
STZ $02B7               ; $11:95C0: 9C B7 02

CODE_1195C3:
JSL CODE_14F908         ; $11:95C3: 22 08 F9 14
...
CODE_1195D1:
STZ $02B7               ; $11:95D1: 9C B7 02
STZ $FE                 ; $11:95D4: 64 FE

CODE_1195D6:
JSL CODE_14F908         ; $11:95D6: 22 08 F9 14
...
CODE_1195FB:
LDA #$00                ; $11:95FB: A9 00

CODE_1195FD:
STA $2140               ; $11:95FD: 8D 40 21
STA $1DE4               ; $11:9600: 8D E4 1D
STZ $1DEA               ; $11:9603: 9C EA 1D

CODE_119606:
LDA $1DE1               ; $11:9606: AD E1 1D
...
CODE_11961F:
LDA #$00                ; $11:961F: A9 00

CODE_119621:
STA $2141               ; $11:9621: 8D 41 21
AND #$0F                ; $11:9624: 29 0F
STA $1DE5               ; $11:9626: 8D E5 1D
STZ $1DEB               ; $11:9629: 9C EB 1D

CODE_11962C:
LDA $1DE2               ; $11:962C: AD E2 1D
...
DATA_119B3F:
db $04,$0A,$00,$01,$01,$01

DATA_119B45:
db $01,$02,$04,$04,$04,$04,$08,$08
...
DATA_11A400:
db $10,$F4,$0C,$E8,$18,$EC,$14,$F8
db $08,$00

DATA_11A40A:
db $00,$C4,$C4,$B8,$B8,$A8,$A8,$A0
db $A0,$00

DATA_11A414:
db $00,$F0,$E0,$C0,$A0,$80,$60,$40
db $20,$00
...
DATA_11A43B:
db $90,$98,$A0,$A8,$B0,$B8,$C0,$C8
db $00

DATA_11A444:
db $00,$00,$00,$3F,$1A,$1D,$1B,$1D
...
DATA_11AA2B:
db $01,$AC,$00,$0D,$ED,$00,$E1,$00
db $DE,$00,$FB,$00,$DE,$00,$E7,$00
db $DD,$00,$FF

DATA_11AA3E:
db $50,$4F,$CA,$21,$50,$5F,$CC,$21
...
DATA_11AA9C:
db $00,$CC,$00,$0F,$BE,$14,$D6,$15
db $CA,$15,$DB,$15,$D2,$15,$D8,$15
db $BE,$14,$BE,$14,$FF

DATA_11AAB1:
db $00,$CC,$00,$0F,$D9,$15,$DB,$15
db $D2,$15,$D7,$15,$CC,$15,$CE,$15
db $DC,$15,$DC,$15,$FF

DATA_11AAC6:
db $00,$CC,$00,$0F,$BE,$14,$BE,$14
db $DD,$15,$D8,$15,$CA,$15,$CD,$15
db $BE,$14,$BE,$14,$FF

DATA_11AADB:
db $00,$CC,$00,$0F,$BE,$14,$D5,$15
...
PNTR_11AB88:
db $A4,$E4,$24,$64,$A4,$E4,$24

PNTR_11AB8F:
db $C4,$04,$44,$84,$C4,$04,$44

PNTR_11AB96:
db $AB,$AB,$AC,$AC,$AC,$AC,$AD

PNTR_11AB9D:
db $AB,$AC,$AC,$AC,$AC,$AD,$AD
...
PNTR_11B564:
db $72,$96,$BA,$DE,$02,$26,$4A

PNTR_11B56B:
db $B5,$B5,$B5,$B5,$B6,$B6,$B6
...
DATA_11BA9C:
db $BC,$45,$FF,$7F,$63,$0C,$F2,$00
db $DA,$11,$3E,$1B,$9C,$2D,$BF,$3A
db $00,$00,$2F,$15,$A3,$40,$C6,$45

; Mario palette.
; 32 bytes - 16 colours, 2 bytes per colour.
...
DATA_11BBB8:
db $40,$00,$C0,$01,$00,$00,$50,$00
db $40,$00,$C0,$01,$00,$00

DATA_11BBC6:
db $0E,$50,$00,$07,$DA,$15,$BD,$09
...
DATA_11BC51:
db $00,$C6,$40,$26,$FB,$00,$FF

DATA_11BC58:
db $0E,$86,$00,$27,$BD,$09,$BD,$09
...
DATA_11BC85:
db $0E,$8B,$00,$15,$D9,$15,$DE,$15
db $DC,$15,$D1,$15,$BD,$09,$CB,$15
db $DE,$15,$DD,$15,$DD,$15,$D8,$15
db $D7,$15,$FF

DATA_11BCA0:
db $55,$6D,$00,$09,$19,$21,$0A,$21
db $1E,$21,$1C,$21,$0E,$21,$FF

DATA_11BCAF:
db $0E,$86,$40,$26,$BD,$09,$FF

DATA_11BCB6:
db $0E,$89,$00,$1B,$BD,$09,$BD,$09
...
DATA_11BCD7:
db $0E,$AA,$40,$18,$BD,$09,$FF

DATA_11BCDE:
db $FF

DATA_11BCDF:
db $55,$6D,$40,$08,$2F,$21,$FF

DATA_11BCE6:
db $04,$EE,$00,$0D,$BF,$01,$BF,$01
...
DATA_11C0E6:
db $00,$6E,$40,$18,$BF,$00,$00,$8E
db $40,$18,$BF,$00,$FF

DATA_11C0F3:
db $00,$AE,$40,$18,$BF,$00,$00,$CE
db $40,$18,$BF,$00,$FF

DATA_11C100:
db $00,$EF,$40,$16,$BF,$00,$01,$0F
db $40,$16,$BF,$00,$FF

DATA_11C10D:
db $01,$2F,$40,$16,$BF,$00,$01,$50
db $40,$14,$BF,$00,$FF

DATA_11C11A:
db $01,$74,$40,$0C,$BF,$00,$01,$96
...
; 00 - RAM upload table, used for 8x8 tile upload on layer 1

PNTR_11C1D0:
dl $000302

; 01 - RAM upload table, used for various texts in the bonus game and other
dl $001400
dl $000561
...
; 08 - RAM upload table, used for 'World X-X', 'Extra Lifes.'
dl $001168
dl DATA_11BC51
...
; 13 - RAM upload table, used for small moveable vegetable at 'Game Over'
dl $0011C4
dl $00144E
dl DATA_11C88D
dl DATA_11C88D
...
DATA_11C88D:
db $68,$1E,$C0,$3A,$FF,$00,$68,$1F
db $C0,$3A,$FF,$00,$FF

DATA_11C89A:
db $10,$00,$42,$7E,$BF,$00,$14,$00
...
; Format : xxxxxixx. i = Invincible to bombs and shells.
...
DATA_11CE48:
db $00,$00,$06,$06,$0A,$0A,$0B,$0D
db $0E,$11,$11,$12,$12,$12,$12,$13

DATA_11CE58:
db $01,$05,$01,$03,$01,$02,$04,$02
...
DATA_11CE70:
db $7F,$1B,$9F,$03,$CF,$7E

DATA_11CE76:
db $FF,$12,$9F,$03,$CF,$7E

DATA_11CE7C:
db $5F,$12,$9F,$03,$CF,$7E

DATA_11CE82:
db $BF,$15,$9F,$03,$CF,$7E

DATA_11CE88:
db $9F,$03,$DF,$76,$1B,$00

DATA_11CE8E:
db $B9,$30,$B0,$31,$B1,$32,$B2,$33
db $B3,$34

DATA_11CE98:
db $D9,$50,$D0,$51,$D1,$52,$D2,$53
db $D3,$54

DATA_11CEA2:
db $11,$91,$12,$92,$13,$93,$14,$94
db $15,$95
...
DATA_11CF30:
db $05,$04,$04,$04,$05,$07,$04,$02
db $08,$01,$04,$07,$02,$05,$05,$06
db $02,$06,$05,$09

DATA_11CF44:
db $02,$05,$08,$0B,$0E,$11,$13

DATA_11CF4B:
db $04,$06,$08,$07,$05,$06,$05

DATA_11CF52:
db $03,$03,$00,$FF,$FF,$03,$00,$00
...
DATA_11D01A:
db $B9,$00,$30,$70,$B0,$01,$31,$71
db $B1,$02

DATA_11D024:
db $D9,$10,$50,$90,$D0,$11,$51,$91
db $D1,$12

DATA_11D02E:
db $11,$51,$91,$D1,$12,$52,$92,$D2
db $13,$53
...
DATA_11D0AD:
db $51,$72,$C2,$6B,$9D,$BD,$BD,$BD
db $BD,$BD,$FA,$79,$CC,$13,$37,$58
db $58,$58,$58,$58,$58,$09,$20,$A5
db $1A,$1A,$1A,$1A,$1A,$1A,$41,$CF
db $F9,$F9,$1D,$F9,$F9,$F9,$F9,$F9
db $46,$5D,$FD,$45,$90,$B9,$B9,$B9
...
; Low byte of locations...
; ... of the object + level header data.
; This table has 210 slots.
; 10 for each level (10 rooms) - 21 levels (1-1 through 7-2 and unused 7-3)
; Many slots in this pointer table point to the same data.
; That usually implies that those slots (except for the first of the bunch) are unused rooms.
db $AD,$AD

DATA_11D17F:
db $D2,$D2,$D2,$D3,$D3,$D3,$D3,$D3
db $D3,$D3,$D3,$D4,$D4,$D5,$D5,$D5
db $D5,$D5,$D5,$D5,$D5,$D6,$D6,$D6
db $D7,$D7,$D7,$D7,$D7,$D7,$D7,$D7
db $D7,$D7,$D8,$D7,$D7,$D7,$D7,$D7
db $D8,$D8,$D8,$D9,$D9,$D9,$D9,$D9
db $D9,$D9,$D9,$D9,$DA,$DA,$DB,$DB
db $DB,$DB,$DB,$DB,$DB,$DC,$DC,$DC
...
; High byte of locations...
; ... of the object + level header data.
; This pointer table also has 210 slots.
; 10 rooms per level, 21 levels.
; As with the above table, many slots point to the same data.
; Those slots (except the first of them) are very likely unused.
;
; Note: All object data resides in bank 11!
db $F4,$F4
...
; Empty level, clear level. NOT empty data.
db $FF
db $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF
...
db $F5,$F5,$F5,$F5,$F5,$F6,$F6,$F6

; High byte of pointer to high byte of room pointers of sprite data, indexed by level number.
; ...or basically, a pointer to 20 different kinds of pointers. (Each which has 10 bytes, one per room.)
; Somewhat confusing at first, but after looking a bit at it you will get it.
db $F6,$F6,$F6,$F6,$F6

DATA_11F4D0:
db $0F,$23,$37,$4B,$5F,$73,$87,$9B
db $AF,$C3,$D7,$EB,$FF,$13,$27,$3B
...
DATA_11F4E5:
db $F5,$F5,$F5,$F5,$F5,$F5,$F5,$F5
db $F5,$F5,$F5,$F5,$F6,$F6,$F6,$F6

; High byte of pointer to low byte of room pointers of sprite data, indexed by level number.
db $F6,$F6,$F6,$F6,$F6

DATA_11F4FA:
db $19,$2D,$41,$55,$69,$7D,$91,$A5
db $B9,$CD,$E1,$F5,$09,$1D,$31,$45

; Low byte of pointer to low byte of room pointers of sprite data, indexed by level number.
db $59,$6D,$81,$95,$A9
db $F6,$F6,$F6,$F7,$F7,$F7,$F7,$F7

; High byte of pointers, indexed per room, level 1-1.
db $F7,$F7
db $B3,$BC,$D1,$0E,$14,$19,$19,$19

; Low byte of pointers, indexed per room, level 1-1.
db $19,$19
db $F7,$F7,$F7,$F7,$F7,$F7,$F7,$F7

; High byte of pointers, indexed per room, level 1-2.
db $F7,$F7
db $25,$45,$54,$5E,$64,$71,$71,$71

; Low byte of pointers, indexed per room, level 1-2.
db $71,$71
db $F7,$F7,$F7,$F7,$F7,$F7,$F7,$F7

; High byte of pointers, indexed per room, level 1-3.
db $F7,$F7
db $74,$A9,$B1,$CB,$EE,$EE,$EE,$EE

; Low byte of pointers, indexed per room, level 1-3.
db $EE,$EE
db $F7,$F8,$F8,$F8,$F8,$F8,$F8,$F8

; High byte of pointers, indexed per room, level 2-1.
db $F8,$F8
db $F5,$14,$25,$25,$2F,$25,$25,$25

; Low byte of pointers, indexed per room, level 2-1.
db $25,$25
db $F8,$F8,$F8,$F8,$F8,$F8,$F8,$F8

; High byte of pointers, indexed per room, level 2-2.
db $F8,$F8
db $3C,$47,$76,$85,$98,$A5,$A5,$A5

; Low byte of pointers, indexed per room, level 2-2.
db $A5,$A5
db $F8,$F8,$F8,$F8,$F8,$F9,$F9,$F9

; High byte of pointers, indexed per room, level 2-3.
db $F9,$F9
db $AF,$B3,$CE,$D1,$F3,$00,$20,$27

; Low byte of pointers, indexed per room, level 2-3.
db $27,$27
db $F9,$F9,$F9,$F9,$F9,$F9,$F9,$F9

; High byte of pointers, indexed per room, level 3-1.
db $F9,$F9
db $30,$33,$4E,$52,$63,$6E,$6E,$6E

; Low byte of pointers, indexed per room, level 3-1.
db $6E,$6E
db $F9,$F9,$F9,$F9,$F9,$F9,$F9,$F9

; High byte of pointers, indexed per room, level 3-2.
db $F9,$F9
db $6E,$91,$AA,$B5,$BA,$BA,$BA,$BA

; Low byte of pointers, indexed per room, level 3-2.
db $BA,$BA
db $F9,$F9,$F9,$F9,$FA,$FA,$FA,$FA

; High byte of pointers, indexed per room, level 3-3.
db $FA,$FA
db $BA,$BF,$CE,$E1,$14,$30,$3D,$49

; Low byte of pointers, indexed per room, level 3-3.
db $5D,$5D
db $FA,$FA,$FA,$FA,$FA,$FA,$FA,$FA

; High byte of pointers, indexed per room, level 4-1.
db $FA,$FA
db $67,$96,$B7,$B7,$B7,$B7,$B7,$B7

; Low byte of pointers, indexed per room, level 4-1.
db $B7,$B7
db $FA,$FA,$FB,$FB,$FB,$FB,$FB,$FB

; High byte of pointers, indexed per room, level 4-2.
db $FB,$FB
db $E5,$EA,$31,$58,$63,$63,$63,$63

; Low byte of pointers, indexed per room, level 4-2.
db $63,$63
db $FB,$FB,$FB,$FB,$FB,$FB,$FB,$FB

; High byte of pointers, indexed per room, level 4-3.
db $FC,$FC
db $72,$76,$85,$AC,$C5,$D0,$E3,$F6

; Low byte of pointers, indexed per room, level 4-3.
db $03,$0E
db $FC,$FC,$FC,$FC,$FC,$FC,$FC,$FC

; High byte of pointers, indexed per room, level 5-1.
db $FC,$FC
db $19,$23,$4C,$55,$55,$55,$55,$55

; Low byte of pointers, indexed per room, level 5-1.
db $55,$55
db $FC,$FC,$FC,$FC,$FC,$FC,$FC,$FC

; High byte of pointers, indexed per room, level 5-2.
db $FC,$FC
db $55,$5A,$91,$AA,$B6,$BF,$CB,$CB

; Low byte of pointers, indexed per room, level 5-2.
db $CB,$CB
db $FC,$FC,$FC,$FD,$FD,$FD,$FD,$FD

; High byte of pointers, indexed per room, level 5-3.
db $FD,$FD
db $CB,$D0,$EF,$01,$1F,$40,$40,$40

; Low byte of pointers, indexed per room, level 5-3.
db $40,$40
db $FD,$FD,$FD,$FD,$FD,$FD,$FD,$FD

; High byte of pointers, indexed per room, level 6-1.
db $FD,$FD
db $45,$70,$7F,$89,$96,$A5,$AE,$AE

; Low byte of pointers, indexed per room, level 6-1.
db $AE,$AE
db $FD,$FD,$FD,$FD,$FD,$FD,$FD,$FD

; High byte of pointers, indexed per room, level 6-2.
db $FD,$FD
db $B2,$B7,$EC,$EC,$EC,$EC,$EC,$EC

; Low byte of pointers, indexed per room, level 6-2.
db $EC,$EC
db $FD,$FD,$FE,$FE,$FE,$FE,$FE,$FE

; High byte of pointers, indexed per room, level 6-3.
db $FE,$FE
db $F6,$FA,$08,$23,$50,$55,$5E,$5E

; Low byte of pointers, indexed per room, level 6-3.
db $5E,$5E
db $FE,$FE,$FE,$FE,$FE,$FE,$FE,$FE

; High byte of pointers, indexed per room, level 7-1.
db $FE,$FE
db $63,$67,$93,$A8,$BD,$C6,$C6,$C6

; Low byte of pointers, indexed per room, level 7-1.
db $C6,$C6
db $FE,$FE,$FE,$FF,$FF,$FF,$FF,$FF

; High byte of pointers, indexed per room, level 7-2.
db $FF,$FF
db $CC,$D8,$F4,$15,$2E,$53,$5B,$86

; Low byte of pointers, indexed per room, level 7-2.
db $A5,$CB
db $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF

; High byte of pointers, indexed per room, level 7-3. (Unused.)
db $FF,$FF
db $D6,$D7,$D8,$D9,$DA,$DA,$DA,$DA

; Low byte of pointers, indexed per room, level 7-3. (Unused.)
db $DA,$DA
db $01,$01,$05,$03,$76,$03,$6C,$01

; Sprite data. First room, level 1-1. (Vertical room where you fall from one door.)
; Total amount of sprites: 2.
db $01
db $05,$14,$56,$14,$AD,$03,$03,$9D
db $07,$0E,$83,$0E,$79,$03,$BC,$05

; Sprite data.
; Vertical room leading up to Birdo, level 1-1.
; Total amount of sprites: 8.
db $0E,$90,$0E,$75,$01
db $03,$01,$EC,$07,$01,$1C,$02,$5C
db $03,$E5,$07,$01,$6C,$02,$8C,$01
db $CC,$05,$03,$79,$01,$D4,$09,$01
...
; Sprite data.
; Main room, level 1-1.
; Total amount of sprites: 25.
db $01,$95,$14,$D1,$01

; Sprite data. Top room inside cave, level 1-1. Total amount of sprites: 1.
db $03,$03,$85,$01,$01,$01

; Sprite data. Bottom room inside cave, level 1-1. Total amount of sprites: 1.
db $03,$0E,$BC,$01,$01
db $01,$01,$07,$1C,$A7,$44,$A8,$43

; Sprite data. Birdo room, level 1-1.
; Total amount of sprites: 3.
db $E7,$01,$01,$01
db $03,$42,$6A,$03,$12,$22,$09,$0F
db $00,$0F,$40,$0F,$90,$0F,$E0,$01
db $05,$0E,$3C,$0E,$6C,$05,$06,$53

; Sprite data.
; Main room (outside), level 1-2.
; Total amount of sprites: 12.
db $0D,$83,$05,$01,$B6,$01,$F6,$01
db $03,$01,$DC,$03,$07,$3C,$03,$06

; Sprite data. Cave room, level 1-2.
; Total amount of sprites: 5.
db $2C,$05,$0D,$79,$0D,$89,$01
db $01,$05,$1C,$A7,$44,$A8,$03,$43

; Sprite data. Birdo room, level 1-2.
; Total amount of sprites: 3.
db $38,$01

; Sprite data. Jar room with key, level 1-2. Total amount of sprites: 2.
db $05,$3D,$79,$17,$77,$01
db $01,$01,$01,$01,$01,$01,$01,$01

; Sprite data. Jar room with 1-Up, level 1-2.
; Total amount of sprites: 1.
db $01,$01,$03,$02,$28

; Unused.
db $01,$01,$01
db $03,$42,$38,$05,$07,$94,$07,$B4
db $03,$01,$74,$05,$13,$34,$13,$A4
db $07,$13,$02,$13,$62,$3B,$E6,$05
...
; Sprite data.
; Main room, level 1-3.
; Total amount of sprites: 21.
db $7A,$02,$9A,$01,$01

; Sprite data. Room with key, level 1-3. Total amount of sprites: 3.
db $07,$17,$83,$3D,$88,$2E,$8A,$01
db $07,$2E,$4B,$30,$7C,$30,$C9,$01
db $07,$30,$61,$31,$5A,$03,$BA,$03
db $01,$DB,$03,$06,$4A,$03,$03,$35

; Sprite data.
; First (vertical) castle chamber, level 1-3.
; Total amount of sprites: 9.
db $01,$01
db $03,$31,$C9,$03,$2F,$C6,$09,$02
db $56,$07,$D4,$07,$D7,$07,$DA,$05
db $30,$A7,$30,$F7,$05,$2E,$3A,$2E
db $6A,$09,$0D,$09,$0D,$29,$44,$A8

; Sprite data.
; Second (horizontal) castle chamber, level 1-3.
; Total amount of sprites: 14.
db $43,$D7,$01

; Sprite data. Mouser/boss room, level 1-3. Total amount of sprites: 2.
db $03,$30,$F6,$03,$5D,$D7,$01
db $01,$03,$19,$FA,$03,$18,$A7,$05
db $01,$69,$03,$99,$03,$18,$47,$03
db $03,$F8,$01,$07,$23,$24,$01,$27

; Sprite data.
; Main room (outside in the desert), level 2-1.
; Total amount of sprites: 10.
db $01,$49,$03,$19,$4A,$01,$01
db $05,$01,$49,$01,$6D,$03,$01,$D3
db $07,$01,$40,$06,$16,$01,$C8,$01

; Sprite data.
; Inside the pyramid, level 2-1.
; Total amount of sprites: 6.
db $01
db $01,$05,$1C,$A8,$44,$A9,$03,$43

; Sprite data. Birdo room, level 2-1.
; Total amount of sprites: 3.
db $D3,$01
db $01,$01,$01,$01,$01,$01,$01,$01

; Sprite data. Jar room (Snifit), level 2-1.
; Total amount of sprites: 1.
db $01,$01,$03,$06,$6C
db $03,$42,$5A,$01,$01,$01,$01,$01

; Sprite data. First room, level 2-2.
; Total amount of sprites: 1.
db $01,$01,$01
db $01,$03,$19,$8D,$05,$0F,$50,$18
db $FA,$03,$01,$99,$05,$18,$0A,$18
db $37,$07,$0F,$10,$18,$15,$3B,$97
db $07,$18,$58,$18,$A8,$18,$E7,$09
db $18,$28,$18,$57,$1A,$86,$18,$97

; Sprite data.
; Main room (outside in the desert), level 2-2.
; Total amount of sprites: 18.
db $03,$23,$B5,$03,$23,$05,$01
db $07,$03,$B8,$03,$F8,$03,$FB,$01

; Sprite data. Cave room with extras, level 2-2.
; Total amount of sprites: 3.
db $01,$01,$01,$01,$01,$01,$01
db $03,$01,$8A,$05,$01,$C2,$01,$67
db $07,$0E,$A0,$01,$78,$01,$BD,$03

; Sprite data.
; Inside the pyramid, level 2-2.
; Total amount of sprites: 7.
db $06,$E2,$01
db $01,$01,$01,$01,$01,$01,$01,$01

; Sprite data. Jar room, level 2-2.
; Total amount of sprites: 1.
db $01,$01,$03,$01,$B9
db $01,$05,$1C,$B4,$44,$B4,$03,$43

; Sprite data. Birdo room, level 2-2.
; Total amount of sprites: 3.
db $B3,$01

; Sprite data. Trapped in the sand (first room), level 2-3. Total amount of sprites: 1.
db $03,$42,$17,$01
db $03,$03,$C7,$03,$49,$20,$05,$0F
db $20,$48,$A0,$01,$01,$03,$48,$80
db $01,$03,$49,$00,$05,$19,$7A,$1A
...
; Cave room with extras, level 2-3. No sprites used.
db $01,$01,$01
db $03,$03,$4B,$05,$01,$D5,$01,$AA
db $05,$03,$D2,$01,$D5,$03,$02,$88
db $07,$01,$83,$01,$A9,$01,$1D,$07
db $01,$B1,$01,$89,$01,$3D,$03,$01

; Sprite data.
; Inside the pyramid, level 2-3.
; Total amount of sprites: 13.
db $E3,$01
db $01,$01,$01,$01,$01,$01,$01,$01

; Sprite data. Jar room, level 2-3.
; Total amount of sprites: 1.
db $01,$01,$03,$01,$B9
db $01,$09,$01,$15,$01,$08,$01,$F8
db $01,$CB,$01,$07,$23,$14,$03,$39
db $03,$7B,$03,$18,$67,$07,$18,$0A

; Sprite data.
; Room leading to the boss, level 2-3.
; Total amount of sprites: 12
db $44,$3B,$18,$6A,$03,$43,$97,$01

; Sprite data. Triclyde boss room, level 2-3. Total amount of sprites: 2.
db $01,$05,$5F,$C5,$02,$D0,$01
db $07,$17,$83,$3D,$87,$2F,$A9,$01

; Sprite data. Key room, level 2-3.
db $01

; First room, level 3-1. No sprites used.
db $01,$01,$01
db $03,$49,$08,$03,$48,$0E,$03,$48
db $02,$05,$12,$92,$49,$09,$03,$03
db $E5,$05,$03,$21,$03,$87,$01,$01

; Sprite data.
; Big waterfall room, level 3-1.
; Total amount of sprites: 8.
db $01,$01,$01

; Secret warp room, level 3-1. No sprites used.
db $01,$01,$01,$01
db $01,$03,$03,$2B,$03,$25,$12,$03
db $23,$95,$03,$03,$65,$03,$24,$05

; Sprite data.
; Up in the clouds, level 3-1.
; Total amount of sprites: 5.
db $01
db $01,$07,$43,$93,$1C,$B9,$44,$BA

; Sprite data. Birdo room, level 3-1.
; Total amount of sprites: 3.
db $01,$01,$01
db $05,$42,$42,$49,$40,$05,$08,$25
db $48,$C0,$01,$03,$48,$00,$05,$25
db $E6,$49,$80,$01,$05,$08,$35,$08
db $55,$05,$06,$A4,$06,$CB,$01,$03

; Sprite data.
; Main room (outside), level 3-2.
; Total amount of sprites: 12.
db $06,$96,$01
db $07,$04,$3C,$04,$6C,$04,$EC,$03
db $04,$1C,$01,$01,$03,$03,$29,$07
db $02,$29,$02,$49,$02,$6C,$01,$01

; Sprite data.
; Main room (underground), level 3-2.
; Total amount of sprites: 8.
db $01
db $05,$1C,$B6,$44,$B6,$03,$43,$FA

; Sprite data. Birdo room, level 3-2.
; Total amount of sprites: 3.
db $01,$01,$01

; Sprite data. Unused room (belonging to level 3-2). Total amount of sprites: 1.
db $01,$03,$5C,$C7,$01

; Sprite data. First room, level 3-3. Total amount of sprites: 1.
db $03,$42,$4A,$01,$01
db $01,$01,$07,$0A,$14,$08,$58,$0A

; Sprite data. Outside the fort, level 3-3.
; Total amount of sprites: 3.
db $84,$01,$01,$01,$01,$01,$01
db $03,$31,$65,$05,$0E,$75,$0E,$95
db $09,$30,$05,$31,$55,$0D,$AC,$0D

; Sprite data.
; Fort hall, first chamber, level 3-3.
; Total amount of sprites: 7.
db $CC,$01,$01
db $01,$09,$31,$72,$2E,$84,$2E,$B7
db $30,$4C,$07,$2E,$81,$2F,$1A,$31
db $DF,$07,$2E,$35,$2E,$96,$2E,$18
db $03,$31,$71,$03,$31,$CF,$07,$2F
db $20,$31,$70,$2E,$7E,$07,$2F,$71
db $30,$8D,$31,$7F,$05,$30,$34,$30

; Sprite data.
; Vertical room #1 (the one which is not directly suitable for advancing to a higher part), level 3-3.
; Total amount of sprites: 20.
db $C7,$01,$01
db $03,$06,$6C,$05,$23,$8D,$23,$CD
db $05,$02,$57,$02,$ED,$01,$05,$05
db $C2,$07,$3B,$05,$07,$C4,$03,$3D

; Sprite data.
; Vertical room #2 (leading to the outside part), level 3-3.
; Total amount of sprites: 10.
db $03,$0E,$D6,$01
db $03,$15,$6F,$03,$15,$6B,$03,$15

; Sprite data. Vertical room #3 with Shy Guy generators, level 3-3.
; Total amount of sprites: 4.
db $67,$03,$15,$63,$01
db $0B,$31,$73,$2F,$84,$31,$79,$17

; Sprite data. Key room, level 3-3.
; Total amount of sprites: 5.
db $87,$3D,$89,$01
db $01,$05,$0E,$C9,$0E,$E9,$03,$0D
db $E9,$05,$0D,$09,$0D,$29,$05,$44

; Sprite data.
; Outside on roof part, level 3-3.
; Total amount of sprites: 7.
db $6B,$43,$AA,$01
db $03,$2F,$22,$05,$2F,$62,$5D,$D6

; Sprite data. Mouser boss room, level 3-3.
; Total amount of sprites: 3.
db $01,$01
db $01,$05,$29,$96,$13,$B2,$03,$13
db $22,$0B,$29,$09,$29,$29,$13,$35
db $29,$D9,$29,$F6,$01,$09,$29,$46
db $29,$98,$29,$A6,$29,$F8,$05,$13
db $13,$29,$B8,$05,$29,$08,$29,$B5

; Sprite data.
; First icy room, level 4-1.
; Total amount of sprites: 18.
db $05,$29,$35,$13,$41,$01,$01
db $01,$01,$03,$26,$58,$01,$07,$29
db $0A,$26,$58,$29,$9A,$05,$29,$3A
db $29,$DC,$03,$26,$F6,$01,$05,$29
db $3C,$26,$D7,$05,$44,$85,$43,$D4

; Sprite data.
; Second icy room, level 4-1.
; Total amount of sprites: 11.
db $01
db $01,$03,$5C,$B8,$01,$01,$01,$01
db $01,$01,$01,$01,$01,$01,$01,$01
db $01,$01,$01,$01,$01,$01,$01,$01
db $01,$01,$01,$01,$01,$01,$01,$01
db $01,$01,$01,$01,$01,$01,$01,$01
...
; Sprite data.
; Unused (4-1). Perhaps intended for a Birdo fight?
; Would be feasible because 4-1 normally lacks a Birdo fight.
; Total amount of sprites: 1.
db $01,$01,$01,$01,$01,$01

; Sprite data. First room, 4-2. Total amount of sprites: 1.
db $03,$42,$47,$01,$01
db $05,$10,$D3,$10,$F5,$03,$10,$D8
db $09,$10,$16,$10,$37,$10,$44,$10
db $78,$0B,$10,$67,$10,$98,$10,$C7
...
; Sprite data.
; Detestable Beezo-fest room, level 4-2.
; Total amount of sprites: 30.
db $23,$10,$66,$29,$B8,$01,$01
db $01,$03,$28,$6A,$05,$28,$7A,$28
db $FA,$01,$03,$28,$DA,$05,$28,$69
db $07,$98,$09,$28,$2A,$03,$39,$28
db $BA,$03,$C9,$05,$28,$69,$03,$88

; Sprite data.
; Whale room, level 4-2.
; Total amount of sprites: 14.
db $05,$28,$A9,$29,$D3,$01,$01
db $01,$03,$26,$C7,$01,$05,$04,$99

; Sprite data. Spikes, level 4-2.
; Total amount of sprites: 3.
db $04,$C9,$01
db $01,$05,$1C,$B8,$44,$B9,$03,$43

; Sprite data. Birdo room, level 4-2.
; Total amount of sprites: 3.
db $BA,$01,$01,$01,$01,$01,$01

; Sprite data. First room, level 4-3. Total amount of sprites: 1.
db $03,$42,$2A,$01
db $01,$03,$1C,$A9,$01,$01,$01,$01

; Sprite data. Outside room, level 4-3.
; Total amount of sprites: 2.
db $01,$01,$01,$03,$10,$18,$01
db $09,$29,$EA,$29,$EC,$29,$DE,$29
db $EE,$03,$29,$EE,$05,$29,$E0,$29
db $E2,$03,$29,$8C,$09,$29,$92,$29
db $B2,$29,$E9,$29,$EB,$05,$29,$71

; Sprite data.
; Vertical room up, level 4-3.
; Total amount of sprites: 14.
db $29,$E4,$01,$01,$01,$01,$01
db $07,$01,$C8,$03,$D8,$02,$E8,$01
db $01,$01,$07,$29,$72,$29,$82,$29
db $7E,$01,$03,$29,$C1,$01,$01,$01

; Sprite data.
; Vertical room down, level 4-3.
; Total amount of sprites: 7.
db $01
db $01,$01,$01,$01,$01,$01,$01,$01

; High up the castle outside, level 4-3.
; No sprites used.
db $01,$01,$01
db $09,$17,$72,$3D,$74,$29,$57,$29
db $97,$01,$01,$01,$01,$01,$01,$01

; Sprite data.
; Key room, level 4-3.
; Total amount of sprites: 4.
db $01,$01,$01
db $05,$29,$65,$29,$95,$05,$44,$2A
db $43,$87,$01,$01,$01,$01,$01,$01

; Sprite data.
; Penultimate room, level 4-3.
; Total amount of sprites: 4.
db $01,$01,$01
db $03,$6A,$24,$01,$01,$01,$01,$01

; Sprite data. Fryguy boss room, level 4-3.
; Total amount of sprites: 1.
db $01,$01,$01,$01,$01
db $01,$01,$01,$01,$01,$01,$01,$01

; Sprite data. Unused (4-3).
db $01,$01,$01
db $01,$01,$01,$01,$01,$01,$01,$01

; Sprite data. Unused (4-3).
db $01,$01,$01
db $03,$42,$31,$03,$08,$45,$03,$23

; Sprite data. Outside room, level 5-1.
; Total amount of sprites: 3.
db $56,$01
db $01,$03,$3B,$E4,$09,$3B,$34,$3B
db $84,$13,$B2,$3B,$D4,$05,$13,$82
db $13,$C2,$05,$13,$02,$3B,$A4,$07
db $13,$42,$13,$82,$13,$C2,$03,$13
db $B2,$05,$3B,$94,$3B,$E4,$01,$01

; Sprite data.
; Cave room, level 5-1.
; Total amount of sprites: 15.
db $01
db $05,$1C,$C4,$44,$C5,$03,$43,$CA

; Sprite data. Birdo room, level 5-1.
; Total amount of sprites: 3.
db $01

; Sprite data. First room, level 5-2. Total amount of sprites: 1.
db $03,$42,$2A,$01,$01
db $01,$07,$14,$78,$14,$96,$14,$B8
db $09,$08,$29,$14,$D6,$14,$E6,$14
db $F6,$01,$09,$04,$8C,$04,$9C,$08
...
; Sprite data.
; Main room, level 5-2.
; Total amount of sprites: 22.
db $46,$05,$04,$6A,$08,$99,$01
db $03,$14,$8B,$09,$10,$F2,$14,$68
db $14,$8E,$06,$DE,$0B,$10,$02,$06
db $C5,$06,$36,$10,$8E,$10,$DE,$01

; Sprite data.
; Going up into the sky, level 5-2.
; Total amount of sprites: 11.
db $01
db $01,$01,$01,$01,$01,$01,$05,$13

; Sprite data. Falling from the sky, level 5-2.
; Total amount of sprites: 2.
db $55,$13,$85,$01
db $03,$01,$2B,$05,$04,$24,$04,$B4

; Sprite data. Jar room, level 5-2.
; Total amount of sprites: 3.
db $01
db $01,$07,$13,$73,$1C,$B8,$44,$B9

; Sprite data. Birdo room, level 5-2.
; Total amount of sprites: 4.
db $03,$43,$B4,$01

; Sprite data. First room, level 5-2. Total amount of sprites: 1.
db $03,$42,$3A,$01,$01
db $03,$49,$80,$01,$03,$47,$00,$01
db $03,$47,$40,$03,$49,$C0,$03,$49
db $C0,$07,$09,$2C,$09,$7C,$09,$AC

; Sprite data.
; Main room outside, level 5-3.
; Total amount of sprites: 10.
db $01,$05,$09,$58,$09,$78,$01
db $01,$05,$23,$36,$09,$C6,$03,$09
db $36,$05,$09,$25,$09,$45,$03,$16

; Sprite data.
; First chamber of fort (with the huge tree), level 5-3.
; Total amount of sprites: 6.
db $A5,$01
db $01,$05,$24,$52,$24,$3D,$01,$09
db $09,$90,$09,$B0,$2F,$D5,$30,$4F
db $05,$15,$82,$2F,$A8,$07,$30,$41

; Sprite data.
; Second chamber of fort (vertical part), level 5-3.
; Total amount of sprites: 11.
db $15,$84,$31,$8A,$01,$01
db $01,$01,$05,$07,$67,$12,$D2,$01
db $03,$12,$F2,$01,$07,$0F,$60,$03
db $92,$03,$A6,$05,$03,$07,$03,$55
db $05,$1C,$B7,$44,$B8,$03,$43,$B5

; Sprite data.
; Hopping from tree to tree, penultimate room, level 5-3.
; Total amount of sprites: 11.
db $01

; Sprite data. Clawgrip boss room, level 5-3. Total amount of sprites: 1.
db $01,$03,$61,$A7,$01
db $03,$42,$4A,$07,$19,$1D,$03,$AB
db $19,$DD,$03,$18,$5A,$03,$1A,$49
db $07,$19,$1D,$19,$5D,$03,$7B,$03
db $18,$EA,$07,$18,$1A,$19,$AD,$19
db $BD,$03,$1A,$E6,$05,$1A,$36,$24

; Sprite data.
; Main room in the desert, level 6-1.
; Total amount of sprites: 16.
db $99,$01,$01
db $01,$07,$18,$4B,$18,$9A,$15,$FB

; Sprite data. Inside the jar building, level 6-1. (The one with those sneaky Cobrats.)
; Total amount of sprites: 5.
db $05,$18,$2B,$18,$7B,$01,$01
db $01,$05,$1C,$C8,$44,$C8,$03,$43

; Sprite data. Birdo room, level 6-1.
; Total amount of sprites: 3.
db $27,$01
db $03,$01,$5A,$09,$01,$41,$01,$B4

; Sprite data. Jar room with key, level 6-1.
; Total amount of sprites: 5.
db $17,$85,$3D,$69,$01
db $01,$01,$01,$01,$01,$01,$01,$01

; Sprite data. Jar room with turtle shell, level 6-1.
; Total amount of sprites: 2.
db $01,$01,$05,$01,$2A,$01,$DA
db $03,$01,$5A,$05,$01,$41,$01,$B4

; Sprite data. Jar room with 1-Up, level 6-1.
; Total amount of sprites: 3.
db $01

; Sprite data. Jar room with potion, level 6-1. Total amount of sprites: 1.
db $03,$01,$B8,$01

; Sprite data. First room, level 6-2. Total amount of sprites: 1.
db $03,$42,$2A,$01,$01
db $05,$0B,$0C,$0B,$26,$07,$0C,$AB
db $0C,$C9,$0C,$E7,$03,$25,$AB,$07
db $10,$55,$10,$85,$10,$A5,$05,$0C
...
; Total amount of sprites: 21.
db $0C,$29,$0C,$A9,$01
db $01,$05,$1C,$CA,$44,$CB,$03,$43

; Sprite data. Birdo room, level 6-2.
; Total amount of sprites: 3.
db $D4,$01

; Sprite data. Trapped in the sand, level 6-3. Total amount of sprites: 1.
db $03,$42,$2A,$01
db $01,$01,$03,$03,$98,$07,$03,$48

; Sprite data. Outside, level 6-3.
; Total amount of sprites: 4.
db $1A,$66,$19,$AA,$01,$01
db $01,$05,$16,$49,$16,$F9,$05,$09
db $A9,$16,$C9,$03,$0D,$F5,$07,$0D
db $27,$0D,$38,$0D,$56,$01,$01,$01

; Sprite data.
; Inside the Bob-Omb room, level 6-3.
; Total amount of sprites: 8.
db $01,$01,$01
db $01,$09,$14,$95,$14,$A4,$14,$B3
db $14,$C2,$07,$14,$A7,$14,$BA,$14
db $C8,$03,$14,$34,$07,$14,$4A,$06
db $75,$06,$7E,$03,$01,$28,$07,$14
db $9C,$14,$AD,$14,$BE,$03,$14,$5C

; Sprite data.
; Gigantic vines (vertical), level 6-3.
; Total amount of sprites: 17.
db $03,$14,$93,$01,$01

; In the clouds, level 6-3. No sprites used.
db $01,$01,$01,$01,$01
db $01,$07,$43,$97,$1C,$B3,$44,$B4

; Sprite data. Birdo room, level 6-3.
; Total amount of sprites: 3.
db $01

; Sprite data. Triclyde boss room, level 6-3. Total amount of sprites: 1.
db $01,$03,$5F,$B5,$01

; Sprite data. First room, level 7-1. Total amount of sprites: 1.
db $03,$42,$2A,$01
db $01,$01,$01,$0D,$09,$8B,$0C,$94
db $09,$94,$0D,$B8,$0C,$E4,$09,$E4
db $07,$09,$2B,$0C,$E4,$09,$E4,$0D
db $0E,$3B,$0C,$54,$09,$54,$09,$6B
db $0C,$94,$09,$94,$07,$15,$37,$0C

; Sprite data.
; Main room in the sky (with Albatosses), level 7-1.
; Total amount of sprites: 18.
db $F3,$09,$F3,$01
db $01,$07,$02,$A8,$06,$B6,$06,$CB
db $07,$15,$38,$03,$DC,$06,$F3,$05

; Sprite data.
; Cloud maze, level 7-1.
; Total amount of sprites: 8.
db $0D,$59,$06,$AB,$01
db $01,$07,$06,$21,$14,$66,$14,$8B
db $07,$31,$87,$31,$D7,$2F,$D9,$05

; Sprite data.
; Vertical room to Birdo, level 7-1.
; Total amount of sprites: 8.
db $31,$E0,$31,$63,$01
db $01,$07,$43,$9A,$1C,$C5,$44,$C6

; Sprite data. Birdo room, level 7-1.
; Total amount of sprites: 3.
db $01

; Sprite data. Room with extras, level 7-1. Total amount of sprites: 2.
db $05,$31,$B9,$31,$C3,$01
db $03,$06,$F5,$05,$06,$58,$06,$E8

; Sprite data. Outside, level 7-2.
; Total amount of sprites: 4.
db $03,$0E,$74,$01
db $01,$07,$01,$99,$01,$D9,$15,$F9
db $07,$0E,$77,$0E,$A7,$0E,$C7,$03
db $16,$D9,$01,$05,$25,$1C,$25,$BC

; Sprite data.
; First chamber with conveyor belts, level 7-2.
; Total amount of sprites: 10.
db $03,$25,$5B,$01
db $01,$05,$31,$99,$31,$EC,$05,$31
db $24,$31,$69,$05,$2F,$96,$2F,$E3
db $03,$2F,$3A,$03,$1C,$B7,$01,$07
db $1C,$B7,$17,$A4,$3D,$B8,$01,$01

; Sprite data.
; Upper path, horizontal room with Sparkies and chains (also contains a mushroom), level 7-2.
; Total amount of sprites: 11.
; This room is in fact "two" rooms, the part with the mushroom is semi-hidden.
db $01
db $07,$2F,$B8,$30,$F3,$2E,$FC,$09
db $2F,$34,$2F,$74,$2F,$A4,$30,$AB
db $07,$30,$1A,$2F,$79,$30,$F5,$01

; Sprite data.
; Bottom path, horizontal room with Sparkies and chains, level 7-2.
; Total amount of sprites: 10.
db $01
db $09,$2F,$23,$2F,$83,$2F,$E3,$31
db $CC,$05,$2F,$BB,$2F,$FB,$03,$2F
db $53,$09,$31,$29,$2E,$43,$2F,$A3
db $31,$59,$01,$01,$01,$01,$01,$05

; Sprite data.
; Room with locked door leading to the penultimate room, level 7-2.
; Total amount of sprites: 13.
db $44,$49,$2D,$B7,$01

; Sprite data. Wart room, level 7-2. Total amount of sprites: 2.
db $01,$01,$05,$4A,$1A,$6C,$A7,$01
db $03,$2F,$8A,$07,$2E,$73,$31,$85
db $2F,$8C,$05,$31,$87,$2F,$8E,$05
db $31,$50,$30,$A0,$01,$01,$01,$0D
db $31,$61,$31,$A1,$2F,$A3,$31,$68
db $2F,$5A,$2F,$AA,$05,$2F,$61,$2F

; Sprite data.
; Bottom path, vertical room with mushroom blocks and Sparkies, level 7-2.
; Total amount of sprites: 16.
db $A1,$01,$01
db $09,$03,$76,$07,$69,$07,$99,$30
db $8F,$09,$2F,$A2,$31,$73,$31,$68
db $2E,$AD,$07,$31,$80,$31,$97,$2E

; Sprite data.
; Bottom path, vertical conveyor room, level 7-2.
; Total amount of sprites: 13.
db $7F,$05,$07,$80,$01,$84,$01
db $05,$31,$9C,$30,$7E,$07,$2F,$35
db $30,$77,$31,$A8,$05,$31,$67,$31
db $BA,$01,$09,$30,$42,$31,$82,$30
db $B2,$2F,$74,$09,$2F,$53,$2F,$93

; Sprite data.
; Upper path, vertical chain room with Sparkies, level 7-2.
; Total amount of sprites: 15.
db $30,$54,$2F,$76,$01,$01
db $01,$01,$03,$23,$79,$05,$02,$20

; Sprite data. Semi-secret outside room.
; Total amount of sprites: 3.
db $02,$D0,$01
