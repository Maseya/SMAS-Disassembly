...
CODE_138062:
REP #$20                ; $13:8062: C2 20
LDA.w #DATA_19E000      ; $13:8064: A9 00 E0
STA $0D                 ; $13:8067: 85 0D
LDX.b #DATA_19E000>>16  ; $13:8069: A2 19

; Load sprite GFX tiles 00-7F. (00-1F will get overwritten)
; ($19E000)
STX $0F                 ; $13:806B: 86 0F
LDA #$1000              ; $13:806D: A9 00 10

; Amount of bytes to transfer = #$1000.
STA $0B                 ; $13:8070: 85 0B
LDA #$6000              ; $13:8072: A9 00 60

; First GFX slot.
; Transfer to VRAM.
JSR CODE_138AE7         ; $13:8075: 20 E7 8A
LDA.w #DATA_16C000      ; $13:8078: A9 00 C0
STA $0D                 ; $13:807B: 85 0D
LDX.b #DATA_16C000>>16  ; $13:807D: A2 16

; Load sprite GFX tiles 80-13F.
; ($16C000)
STX $0F                 ; $13:807F: 86 0F
LDA #$1800              ; $13:8081: A9 00 18

; Amount of bytes to transfer = #$1800.
STA $0B                 ; $13:8084: 85 0B
LDA #$6800              ; $13:8086: A9 00 68

; Second and first half of third GFX slots.
; Transfer to VRAM.
JSR CODE_138AE7         ; $13:8089: 20 E7 8A
LDA $0635               ; $13:808C: AD 35 06
AND #$00FF              ; $13:808F: 29 FF 00
TAY                     ; $13:8092: A8
ASL A                   ; $13:8093: 0A

; Get world number into Y, *2 into X index.
TAX                     ; $13:8094: AA

; Hold X to get later.
PHX                     ; $13:8095: DA
LDA.l DATA_138000,x     ; $13:8096: BF 00 80 13
STA $0D                 ; $13:809A: 85 0D
TYX                     ; $13:809C: BB
LDA.l DATA_13800E,x     ; $13:809D: BF 0E 80 13
TAX                     ; $13:80A1: AA

; Load sprite GFX tiles 140-17F from pointer.
STX $0F                 ; $13:80A2: 86 0F
LDA #$0800              ; $13:80A4: A9 00 08

; Amount of bytes to transfer = #$0800.
STA $0B                 ; $13:80A7: 85 0B
LDA #$7400              ; $13:80A9: A9 00 74

; Second half of third GFX slot.
; Transfer to VRAM.
JSR CODE_138AE7         ; $13:80AC: 20 E7 8A
PLX                     ; $13:80AF: FA

; Get world number * 2 back.
PHX                     ; $13:80B0: DA
LDA.l DATA_138015,x     ; $13:80B1: BF 15 80 13
STA $0D                 ; $13:80B5: 85 0D
TYX                     ; $13:80B7: BB
LDA.l DATA_138023,x     ; $13:80B8: BF 23 80 13
TAX                     ; $13:80BC: AA

; Load sprite GFX tiles 180-1BF from pointer.
STX $0F                 ; $13:80BD: 86 0F
LDA #$0800              ; $13:80BF: A9 00 08

; Amount of bytes to transfer = #$0800.
STA $0B                 ; $13:80C2: 85 0B
LDA #$7800              ; $13:80C4: A9 00 78

; First half of fourth GFX slot.
; Transfer to VRAM.
JSR CODE_138AE7         ; $13:80C7: 20 E7 8A
LDA.w #DATA_179000      ; $13:80CA: A9 00 90
STA $0D                 ; $13:80CD: 85 0D
LDX.b #DATA_179000>>16  ; $13:80CF: A2 17

; Load sprite GFX tiles 1C0-1FF.
; ($179000)
STX $0F                 ; $13:80D1: 86 0F
LDA #$0800              ; $13:80D3: A9 00 08

; Amount of bytes to transfer = #$0800.
STA $0B                 ; $13:80D6: 85 0B
LDA #$7C00              ; $13:80D8: A9 00 7C

; Second half of fourth GFX slot.
; Transfer to VRAM.
JSR CODE_138AE7         ; $13:80DB: 20 E7 8A
PLX                     ; $13:80DE: FA

; Get world number * 2 back.
PHX                     ; $13:80DF: DA
LDA.l DATA_138038,x     ; $13:80E0: BF 38 80 13
STA $0D                 ; $13:80E4: 85 0D
TYX                     ; $13:80E6: BB
LDA.l DATA_138046,x     ; $13:80E7: BF 46 80 13
TAX                     ; $13:80EB: AA

; Load layer GFX tiles 00-7F from pointer.
STX $0F                 ; $13:80EC: 86 0F
LDA #$1000              ; $13:80EE: A9 00 10

; Amount of bytes to transfer = #$1000.
STA $0B                 ; $13:80F1: 85 0B
LDA #$2000              ; $13:80F3: A9 00 20

; First GFX slot.
; Transfer to VRAM.
JSR CODE_138AC4         ; $13:80F6: 20 C4 8A
LDA.w #DATA_18C000      ; $13:80F9: A9 00 C0
STA $0D                 ; $13:80FC: 85 0D
LDX.b #DATA_18C000>>16  ; $13:80FE: A2 18

; Load layer GFX tiles 80-BF.
; ($18C000)
STX $0F                 ; $13:8100: 86 0F
LDA #$0800              ; $13:8102: A9 00 08

; Amount of bytes to transfer = #$0800.
STA $0B                 ; $13:8105: 85 0B
LDA #$2800              ; $13:8107: A9 00 28

; First half of second GFX slot.
; Transfer to VRAM.
JSR CODE_138AC4         ; $13:810A: 20 C4 8A

; Get world num * 2.
PLX                     ; $13:810D: FA
LDA.l DATA_13804D,x     ; $13:810E: BF 4D 80 13
STA $0D                 ; $13:8112: 85 0D
TYX                     ; $13:8114: BB
LDA.l DATA_13805B,x     ; $13:8115: BF 5B 80 13
TAX                     ; $13:8119: AA

; Load layer GFX tiles C0-FF from pointer.
STX $0F                 ; $13:811A: 86 0F
LDA #$0800              ; $13:811C: A9 00 08

; Amount of bytes to transfer = #$0800.
STA $0B                 ; $13:811F: 85 0B
LDA #$2C00              ; $13:8121: A9 00 2C

; Second half of second GFX slot.
; Transfer to VRAM.
JSR CODE_138AC4         ; $13:8124: 20 C4 8A

; Accumulator = 8-bit.
SEP #$20                ; $13:8127: E2 20

; Return.
RTL                     ; $13:8129: 6B

DATA_13812A:
db $C8,$C8,$C8,$C8,$C8,$C8,$00,$00
...
; Get level + room number into index.
;
;
; Accumulator & Index = 16-bit.
TAX                     ; $13:85FD: AA
LDA.l DATA_13812A,x     ; $13:85FE: BF 2A 81 13
AND #$00FF              ; $13:8602: 29 FF 00
XBA                     ; $13:8605: EB

; Tiles of the FG/BG slots 140-17F, high byte.
STA $02CB               ; $13:8606: 8D CB 02
LDA.l DATA_1381F2,x     ; $13:8609: BF F2 81 13
AND #$00FF              ; $13:860D: 29 FF 00
XBA                     ; $13:8610: EB

; Tiles of the FG/BG slots 180-1BF, high byte.
STA $02CD               ; $13:8611: 8D CD 02
LDA.l DATA_1382BA,x     ; $13:8614: BF BA 82 13
AND #$00FF              ; $13:8618: 29 FF 00
XBA                     ; $13:861B: EB

; Tiles of the FG/BG slots 1C0-1FF, high byte.
STA $02CF               ; $13:861C: 8D CF 02
LDA.l DATA_138382,x     ; $13:861F: BF 82 83 13

; Tiles of the FG/BG slots 140-17F, bank byte.
STA $02D1               ; $13:8623: 8D D1 02
LDA.l DATA_13844A,x     ; $13:8626: BF 4A 84 13

; Tiles of the FG/BG slots 180-1BF, bank byte.
STA $02D3               ; $13:862A: 8D D3 02
LDA.l DATA_138512,x     ; $13:862D: BF 12 85 13

; Tiles of the FG/BG slots 1C0-1FF, bank byte.
STA $02D5               ; $13:8631: 8D D5 02

; Index = 8-bit.
SEP #$10                ; $13:8634: E2 10
LDX $0635               ; $13:8636: AE 35 06
CPX #$06                ; $13:8639: E0 06

; If not in World 7, branch.
BNE CODE_138646         ; $13:863B: D0 09
LDA.w #DATA_1DB000      ; $13:863D: A9 00 B0
STA $0D                 ; $13:8640: 85 0D
LDX.b #DATA_1DB000>>16  ; $13:8642: A2 1D

; $1DB000 = Tiles of the FG/BG slots 100-13F
; Metal ground graphics.
BRA CODE_13864D         ; $13:8644: 80 07

CODE_138646:
LDA.w #DATA_1BC000      ; $13:8646: A9 00 C0
STA $0D                 ; $13:8649: 85 0D
LDX.b #DATA_1BC000>>16  ; $13:864B: A2 1B

; $1BC000 = Tiles of the FG/BG slots 100-13F.

CODE_13864D:
STX $0F                 ; $13:864D: 86 0F
LDA #$0800              ; $13:864F: A9 00 08

; Amount of bytes to transfer = #$0800.
STA $0B                 ; $13:8652: 85 0B
LDA #$3000              ; $13:8654: A9 00 30

; First half of third GFX slot.
; Transfer to VRAM.
JSR CODE_138AC4         ; $13:8657: 20 C4 8A
LDA $02CB               ; $13:865A: AD CB 02
STA $0D                 ; $13:865D: 85 0D
LDX $02D1               ; $13:865F: AE D1 02

; Load tiles 140-17F of the FG/BG slots from pointer.
STX $0F                 ; $13:8662: 86 0F
LDA #$0800              ; $13:8664: A9 00 08

; Amount of bytes to transfer = #$0800.
STA $0B                 ; $13:8667: 85 0B
LDA #$3400              ; $13:8669: A9 00 34

; Second half of third GFX slot.
; Transfer to VRAM.
JSR CODE_138AC4         ; $13:866C: 20 C4 8A
LDA $02CD               ; $13:866F: AD CD 02
STA $0D                 ; $13:8672: 85 0D
LDX $02D3               ; $13:8674: AE D3 02

; Load tiles 180-1BF of the FG/BG slots from pointer.
STX $0F                 ; $13:8677: 86 0F
LDA #$0800              ; $13:8679: A9 00 08

; Amount of bytes to transfer = #$0800.
STA $0B                 ; $13:867C: 85 0B
LDA #$3800              ; $13:867E: A9 00 38

; First half of fourth GFX slot
; Transfer to VRAM
JSR CODE_138AC4         ; $13:8681: 20 C4 8A
LDA $02CF               ; $13:8684: AD CF 02
STA $0D                 ; $13:8687: 85 0D
LDX $02D5               ; $13:8689: AE D5 02

; Load tiles 1C0-1FF of the FG/BG slots from pointer.
STX $0F                 ; $13:868C: 86 0F
LDA #$0800              ; $13:868E: A9 00 08

; Amount of bytes to transfer = #$0800.
STA $0B                 ; $13:8691: 85 0B
LDA #$3C00              ; $13:8693: A9 00 3C

; Second half of fourth GFX slot.
; Transfer to VRAM.
JSR CODE_138AC4         ; $13:8696: 20 C4 8A
LDX $0533               ; $13:8699: AE 33 05
CPX #$02                ; $13:869C: E0 02
BEQ CODE_1386BC         ; $13:869E: F0 1C
CPX #$08                ; $13:86A0: E0 08
BEQ CODE_1386BC         ; $13:86A2: F0 18
CPX #$0B                ; $13:86A4: E0 0B
BEQ CODE_1386BC         ; $13:86A6: F0 14
CPX #$11                ; $13:86A8: E0 11
BNE CODE_1386D2         ; $13:86AA: D0 26
LDX $0534               ; $13:86AC: AE 34 05
CPX #$05                ; $13:86AF: E0 05
BEQ CODE_1386BC         ; $13:86B1: F0 09
LDA.w #DATA_18C800      ; $13:86B3: A9 00 C8
STA $0D                 ; $13:86B6: 85 0D
LDX.b #DATA_18C800>>16  ; $13:86B8: A2 18

; Load different graphics for tiles C0-FF of the FG/BG slots if the following levels:
; Level 1-3...
;
; Level 3-3...
;
; or level 4-3.
;
; If NOT level 5-3, even different tiles are used for tiles C0-FF of the FG/BG slots.
;
; If it's level 5-3 and the sixth room is entered...
; ...use the tiles from 1-3, 3-3 and 4-3.
;
; Graphics from $18C800 are used.
; $0800 bytes.
BRA CODE_1386C3         ; $13:86BA: 80 07

CODE_1386BC:
LDA.w #DATA_1D9000      ; $13:86BC: A9 00 90
STA $0D                 ; $13:86BF: 85 0D
LDX.b #DATA_1D9000>>16  ; $13:86C1: A2 1D

CODE_1386C3:
STX $0F                 ; $13:86C3: 86 0F
LDA #$0800              ; $13:86C5: A9 00 08
STA $0B                 ; $13:86C8: 85 0B
LDA #$2C00              ; $13:86CA: A9 00 2C
JSR CODE_138AC4         ; $13:86CD: 20 C4 8A

; 1-3, 3-3, 4-3 or 5-3 room 6.
; They use graphics from $1D9000.
;
;
; $0800 bytes also.
;
; VRAM destination is where tiles C0-FF go.
; Transfer to VRAM.
; Branch.
BRA CODE_1386ED         ; $13:86D0: 80 1B

CODE_1386D2:
LDX $0533               ; $13:86D2: AE 33 05
CPX #$13                ; $13:86D5: E0 13
BNE CODE_1386ED         ; $13:86D7: D0 14
LDA.w #DATA_1DA000      ; $13:86D9: A9 00 A0
STA $0D                 ; $13:86DC: 85 0D
LDX.b #DATA_1DA000>>16  ; $13:86DE: A2 1D
STX $0F                 ; $13:86E0: 86 0F
LDA #$0800              ; $13:86E2: A9 00 08
STA $0B                 ; $13:86E5: 85 0B
LDA #$2C00              ; $13:86E7: A9 00 2C

; If NOT 7-2...
; ...then don't load any new tiles at all.
;
; 7-2 uses graphics from $1DA000.
;
;
;
; $0800 bytes as usual.
...
; VRAM destination is where tiles C0-FF go.
; Transfer to VRAM.
JSR CODE_138AC4         ; $13:86EA: 20 C4 8A

CODE_1386ED:
LDX #$00                ; $13:86ED: A2 00
STX $0773               ; $13:86EF: 8E 73 07
LDX $0533               ; $13:86F2: AE 33 05
CPX #$03                ; $13:86F5: E0 03
BNE CODE_138704         ; $13:86F7: D0 0B
LDX $0534               ; $13:86F9: AE 34 05
CPX #$01                ; $13:86FC: E0 01
BEQ CODE_13871D         ; $13:86FE: F0 1D
CPX #$02                ; $13:8700: E0 02
...
; Or the third room.
; If either, branch.
BEQ CODE_13871D         ; $13:8702: F0 19

CODE_138704:
LDX $0533               ; $13:8704: AE 33 05
CPX #$05                ; $13:8707: E0 05
BNE CODE_138736         ; $13:8709: D0 2B
LDX $0534               ; $13:870B: AE 34 05
CPX #$03                ; $13:870E: E0 03
BEQ CODE_13871D         ; $13:8710: F0 0B
LDX $0534               ; $13:8712: AE 34 05
CPX #$05                ; $13:8715: E0 05
BEQ CODE_13871D         ; $13:8717: F0 04
CPX #$07                ; $13:8719: E0 07
BNE CODE_138736         ; $13:871B: D0 19

CODE_13871D:
LDA #$A800              ; $13:871D: A9 00 A8
STA $0D                 ; $13:8720: 85 0D
LDX #$1D                ; $13:8722: A2 1D
STX $0F                 ; $13:8724: 86 0F
LDA #$0800              ; $13:8726: A9 00 08
STA $0B                 ; $13:8729: 85 0B
LDA #$3000              ; $13:872B: A9 00 30
...
;
; Or the sixth room...
; (Extra LDX $0534 is redundant, by the way.)
;
; Or the eighth room.
; If none of these, return.
; Upload stone graphics to 100-13F.
; Source: $1DA800.
;
;
; Size: $0800 (x40 tiles)
;
; Destination: FG/BG tile slots 100-13F.
; Transfer to VRAM.
JSR CODE_138AC4         ; $13:872E: 20 C4 8A
...
CODE_13873D:
REP #$20                ; $13:873D: C2 20
LDX $0533               ; $13:873F: AE 33 05
CPX #$0E                ; $13:8742: E0 0E

; Check if in level 5-3.
;
; If not, branch.
BNE CODE_13874A         ; $13:8744: D0 04

; Layer tiles 200-23F = $1D9800.
LDX #$02                ; $13:8746: A2 02
BRA CODE_13874D         ; $13:8748: 80 03

CODE_13874A:
LDX $04EF               ; $13:874A: AE EF 04

CODE_13874D:
LDA.l DATA_138739,x     ; $13:874D: BF 39 87 13
STA $0D                 ; $13:8751: 85 0D
LDX #$1D                ; $13:8753: A2 1D

; Load GFX pointer for layer tiles 200-23F.
; Into [$0D]
STX $0F                 ; $13:8755: 86 0F
LDA #$0800              ; $13:8757: A9 00 08

; Amount of bytes to transfer = #$0800.
STA $0B                 ; $13:875A: 85 0B
LDA #$4000              ; $13:875C: A9 00 40

; First half of fifth GFX slot.
; Transfer to VRAM.
JSR CODE_138AC4         ; $13:875F: 20 C4 8A
LDA #$9000              ; $13:8762: A9 00 90
STA $0D                 ; $13:8765: 85 0D
LDX #$1D                ; $13:8767: A2 1D

; Layer tiles 240-27F pointer into [$0D]
; ($1D9000)
STX $0F                 ; $13:8769: 86 0F
LDA #$0800              ; $13:876B: A9 00 08

; Amount of bytes to transfer = #$0800.
STA $0B                 ; $13:876E: 85 0B
LDA #$4400              ; $13:8770: A9 00 44

; Second half of fifth GFX slot.
; Transfer to VRAM.
JSR CODE_138AC4         ; $13:8773: 20 C4 8A

; Accumulator = 8-bit.
SEP #$20                ; $13:8776: E2 20

; Return.
RTL                     ; $13:8778: 6B

DATA_138779:
db $18,$38,$58,$75,$91,$B0,$C3

CODE_138780:
LDA #$06                ; $13:8780: A9 06
...
CODE_138791:
CMP.l DATA_138779,x     ; $13:8791: DF 79 87 13
...
CODE_1388F5:
REP #$20                ; $13:88F5: C2 20
LDA #$8000              ; $13:88F7: A9 00 80
STA $0D                 ; $13:88FA: 85 0D
LDX #$1A                ; $13:88FC: A2 1A

; Layer tiles 00-3F.
; ($1A8000)
STX $0F                 ; $13:88FE: 86 0F
LDA #$0800              ; $13:8900: A9 00 08

; Amount of bytes to transfer = #$0800.
STA $0B                 ; $13:8903: 85 0B
LDA #$2000              ; $13:8905: A9 00 20

; First half of first GFX slot.
; Transfer to VRAM.
JSR CODE_138AC4         ; $13:8908: 20 C4 8A
LDA.w #DATA_19C800      ; $13:890B: A9 00 C8
STA $0D                 ; $13:890E: 85 0D
LDX.b #DATA_19C800>>16  ; $13:8910: A2 19

; Layer tiles 40-FF.
; ($19C800)
STX $0F                 ; $13:8912: 86 0F
LDA #$1800              ; $13:8914: A9 00 18

; Amount of bytes to transfer = #$1800.
STA $0B                 ; $13:8917: 85 0B
LDA #$2400              ; $13:8919: A9 00 24

; Second half of first and full second GFX slot.
; Transfer to VRAM.
JSR CODE_138AC4         ; $13:891C: 20 C4 8A
LDA #$4000              ; $13:891F: A9 00 40

; Amount of bytes to transfer = #$4000.
STA $0B                 ; $13:8922: 85 0B
LDA.w #DATA_1B8000      ; $13:8924: A9 00 80
STA $0D                 ; $13:8927: 85 0D
LDX.b #DATA_1B8000>>16  ; $13:8929: A2 1B

; Sprite tiles 00-1FF.
; ($1B8000)
STX $0F                 ; $13:892B: 86 0F
LDA #$6000              ; $13:892D: A9 00 60

; All four GFX slots.
; Transfer to VRAM.
JSR CODE_138AE7         ; $13:8930: 20 E7 8A

; Accumulator = 8-bit.
SEP #$20                ; $13:8933: E2 20
...
CODE_138A4E:
LDA #$D000              ; $13:8A4E: A9 00 D0
LDX #$16                ; $13:8A51: A2 16

CODE_138A53:
STA $0D                 ; $13:8A53: 85 0D
...
CODE_138A62:
SEP #$20                ; $13:8A62: E2 20
STZ $0722               ; $13:8A64: 9C 22 07
RTL                     ; $13:8A67: 6B

CODE_138A68:
REP #$20                ; $13:8A68: C2 20
...
CODE_138AC4:
LDX #$80                ; $13:8AC4: A2 80
STX $2115               ; $13:8AC6: 8E 15 21
STA $2116               ; $13:8AC9: 8D 16 21
LDA #$01                ; $13:8ACC: A9 01
CLC                     ; $13:8ACE: 18
STA $4300               ; $13:8ACF: 8D 00 43
LDA $0D                 ; $13:8AD2: A5 0D
STA $4302               ; $13:8AD4: 8D 02 43
LDX $0F                 ; $13:8AD7: A6 0F
STX $4304               ; $13:8AD9: 8E 04 43
LDA $0B                 ; $13:8ADC: A5 0B
STA $4305               ; $13:8ADE: 8D 05 43
LDX #$01                ; $13:8AE1: A2 01
STX $420B               ; $13:8AE3: 8E 0B 42

; Increment after write to $2119.
; Increment source&destination addresses by 1.
; 16-bit value in A determines destination in VRAM.
; 1 byte per reg (2 regs, low byte in $reg, high byte in $reg+1).
; Clear carry.
; -------------^
; [$0D] holds the source address.
;
;
;
; $0B (16-bit) holds the size.
;
; Data transfer here.
;
; Return.
...
CODE_138B44:
SEP #$20                ; $13:8B44: E2 20
PLD                     ; $13:8B46: 2B
RTL                     ; $13:8B47: 6B

CODE_138B48:
LDX #$80                ; $13:8B48: A2 80
...
CODE_138CE8:
LDA.l DATA_138CC0,x     ; $13:8CE8: BF C0 8C 13
STA $021B               ; $13:8CEC: 8D 1B 02

CODE_138CEF:
SEP #$20                ; $13:8CEF: E2 20
RTL                     ; $13:8CF1: 6B

CODE_138CF2:
LDA #$04                ; $13:8CF2: A9 04
...
CODE_138D56:
REP #$20                ; $13:8D56: C2 20
LDX #$2E                ; $13:8D58: A2 2E

CODE_138D5A:
LDA.w DATA_11BBC6,x     ; $13:8D5A: BD C6 BB
...
CODE_138D67:
LDX #$23                ; $13:8D67: A2 23

CODE_138D69:
LDA.l DATA_15EC33,x     ; $13:8D69: BF 33 EC 15
...
DATA_138EDD:
db $F0,$00,$F0,$F0,$E0,$F0,$00

DATA_138EE4:
db $F0,$00,$F2,$F0,$E0,$F2,$00

CODE_138EEB:
REP #$30                ; $13:8EEB: C2 30
...
CODE_138F26:
STA $7FF000,x           ; $13:8F26: 9F 00 F0 7F
INX                     ; $13:8F2A: E8
INX                     ; $13:8F2B: E8
...
CODE_139050:
LDA.l DATA_14C563,x     ; $13:9050: BF 63 C5 14
...
CODE_1390C9:
LDY #$00                ; $13:90C9: A0 00

CODE_1390CB:
CMP #$0A                ; $13:90CB: C9 0A
...
CODE_1391E1:
CMP.l DATA_1391D0,x     ; $13:91E1: DF D0 91 13
...
CODE_139446:
JSR CODE_139705         ; $13:9446: 20 05 97
...
CODE_1394F6:
LDX #$05                ; $13:94F6: A2 05
LDA $050F               ; $13:94F8: AD 0F 05
CLC                     ; $13:94FB: 18
ADC #$10                ; $13:94FC: 69 10

CODE_1394FE:
CMP.l DATA_13D471,x     ; $13:94FE: DF 71 D4 13
...
CODE_13951D:
LDX #$04                ; $13:951D: A2 04
LDA $050F               ; $13:951F: AD 0F 05
CLC                     ; $13:9522: 18
ADC #$10                ; $13:9523: 69 10

CODE_139525:
CMP.l DATA_13D497,x     ; $13:9525: DF 97 D4 13
...
CODE_13954E:
LDA.l DATA_13D49C,x     ; $13:954E: BF 9C D4 13

CODE_139552:
STA [$01],y             ; $13:9552: 97 01
INX                     ; $13:9554: E8
...
CODE_139567:
LDA.l DATA_13D49C,x     ; $13:9567: BF 9C D4 13

CODE_13956B:
STA [$01],y             ; $13:956B: 97 01
...
CODE_139580:
LDX #$09                ; $13:9580: A2 09

CODE_139582:
LDA $0533               ; $13:9582: AD 33 05
...
CODE_139599:
LDX #$06                ; $13:9599: A2 06

CODE_13959B:
LDA [$01],y             ; $13:959B: B7 01
...
CODE_1395A6:
LDA #$00                ; $13:95A6: A9 00
RTS                     ; $13:95A8: 60

CODE_1395A9:
LDA.l DATA_13D4D5,x     ; $13:95A9: BF D5 D4 13
RTS                     ; $13:95AD: 60

CODE_1395AE:
STZ $0F                 ; $13:95AE: 64 0F
...
CODE_1395D2:
LDA.l DATA_13DA8E,x     ; $13:95D2: BF 8E DA 13
STA [$01],y             ; $13:95D6: 97 01
LDX $08                 ; $13:95D8: A6 08
BEQ CODE_139602         ; $13:95DA: F0 26

CODE_1395DC:
JSR CODE_139660         ; $13:95DC: 20 60 96
...
CODE_1395F0:
JSR CODE_139660         ; $13:95F0: 20 60 96
...
CODE_139602:
JSR CODE_139660         ; $13:9602: 20 60 96
...
CODE_139659:
JSR CODE_139689         ; $13:9659: 20 89 96
...
CODE_1396CC:
JSR CODE_1397DC         ; $13:96CC: 20 DC 97
...
CODE_1396F7:
CMP.l DATA_13DB60,x     ; $13:96F7: DF 60 DB 13
...
CODE_139701:
INC $02E4               ; $13:9701: EE E4 02

CODE_139704:
RTS                     ; $13:9704: 60

CODE_139705:
LDA $09                 ; $13:9705: A5 09
ASL A                   ; $13:9707: 0A
ASL A                   ; $13:9708: 0A
SEC                     ; $13:9709: 38
...
CODE_13971A:
BNE CODE_13971E         ; $13:971A: D0 02

CODE_13971C:
INC $0A                 ; $13:971C: E6 0A

CODE_13971E:
LDA $0A                 ; $13:971E: A5 0A
...
CODE_139736:
INC $04                 ; $13:9736: E6 04

CODE_139738:
LDY $04                 ; $13:9738: A4 04
...
CODE_13979F:
BRL CODE_139738         ; $13:979F: 82 96 FF

CODE_1397A2:
LDA [$05],y             ; $13:97A2: B7 05
...
CODE_1397CA:
INC $E9                 ; $13:97CA: E6 E9

CODE_1397CC:
INC $E9                 ; $13:97CC: E6 E9
LDA #$00                ; $13:97CE: A9 00
STA $E6                 ; $13:97D0: 85 E6
RTS                     ; $13:97D2: 60

CODE_1397D3:
LDX $E9                 ; $13:97D3: A6 E9
...
CODE_1398C4:
LDA $02DC               ; $13:98C4: AD DC 02
BEQ CODE_1398D5         ; $13:98C7: F0 0C

CODE_1398C9:
LDA $0F                 ; $13:98C9: A5 0F
CLC                     ; $13:98CB: 18
...
CODE_1398D6:
JSR CODE_1398F7         ; $13:98D6: 20 F7 98

CODE_1398D9:
LDY $0F                 ; $13:98D9: A4 0F
...
CODE_139910:
INC $0D                 ; $13:9910: E6 0D
RTS                     ; $13:9912: 60

CODE_139913:
LDX $E9                 ; $13:9913: A6 E9
...
CODE_13993B:
INC $08                 ; $13:993B: E6 08
RTS                     ; $13:993D: 60

CODE_13993E:
LDX #$03                ; $13:993E: A2 03
LDA $050F               ; $13:9940: AD 0F 05
CLC                     ; $13:9943: 18
ADC #$10                ; $13:9944: 69 10

CODE_139946:
CMP.l DATA_13D483,x     ; $13:9946: DF 83 D4 13
...
CODE_13997C:
LDY $E7                 ; $13:997C: A4 E7
LDX #$00                ; $13:997E: A2 00

CODE_139980:
LDA.l DATA_13D4DC,x     ; $13:9980: BF DC D4 13
...
CODE_1399A0:
JSR CODE_1396B0         ; $13:99A0: 20 B0 96

CODE_1399A3:
JSR CODE_1396B0         ; $13:99A3: 20 B0 96
...
CODE_1399A9:
LDX #$33                ; $13:99A9: A2 33
LDA $050F               ; $13:99AB: AD 0F 05
CLC                     ; $13:99AE: 18
ADC #$10                ; $13:99AF: 69 10

CODE_1399B1:
CMP.l DATA_13D4E6,x     ; $13:99B1: DF E6 D4 13
...
CODE_139A65:
LDA #$05                ; $13:9A65: A9 05
BRA CODE_139A6B         ; $13:9A67: 80 02

CODE_139A69:
LDA #$04                ; $13:9A69: A9 04

CODE_139A6B:
STA $0D                 ; $13:9A6B: 85 0D

CODE_139A6D:
LDA.l DATA_13D9BE,x     ; $13:9A6D: BF BE D9 13
...
CODE_139AA2:
LDY $E7                 ; $13:9AA2: A4 E7
LDA #$03                ; $13:9AA4: A9 03
STA $0F                 ; $13:9AA6: 85 0F

CODE_139AA8:
STA $0E                 ; $13:9AA8: 85 0E

CODE_139AAA:
LDX $0E                 ; $13:9AAA: A6 0E
...
CODE_139ADA:
LDX #$05                ; $13:9ADA: A2 05

CODE_139ADC:
LDA [$01],y             ; $13:9ADC: B7 01
...
CODE_139AEA:
LDA.l DATA_13D9EA,x     ; $13:9AEA: BF EA D9 13
RTS                     ; $13:9AEE: 60

CODE_139AEF:
LDY $E7                 ; $13:9AEF: A4 E7
STY $0C                 ; $13:9AF1: 84 0C
STZ $0D                 ; $13:9AF3: 64 0D
STZ $0F                 ; $13:9AF5: 64 0F

CODE_139AF7:
STZ $0E                 ; $13:9AF7: 64 0E

CODE_139AF9:
LDX $0D                 ; $13:9AF9: A6 0D
...
CODE_139B21:
INC $0D                 ; $13:9B21: E6 0D
INC $0D                 ; $13:9B23: E6 0D
INC $0D                 ; $13:9B25: E6 0D

CODE_139B27:
INC $0F                 ; $13:9B27: E6 0F
...
CODE_139B5E:
JSR CODE_1396D2         ; $13:9B5E: 20 D2 96
...
CODE_139B86:
CMP #$03                ; $13:9B86: C9 03
BPL CODE_139B8C         ; $13:9B88: 10 02
BRA CODE_139B97         ; $13:9B8A: 80 0B

CODE_139B8C:
LDA.l DATA_13DAA5,x     ; $13:9B8C: BF A5 DA 13
SEC                     ; $13:9B90: 38
...
CODE_139B97:
INC $0D                 ; $13:9B97: E6 0D

CODE_139B99:
LDY $00E7               ; $13:9B99: AC E7 00
...
CODE_139BE2:
JSR CODE_1396D2         ; $13:9BE2: 20 D2 96
...
CODE_139C4E:
LDA.l DATA_13DB33,x     ; $13:9C4E: BF 33 DB 13
RTS                     ; $13:9C52: 60

CODE_139C53:
LDA $0247               ; $13:9C53: AD 47 02
RTS                     ; $13:9C56: 60

CODE_139C57:
LDY $00E7               ; $13:9C57: AC E7 00
...
CODE_139C81:
LDA.l DATA_13DB3F,x     ; $13:9C81: BF 3F DB 13
...
CODE_139CCF:
JSR CODE_139D04         ; $13:9CCF: 20 04 9D
...
CODE_139CED:
CMP.l DATA_13DB49,x     ; $13:9CED: DF 49 DB 13
...
CODE_139CF8:
LDA.l DATA_13DB4B,x     ; $13:9CF8: BF 4B DB 13
BRA CODE_139D01         ; $13:9CFC: 80 03

CODE_139CFE:
LDA $0247               ; $13:9CFE: AD 47 02

CODE_139D01:
LDX $0F                 ; $13:9D01: A6 0F
RTS                     ; $13:9D03: 60

CODE_139D04:
LDA $0E                 ; $13:9D04: A5 0E
ASL A                   ; $13:9D06: 0A
TAX                     ; $13:9D07: AA
...
CODE_139D17:
LDA.l DATA_13DB51,x     ; $13:9D17: BF 51 DB 13
STA [$01],y             ; $13:9D1B: 97 01
RTS                     ; $13:9D1D: 60

CODE_139D1E:
LDA $0E                 ; $13:9D1E: A5 0E
ASL A                   ; $13:9D20: 0A
TAX                     ; $13:9D21: AA
...
CODE_139D31:
LDA.l DATA_13DB59,x     ; $13:9D31: BF 59 DB 13
...
CODE_139D6B:
LDA #$60                ; $13:9D6B: A9 60

CODE_139D6D:
STA $C5                 ; $13:9D6D: 85 C5
...
CODE_139DB4:
JSL CODE_118B2D         ; $13:9DB4: 22 2D 8B 11
...
DATA_13C700:
db $81,$12,$26,$29,$29,$29,$29,$29
db $29,$11,$25,$29,$29,$29,$29,$29
db $29

DATA_13C711:
db $01,$00,$0B,$00,$0B,$00,$0B,$00
...
DATA_13C732:
db $41,$28,$2E,$31,$16,$18,$44,$46
db $44,$46,$44,$46,$44,$29,$2F,$32
db $17,$19,$45,$47,$45,$47,$45,$47
db $45

DATA_13C74B:
db $0F,$00,$02,$04,$0E,$02,$0D,$03
...
DATA_13C84C:
db $41,$15,$15,$15,$15,$15,$3E,$2E
db $31,$34,$35,$34,$35,$15,$15,$15
db $15,$15,$3F,$2F,$32,$35,$34,$35
db $34

DATA_13C865:
db $01,$44,$46,$44,$46,$44,$46,$44
...
DATA_13C8A7:
db $41,$01,$04,$07,$0C,$0C,$0C,$36
db $37,$37,$37,$37,$37,$00,$03,$08
db $0D,$0D,$0D,$36,$37,$37,$37,$37
db $37

DATA_13C8C0:
db $0F,$00,$03,$09,$0F,$0F,$1C,$21
...
DATA_13CB84:
db $A1,$07,$13,$18,$1A,$1B,$1B,$08
db $14,$19,$1A,$1B,$1B

DATA_13CB91:
db $41,$28,$2E,$31,$34,$34,$34,$34
db $34,$34,$34,$34,$34,$29,$2F,$32
db $35,$35,$35,$35,$35,$35,$35,$35
db $35

DATA_13CBAA:
db $C1,$10,$18,$1B,$1B,$0F,$19,$1B
db $1B
...
DATA_13D49C:
db $04,$06,$08,$07,$09,$03,$0A,$02
db $0B,$06,$05,$07,$37,$47,$38,$48
db $25,$25,$89,$8B,$8A,$8C,$25,$25
db $01,$04,$02,$05,$03,$06

DATA_13D4BA:
db $02,$02,$02,$02,$08,$08,$08,$08
db $08,$08

DATA_13D4C4:
db $01,$02,$03,$04,$02,$03,$04,$05
db $06,$08
...
DATA_13D582:
db $E1,$40,$09,$65,$68,$17,$1B,$09
db $40,$09,$65,$68,$17,$1B,$09,$09
db $30,$0A,$0A,$0A,$15,$1C,$0A,$30
db $0A,$0A,$0A,$15,$1C,$0A,$0A

DATA_13D5A1:
db $31,$60,$60,$60,$60,$25,$25,$64
db $67

DATA_13D5AA:
db $51,$6A,$6F,$77,$7A,$7A,$7A,$6B
db $25,$25,$25,$67,$64
...
DATA_13D605:
db $13,$0B,$1A,$0C,$1B,$09,$18,$0A
db $19

DATA_13D60E:
db $2A,$00,$0D,$1C,$03,$0E,$1D,$04
...
CODE_13DC11:
LDA.l DATA_14B65C,x     ; $13:DC11: BF 5C B6 14
...
CODE_13DC30:
CMP.l DATA_138779,x     ; $13:DC30: DF 79 87 13
...
CODE_13DC4A:
LDA.l DATA_14B8DC,x     ; $13:DC4A: BF DC B8 14
...
CODE_13DC5E:
REP #$20                ; $13:DC5E: C2 20
LDX #$00                ; $13:DC60: A2 00

CODE_13DC62:
LDA.l DATA_15E715,x     ; $13:DC62: BF 15 E7 15
...
CODE_13DC9B:
LDA.l DATA_15E815,x     ; $13:DC9B: BF 15 E8 15
...
CODE_13DCB1:
LDA.w DATA_11C9EC,x     ; $13:DCB1: BD EC C9
...
CODE_13DCC7:
LDA.l DATA_14BAE0,x     ; $13:DCC7: BF E0 BA 14
...
DATA_13DCE8:
db $51,$7F,$40,$49,$51,$7F,$F5,$7E
db $51,$7F,$40,$49,$F5,$7E

; Accumulator and Index = 16-bit.

CODE_13DCF6:
REP #$30                ; $13:DCF6: C2 30
LDA $0635               ; $13:DCF8: AD 35 06
AND #$000F              ; $13:DCFB: 29 0F 00
ASL A                   ; $13:DCFE: 0A

; Get world number * 2 into index.
TAX                     ; $13:DCFF: AA
LDA.l DATA_13DCE8,x     ; $13:DD00: BF E8 DC 13

; Get BG colour for the 'World x-x' screen.
STA $0B00               ; $13:DD04: 8D 00 0B
LDA.l DATA_13DCDA,x     ; $13:DD07: BF DA DC 13

; Get index for different palette set.
TAX                     ; $13:DD0B: AA
LDY #$0000              ; $13:DD0C: A0 00 00

CODE_13DD0F:
LDA.l DATA_15F555,x     ; $13:DD0F: BF 55 F5 15
STA $0B20,y             ; $13:DD13: 99 20 0B
LDA.l DATA_15F575,x     ; $13:DD16: BF 75 F5 15
STA $0B40,y             ; $13:DD1A: 99 40 0B
LDA.l DATA_15F595,x     ; $13:DD1D: BF 95 F5 15

; Y = #$0000.
; Load colours into palette 1.
;
; Load colours into palette 2.
;
; Load colours into palette 7.
STA $0BE0,y             ; $13:DD21: 99 E0 0B
INX                     ; $13:DD24: E8
INX                     ; $13:DD25: E8
INY                     ; $13:DD26: C8
INY                     ; $13:DD27: C8
CPY #$0020              ; $13:DD28: C0 20 00

; Get to next colours.
;
;
;
; Check if full palette has been uploaded.
; If not, loop.
BNE CODE_13DD0F         ; $13:DD2B: D0 E2
LDA #$7FFF              ; $13:DD2D: A9 FF 7F
STA $0B7A               ; $13:DD30: 8D 7A 0B
STA $0B7C               ; $13:DD33: 8D 7C 0B

; Palette 3 colours D-F = white.
STA $0B7E               ; $13:DD36: 8D 7E 0B
LDA #$2896              ; $13:DD39: A9 96 28
STA $0BB2               ; $13:DD3C: 8D B2 0B
LDA #$495F              ; $13:DD3F: A9 5F 49
STA $0BB4               ; $13:DD42: 8D B4 0B
LDA #$6E9F              ; $13:DD45: A9 9F 6E

; Palette 5 colour 9-B = pink-ish colours.
STA $0BB6               ; $13:DD48: 8D B6 0B

; Accumulator and Index = 8-bit.
SEP #$30                ; $13:DD4B: E2 30
BRL CODE_13DEDC         ; $13:DD4D: 82 8C 01

CODE_13DD50:
LDA $0533               ; $13:DD50: AD 33 05
...
CODE_13DD70:
REP #$20                ; $13:DD70: C2 20
LDX #$00                ; $13:DD72: A2 00

CODE_13DD74:
LDA.l DATA_14B9BC,x     ; $13:DD74: BF BC B9 14
...
CODE_13DD8E:
REP #$20                ; $13:DD8E: C2 20
LDX #$00                ; $13:DD90: A2 00

CODE_13DD92:
LDA.l DATA_14BB00,x     ; $13:DD92: BF 00 BB 14
...
CODE_13DE0D:
REP #$20                ; $13:DE0D: C2 20
LDX #$00                ; $13:DE0F: A2 00

CODE_13DE11:
LDA.l DATA_14BD00,x     ; $13:DE11: BF 00 BD 14
...
CODE_13DE8C:
REP #$20                ; $13:DE8C: C2 20
LDX #$00                ; $13:DE8E: A2 00

CODE_13DE90:
LDA.l DATA_15E715,x     ; $13:DE90: BF 15 E7 15
...
CODE_13DED0:
LDA.w DATA_11BB1C,x     ; $13:DED0: BD 1C BB
...
CODE_13DEDC:
LDA #$01                ; $13:DEDC: A9 01
STA $02A9               ; $13:DEDE: 8D A9 02
RTL                     ; $13:DEE1: 6B

CODE_13DEE2:
LDA #$81                ; $13:DEE2: A9 81
...
DATA_13E135:
db $9C,$01,$18,$01,$D5,$00,$92,$00

DATA_13E13D:
db $1F,$33,$9B,$22,$17,$12,$93,$01
...
CODE_13E1F2:
STZ $0781               ; $13:E1F2: 9C 81 07

CODE_13E1F5:
LDA $0780               ; $13:E1F5: AD 80 07
...
CODE_13E233:
INC $0780               ; $13:E233: EE 80 07
BRA CODE_13E1F5         ; $13:E236: 80 BD

CODE_13E238:
LDA #$FF                ; $13:E238: A9 FF
STA $0781               ; $13:E23A: 8D 81 07

CODE_13E23D:
LDX #$18                ; $13:E23D: A2 18

CODE_13E23F:
REP #$20                ; $13:E23F: C2 20
...
CODE_13E25B:
REP #$20                ; $13:E25B: C2 20
STZ $0B00               ; $13:E25D: 9C 00 0B
LDX #$00                ; $13:E260: A2 00

CODE_13E262:
LDA.l DATA_14BFA0,x     ; $13:E262: BF A0 BF 14
...
CODE_13E433:
LDA.l DATA_13E282,x     ; $13:E433: BF 82 E2 13
...
DATA_13E449:
db $04,$0F,$11,$11,$0F,$04,$05

DATA_13E450:
db $01,$00,$03,$04,$06,$04,$04

CODE_13E457:
LDX #$06                ; $13:E457: A2 06

CODE_13E459:
LDA $0533               ; $13:E459: AD 33 05
...
CODE_13E485:
JSR CODE_13E489         ; $13:E485: 20 89 E4
RTL                     ; $13:E488: 6B
...
CODE_13E49D:
REP #$20                ; $13:E49D: C2 20
LDX #$00                ; $13:E49F: A2 00

CODE_13E4A1:
LDA.l DATA_14BF00,x     ; $13:E4A1: BF 00 BF 14
...
CODE_13E4B8:
REP #$20                ; $13:E4B8: C2 20
LDX #$00                ; $13:E4BA: A2 00

CODE_13E4BC:
LDA.l DATA_14BF40,x     ; $13:E4BC: BF 40 BF 14
...
CODE_13E4CC:
REP #$20                ; $13:E4CC: C2 20
LDX #$00                ; $13:E4CE: A2 00

CODE_13E4D0:
LDA.l DATA_14BF60,x     ; $13:E4D0: BF 60 BF 14
...
CODE_13E700:
LDA #$80                ; $13:E700: A9 80
BEQ CODE_13E706         ; $13:E702: F0 02

CODE_13E704:
LDA #$0F                ; $13:E704: A9 0F

CODE_13E706:
STA $FE                 ; $13:E706: 85 FE

CODE_13E708:
LDA $11                 ; $13:E708: A5 11
ASL A                   ; $13:E70A: 0A
TAX                     ; $13:E70B: AA
...
CODE_13E728:
LDA #$B0                ; $13:E728: A9 B0
BRA CODE_13E72E         ; $13:E72A: 80 02
LDA #$30                ; $13:E72C: A9 30

CODE_13E72E:
STA $FF                 ; $13:E72E: 85 FF
RTS                     ; $13:E730: 60

CODE_13E731:
JSR CODE_13E700         ; $13:E731: 20 00 E7
...
CODE_13E78D:
JSR CODE_13E8A4         ; $13:E78D: 20 A4 E8
...
CODE_13E79F:
JSR CODE_13E704         ; $13:E79F: 20 04 E7

CODE_13E7A2:
DEC $0210               ; $13:E7A2: CE 10 02
...
CODE_13E7B4:
DEC $E6                 ; $13:E7B4: C6 E6
LDA #$03                ; $13:E7B6: A9 03
STA $11                 ; $13:E7B8: 85 11

; Clear all OAM.
JSL CODE_14F9F0         ; $13:E7BA: 22 F0 F9 14
...
CODE_13E81A:
JSR CODE_13E708         ; $13:E81A: 20 08 E7
...
CODE_13E85C:
JSR CODE_13E94B         ; $13:E85C: 20 4B E9
...
CODE_13E88D:
JSR CODE_13E907         ; $13:E88D: 20 07 E9
...
CODE_13E8D3:
LDA.w DATA_11C18B,y     ; $13:E8D3: B9 8B C1
STA $0820,y             ; $13:E8D6: 99 20 08
DEY                     ; $13:E8D9: 88
BPL CODE_13E8D3         ; $13:E8DA: 10 F7

CODE_13E8DC:
STZ $0A20               ; $13:E8DC: 9C 20 0A
...
CODE_13E94B:
LDX #$0F                ; $13:E94B: A2 0F

CODE_13E94D:
LDA.l DATA_14C564,x     ; $13:E94D: BF 64 C5 14
...
DATA_13E978:
db $E0,$58,$40,$6D,$A0,$7D,$80,$7E
db $FF,$7F

CODE_13E982:
DEC $28                 ; $13:E982: C6 28
...
CODE_13EB70:
LDA #$F0                ; $13:EB70: A9 F0

CODE_13EB72:
STA $0849               ; $13:EB72: 8D 49 08
...
CODE_13EBAE:
LDA #$F0                ; $13:EBAE: A9 F0

CODE_13EBB0:
STA $0851               ; $13:EBB0: 8D 51 08
...
CODE_13EC34:
LDA #$F0                ; $13:EC34: A9 F0

CODE_13EC36:
STA $0891               ; $13:EC36: 8D 91 08
...
CODE_13EC4E:
LDA $2E                 ; $13:EC4E: A5 2E
AND #$01                ; $13:EC50: 29 01
BNE CODE_13EC57         ; $13:EC52: D0 03

CODE_13EC54:
JMP CODE_13ED3F         ; $13:EC54: 4C 3F ED

CODE_13EC57:
LDA $08C1               ; $13:EC57: AD C1 08
...
CODE_13ECD3:
LDA #$F0                ; $13:ECD3: A9 F0

CODE_13ECD5:
STA $08D1               ; $13:ECD5: 8D D1 08
...
CODE_13ECF3:
LDA.l DATA_14CB4A,x     ; $13:ECF3: BF 4A CB 14
...
CODE_13ED40:
LDX #$43                ; $13:ED40: A2 43

CODE_13ED42:
LDA.l DATA_14CB6A,x     ; $13:ED42: BF 6A CB 14
...
CODE_13EE63:
LDA.l DATA_14C574,x     ; $13:EE63: BF 74 C5 14
...
CODE_13EE76:
LDA.l DATA_14C57A,x     ; $13:EE76: BF 7A C5 14
...
DATA_13EE87:
db $80,$7E,$A0,$7D,$40,$6D,$E0,$58
db $80,$44

CODE_13EE91:
DEC $28                 ; $13:EE91: C6 28
...
CODE_13EF0D:
LDA.l DATA_14CBDC,x     ; $13:EF0D: BF DC CB 14
TAY                     ; $13:EF11: A8
...
CODE_13F04C:
STZ $0208               ; $13:F04C: 9C 08 02

CODE_13F04F:
STZ $0209               ; $13:F04F: 9C 09 02
...
CODE_13F073:
JSL CODE_13F1BF         ; $13:F073: 22 BF F1 13
...
CODE_13F0AC:
STZ $0B                 ; $13:F0AC: 64 0B

CODE_13F0AE:
LDA $02C2               ; $13:F0AE: AD C2 02
...
CODE_13F0E5:
LDA $0C                 ; $13:F0E5: A5 0C

CODE_13F0E7:
STA $0257,x             ; $13:F0E7: 9D 57 02
DEX                     ; $13:F0EA: CA
...
CODE_13F102:
STZ $02C2               ; $13:F102: 9C C2 02

CODE_13F105:
JSR CODE_13F343         ; $13:F105: 20 43 F3
RTS                     ; $13:F108: 60
...
CODE_13F13C:
LDA.w DATA_119B3C,y     ; $13:F13C: B9 3C 9B

CODE_13F13F:
STA $0261               ; $13:F13F: 8D 61 02
RTS                     ; $13:F142: 60

CODE_13F143:
LDA $0202               ; $13:F143: AD 02 02
...
CODE_13F2C7:
LDA $02DF               ; $13:F2C7: AD DF 02
STA $00                 ; $13:F2CA: 85 00
LDA $02E0               ; $13:F2CC: AD E0 02
STA $01                 ; $13:F2CF: 85 01
LDA $02E1               ; $13:F2D1: AD E1 02

; [$00] = Pointer to Map16 tileset.
STA $02                 ; $13:F2D4: 85 02
LDY $0256               ; $13:F2D6: AC 56 02

; Accumulator and Index = 16-bit.
REP #$30                ; $13:F2D9: C2 30
LDA [$C4],y             ; $13:F2DB: B7 C4
AND #$00FF              ; $13:F2DD: 29 FF 00
CMP #$00FF              ; $13:F2E0: C9 FF 00

; Check if Layer 2 Map16 tile = #$FF.
;
;
; If not, branch.
BNE CODE_13F2F5         ; $13:F2E3: D0 10
LDA.l PNTR_13A613       ; $13:F2E5: AF 13 A6 13
STA $00                 ; $13:F2E9: 85 00
...
; Multiply by 8 (8 bytes for 1 Map16 tile)
;
;
; Into Y.
TAY                     ; $13:F2F8: A8
...
CODE_13F2F9:
LDA [$00],y             ; $13:F2F9: B7 00
STA $7F0002,x           ; $13:F2FB: 9F 02 00 7F
INY                     ; $13:F2FF: C8
INY                     ; $13:F300: C8
LDA [$00],y             ; $13:F301: B7 00
STA $7F0042,x           ; $13:F303: 9F 42 00 7F
INY                     ; $13:F307: C8
INY                     ; $13:F308: C8
LDA [$00],y             ; $13:F309: B7 00
STA $7F0004,x           ; $13:F30B: 9F 04 00 7F
INY                     ; $13:F30F: C8
INY                     ; $13:F310: C8
LDA [$00],y             ; $13:F311: B7 00

; Store top-left tile.
;
; Get to next tile.
;
; Store bottom-left tile.
;
; Get to next tile.
;
; Store top-right tile.
;
; Get to next tile.
;
; Store bottom-right tile.
STA $7F0044,x           ; $13:F313: 9F 44 00 7F

; Accumulator and Index = 8-bit.
SEP #$30                ; $13:F317: E2 30
...
CODE_13F367:
LDA #$01                ; $13:F367: A9 01

CODE_13F369:
STA $0203               ; $13:F369: 8D 03 02
...
CODE_13F391:
LDA #$00                ; $13:F391: A9 00

CODE_13F393:
STA $0203               ; $13:F393: 8D 03 02
...
CODE_13F3A4:
LDA $0200               ; $13:F3A4: AD 00 02
LSR A                   ; $13:F3A7: 4A
ORA #$80                ; $13:F3A8: 09 80
STA $0202               ; $13:F3AA: 8D 02 02

CODE_13F3AD:
LDA $0202               ; $13:F3AD: AD 02 02
...
; Get level + room number into index.
TAX                     ; $13:F3C4: AA
LDA.l DATA_13A61D,x     ; $13:F3C5: BF 1D A6 13
ASL A                   ; $13:F3C9: 0A

; Load a certain Layer 2 Map16 tileset.
TAX                     ; $13:F3CA: AA
LDA.l PNTR_13A6E5,x     ; $13:F3CB: BF E5 A6 13

; Tileset pointer, low byte, into $02DF.
STA $02DF               ; $13:F3CF: 8D DF 02
INX                     ; $13:F3D2: E8
LDA.l PNTR_13A6E5,x     ; $13:F3D3: BF E5 A6 13

; Tileset pointer, high byte, into $02E0.
STA $02E0               ; $13:F3D7: 8D E0 02
LDA #$13                ; $13:F3DA: A9 13

; Bank number = #$13.
; Into $02E1.
STA $02E1               ; $13:F3DC: 8D E1 02

; Return.
RTS                     ; $13:F3DF: 60

CODE_13F3E0:
REP #$20                ; $13:F3E0: C2 20
...
;
; If not, branch.
BNE CODE_13F44A         ; $13:F438: D0 10
LDA.l PNTR_13A613       ; $13:F43A: AF 13 A6 13
STA $00                 ; $13:F43E: 85 00
LDA #$0013              ; $13:F440: A9 13 00

; Load empty tile data.
; ($13A615)
STA $02                 ; $13:F443: 85 02

; Y = #$0000.
LDY #$0000              ; $13:F445: A0 00 00
...
CODE_13F66A:
CMP #$07                ; $13:F66A: C9 07
BNE CODE_13F6A2         ; $13:F66C: D0 34
LDA #$03                ; $13:F66E: A9 03

CODE_13F670:
STA $02B9,x             ; $13:F670: 9D B9 02

CODE_13F673:
RTL                     ; $13:F673: 6B

CODE_13F674:
LDA $025B,x             ; $13:F674: BD 5B 02
CLC                     ; $13:F677: 18
...
CODE_13F69C:
CMP #$0C                ; $13:F69C: C9 0C
BNE CODE_13F6A2         ; $13:F69E: D0 02
LDA #$00                ; $13:F6A0: A9 00

CODE_13F6A2:
STA $02B9,x             ; $13:F6A2: 9D B9 02

CODE_13F6A5:
RTL                     ; $13:F6A5: 6B

CODE_13F6A6:
LDA $0258,x             ; $13:F6A6: BD 58 02
SEC                     ; $13:F6A9: 38
...
CODE_13F77D:
LDA $7F0000             ; $13:F77D: AF 00 00 7F
TAX                     ; $13:F781: AA
...
LDA [$C4],y             ; $13:F7CC: B7 C4
AND #$00FF              ; $13:F7CE: 29 FF 00
CMP #$00FF              ; $13:F7D1: C9 FF 00

; Check if Layer 2 Map16 tile = #$FF.
BNE CODE_13F7E6         ; $13:F7D4: D0 10
LDA.l PNTR_13A613       ; $13:F7D6: AF 13 A6 13
STA $00                 ; $13:F7DA: 85 00
...
CODE_13F84F:
JMP CODE_13F862         ; $13:F84F: 4C 62 F8

CODE_13F852:
LDA $0258,x             ; $13:F852: BD 58 02
...
CODE_13F92E:
LDA.w DATA_11CB56,y     ; $13:F92E: B9 56 CB
...
; Get index (position) to the corresponding Map16 tile.
LDY $E7                 ; $13:F974: A4 E7
LDA [$0D],y             ; $13:F976: B7 0D

; If Map16 page 0, branch.
BEQ CODE_13F983         ; $13:F978: F0 09
LDA [$01],y             ; $13:F97A: B7 01
TAX                     ; $13:F97C: AA
LDA.l DATA_14CCBD,x     ; $13:F97D: BF BD CC 14

; All tiles on page 1 must act like...
;
; $2C, $40, $AB or $C0...
; from page 0.
BRA CODE_13F985         ; $13:F981: 80 02

; This is for page 0, just act what it's supposed to act like.

CODE_13F983:
LDA [$01],y             ; $13:F983: B7 01
...
; Map16 tile 'acts like'.

CODE_13F997:
STA $00                 ; $13:F997: 85 00
PLA                     ; $13:F999: 68
TAX                     ; $13:F99A: AA
RTL                     ; $13:F99B: 6B
...
CODE_13F9C8:
LDA $04CC               ; $13:F9C8: AD CC 04
EOR.w DATA_119BBA,y     ; $13:F9CB: 59 BA 9B
BPL CODE_13F9D3         ; $13:F9CE: 10 03
STX $04CC               ; $13:F9D0: 8E CC 04

CODE_13F9D3:
STX $0407               ; $13:F9D3: 8E 07 04
RTL                     ; $13:F9D6: 6B

CODE_13F9D7:
LDA #$02                ; $13:F9D7: A9 02

; Pick something up animation.
STA $50                 ; $13:F9D9: 85 50
STZ $078C               ; $13:F9DB: 9C 8C 07
LDA #$06                ; $13:F9DE: A9 06

; Amount of frames it should take to pick the enemy up.
STA $82                 ; $13:F9E0: 85 82
LDA #$08                ; $13:F9E2: A9 08
STA $C7                 ; $13:F9E4: 85 C7
INC $9C                 ; $13:F9E6: E6 9C
LDA #$3C                ; $13:F9E8: A9 3C

; Picking something up sound effect.
...
CODE_13FADD:
CMP #$00                ; $13:FADD: C9 00
BEQ CODE_13FAE3         ; $13:FADF: F0 02
SEC                     ; $13:FAE1: 38
RTS                     ; $13:FAE2: 60

CODE_13FAE3:
LDA $0006,y             ; $13:FAE3: B9 06 00
...
CODE_13FAFD:
JSR CODE_13FAB9         ; $13:FAFD: 20 B9 FA

CODE_13FB00:
BCS CODE_13FB0F         ; $13:FB00: B0 0D
PHA                     ; $13:FB02: 48
TYA                     ; $13:FB03: 98
LSR A                   ; $13:FB04: 4A
TAX                     ; $13:FB05: AA
...
CODE_13FB2D:
LDA $04BC               ; $13:FB2D: AD BC 04

CODE_13FB30:
STA $0C00               ; $13:FB30: 8D 00 0C
...
CODE_13FB5D:
LDA.l DATA_11AB63,x     ; $13:FB5D: BF 63 AB 11
...
; Preserve sprite index.

CODE_13FBC2:
PHX                     ; $13:FBC2: DA
LDX $0628               ; $13:FBC3: AE 28 06
CPX #$02                ; $13:FBC6: E0 02

; Don't flash colours if in potion room.
BEQ CODE_13FC1A         ; $13:FBC8: F0 50

; A = 16-bit
REP #$20                ; $13:FBCA: C2 20
AND #$00FF              ; $13:FBCC: 29 FF 00

; If value is zero...
; branch.
BEQ CODE_13FBDF         ; $13:FBCF: F0 0E
LDA $10                 ; $13:FBD1: A5 10
AND #$0003              ; $13:FBD3: 29 03 00
TAX                     ; $13:FBD6: AA
LDA.w DATA_11AB83,x     ; $13:FBD7: BD 83 AB
STA $0B00               ; $13:FBDA: 8D 00 0B

; Flash through 4 different colours...
; <--
;
; Apparently, the 16-bit colour values interfer with eachother (no ASL is included, table is not 8 bytes long but only 5 bytes)
; This may complicate hex editing the colours to your likings.
BRA CODE_13FBED         ; $13:FBDD: 80 0E

; No flashing BG colour.

CODE_13FBDF:
STZ $0B00               ; $13:FBDF: 9C 00 0B
...
; Update palettes and return appropiately.
BRA CODE_13FC15         ; $13:FC59: 80 BA

CODE_13FC5B:
REP #$30                ; $13:FC5B: C2 30
LDY #$0120              ; $13:FC5D: A0 20 01

CODE_13FC60:
LDA $0801,y             ; $13:FC60: B9 01 08
...
CODE_13FC81:
STY $02F8               ; $13:FC81: 8C F8 02
SEP #$30                ; $13:FC84: E2 30
LDX $12                 ; $13:FC86: A6 12
RTL                     ; $13:FC88: 6B

CODE_13FC89:
LDY $0533               ; $13:FC89: AC 33 05
LDA.w DATA_11D098,y     ; $13:FC8C: B9 98 D0
CLC                     ; $13:FC8F: 18
ADC $0534               ; $13:FC90: 6D 34 05
TAX                     ; $13:FC93: AA
LDA.l DATA_11CF52,x     ; $13:FC94: BF 52 CF 11
CMP #$FF                ; $13:FC98: C9 FF

; Get level + room number into X index.
;
;
;
;
; Check HDMA BG table.
; If value = $FF, don't load a HDMA BG.
BEQ CODE_13FCA0         ; $13:FC9A: F0 04

; Load HDMA BG.
JSL CODE_14FAE8         ; $13:FC9C: 22 E8 FA 14
