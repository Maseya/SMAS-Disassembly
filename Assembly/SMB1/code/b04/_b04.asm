...
STA $00                 ; $04:8003: 85 00
STZ $2115               ; $04:8005: 9C 15 21
REP #$20                ; $04:8008: C2 20
LDA #$4300              ; $04:800A: A9 00 43
TCD                     ; $04:800D: 5B
LDA #$0800              ; $04:800E: A9 00 08
...
; (BG1 and half of BG2 tilemap)
; Clear VRAM 0000-17FF with 24,00,24,00,etc
;
;
; Also clear VRAM B0F0-BFFF with 24,00,24,00,etc
; (layer 3 tilemap)
RTL                     ; $04:80AD: 6B

CODE_0480AE:
LDA #$28                ; $04:80AE: A9 28
STA $00                 ; $04:80B0: 85 00
STZ $2115               ; $04:80B2: 9C 15 21
REP #$20                ; $04:80B5: C2 20
LDA #$5800              ; $04:80B7: A9 00 58
STA $2116               ; $04:80BA: 8D 16 21
LDA #$1808              ; $04:80BD: A9 08 18
STA $4300               ; $04:80C0: 8D 00 43
STZ $4302               ; $04:80C3: 9C 02 43
...
; Clear entire layer 3 tilemap with 28 00 28 00 etc
; Tilemap is located at $B000-$B3FF
;
; Format: Tile, properties, tile, etc
;
; Clears tilemap by fixed DMA.
;
; Only runs during game loading
RTL                     ; $04:80EE: 6B
...
CODE_04817A:
LDA #$00                ; $04:817A: A9 00

CODE_04817C:
STA $2140               ; $04:817C: 8D 40 21
STA $1604               ; $04:817F: 8D 04 16
STZ $160A               ; $04:8182: 9C 0A 16

CODE_048185:
LDA $1601               ; $04:8185: AD 01 16
...
CODE_04819E:
LDA #$00                ; $04:819E: A9 00

CODE_0481A0:
STA $2141               ; $04:81A0: 8D 41 21
AND #$0F                ; $04:81A3: 29 0F
STA $1605               ; $04:81A5: 8D 05 16
STZ $160B               ; $04:81A8: 9C 0B 16

CODE_0481AB:
LDA $1602               ; $04:81AB: AD 02 16
...
CODE_04825E:
STZ $420C               ; $04:825E: 9C 0C 42

; Disable HDMA channels
STZ $1203               ; $04:8261: 9C 03 12

; main screen window mask designation: null
STZ $1207               ; $04:8264: 9C 07 12

; sub screen window mask designation: null
STZ $1208               ; $04:8267: 9C 08 12

; window mask settings for bg1/2: null
STZ $1204               ; $04:826A: 9C 04 12

; ^for bg3/4: null
STZ $1205               ; $04:826D: 9C 05 12

; ^for OBJ and color window: null
STZ $1206               ; $04:8270: 9C 06 12

; Color addition select: null
STZ $1209               ; $04:8273: 9C 09 12
LDX #$20                ; $04:8276: A2 20

; CGADSUB: Enable color math on backdrop
STX $120A               ; $04:8278: 8E 0A 12
CMP #$FF                ; $04:827B: C9 FF
BNE CODE_048280         ; $04:827D: D0 01

; If there's a HDMA gradient, execute the gradient code
RTL                     ; $04:827F: 6B
...
; HDMA gradient type goes into $00. See $7E00F1 for types
STA $00                 ; $04:8283: 85 00
ASL A                   ; $04:8285: 0A
TAY                     ; $04:8286: A8
PHY                     ; $04:8287: 5A
...
CODE_048292:
LDA DATA_0483AC,x       ; $04:8292: BD AC 83
STA $1520,y             ; $04:8295: 99 20 15
LDA DATA_04840E,x       ; $04:8298: BD 0E 84
STA $1560,y             ; $04:829B: 99 60 15
...
; Copy indirect HDMA pointers to RAM until you're done
...
CODE_0482B5:
LDA DATA_0484D2,x       ; $04:82B5: BD D2 84
...
; 16-bit XY.
REP #$10                ; $04:82CD: C2 10
LDX #$3240              ; $04:82CF: A2 40 32
STX $4350               ; $04:82D2: 8E 50 43
STX $4360               ; $04:82D5: 8E 60 43

; Base reg: $2132 (direct color data)
; 1 reg write once, indirect pointers
; We are setting up 3 HDMA channels it seems
STX $4370               ; $04:82D8: 8E 70 43
LDX #$1520              ; $04:82DB: A2 20 15
STX $4352               ; $04:82DE: 8E 52 43
LDX #$1560              ; $04:82E1: A2 60 15
STX $4362               ; $04:82E4: 8E 62 43
LDX #$15A0              ; $04:82E7: A2 A0 15
STX $4372               ; $04:82EA: 8E 72 43
...
STA $4367               ; $04:82FF: 8D 67 43
LDA #$00                ; $04:8302: A9 00

; Indirect HDMA bank bytes: $00
STA $4377               ; $04:8304: 8D 77 43
LDA #$01                ; $04:8307: A9 01

; Timer to move the gradient up and down(water)
; Set to 1 so it doesn't keep moving up-down.
STA $15E0               ; $04:8309: 8D E0 15
LDA $00                 ; $04:830C: A5 00
CMP #$02                ; $04:830E: C9 02
BNE CODE_048357         ; $04:8310: D0 45
LDX #$2841              ; $04:8312: A2 41 28

; Base reg: $2128. Indirect pointers.
; 2 regs write once (Window 2 L+R position)
STX $4340               ; $04:8315: 8E 40 43
LDX.w #DATA_0483A5      ; $04:8318: A2 A5 83
STX $4342               ; $04:831B: 8E 42 43
LDA.b #DATA_0483A5>>16  ; $04:831E: A9 04
STA $4344               ; $04:8320: 8D 44 43
LDA #$04                ; $04:8323: A9 04

; DMA source: $04:83A5
STA $4347               ; $04:8325: 8D 47 43
LDA #$17                ; $04:8328: A9 17

; Window mask designation for main screen
; Everything except BG4
STA $1207               ; $04:832A: 8D 07 12

; Window mask designation for sub screen: none
STZ $1208               ; $04:832D: 9C 08 12
STZ $1204               ; $04:8330: 9C 04 12

; Window Mask Settings for BG1/2/3/4
STZ $1205               ; $04:8333: 9C 05 12
LDA #$80                ; $04:8336: A9 80

; Enable window 2 for BG1/BG3/OBJ
STA $1206               ; $04:8338: 8D 06 12
LDA #$10                ; $04:833B: A9 10

; Prevent color math outside window
STA $1209               ; $04:833D: 8D 09 12
LDA #$33                ; $04:8340: A9 33

; Enable color math on OBJ & Backdrop & BG1/2
STA $120A               ; $04:8342: 8D 0A 12
LDA #$F0                ; $04:8345: A9 F0

; Enable HDMA channels 7/6/5/4
STA $1203               ; $04:8347: 8D 03 12
STZ $1000               ; $04:834A: 9C 00 10
...
CODE_048357:
LDA #$E0                ; $04:8357: A9 E0

; Enable HDMA channels 7/6/5
STA $1203               ; $04:8359: 8D 03 12

; 8-bit XY
SEP #$10                ; $04:835C: E2 10
...
; The very small pauses between going up and down 1 time
...
DATA_0483A5:
db $27,$92,$85,$02,$94,$85,$00

; Red indirect pointers. Scanline - ram address (word) - scanline - etc

DATA_0483AC:
db $40,$00,$14,$08,$01,$14,$08,$02
...
; green indirect pointers

DATA_04840E:
db $40,$60,$14,$08,$61,$14,$08,$62
...
; blue indirect pointers

DATA_048470:
db $40,$C0,$14,$08,$C1,$14,$08,$C2
...
; red intensity stuff. Actual data of $2132
...
CODE_048600:
LDA $1680               ; $04:8600: AD 80 16
BMI CODE_048629         ; $04:8603: 30 24

; "pause" flag after rescuing princess
; skip all of these if negative, if 00 check for start button etc
BNE CODE_048619         ; $04:8605: D0 12
LDX $0753               ; $04:8607: AE 53 07
LDA $0FF6,x             ; $04:860A: BD F6 0F
AND #$10                ; $04:860D: 29 10
BEQ CODE_048629         ; $04:860F: F0 18

; Check for start button press
; If pressed, enable "pause" flag after rescuing princess
INC $1680               ; $04:8611: EE 80 16
LDA #$43                ; $04:8614: A9 43

; Pause sound
STA $1600               ; $04:8616: 8D 00 16

CODE_048619:
DEC $0B9A               ; $04:8619: CE 9A 0B
DEC $0B9A               ; $04:861C: CE 9A 0B
LDA $0B9A               ; $04:861F: AD 9A 0B

; Decrease portrait windowing hdma size until negative values
BPL CODE_048629         ; $04:8622: 10 05
LDA #$0D                ; $04:8624: A9 0D

; Rescued peach victory operation mode $0D
STA $0772               ; $04:8626: 8D 72 07
...
CODE_04862A:
JSL CODE_05DE31         ; $04:862A: 22 31 DE 05

; Enable the more difficult quest flag
JSL CODE_05EB5A         ; $04:862E: 22 5A EB 05
LDA #$22                ; $04:8632: A9 22

; Enable window 1 on BG1 and 2
STA $1204               ; $04:8634: 8D 04 12
LDA #$02                ; $04:8637: A9 02

; Enable window 1 on BG3
STA $1205               ; $04:8639: 8D 05 12

; go to operation $0E
INC $0772               ; $04:863C: EE 72 07
RTL                     ; $04:863F: 6B

; Rescued peach - Operation $0E

CODE_048640:
LDA $2140               ; $04:8640: AD 40 21

; If there's something playing in SFX channel 0, skip.
BNE CODE_04864F         ; $04:8643: D0 0A
LDA #$0C                ; $04:8645: A9 0C

; Operation mode $0C
STA $0772               ; $04:8647: 8D 72 07
LDA #$80                ; $04:864A: A9 80

; Set pause flag after rescuing princess to negative. (unpause flag?)
STA $1680               ; $04:864C: 8D 80 16
...
CODE_04866D:
LDY #$03                ; $04:866D: A0 03

CODE_04866F:
LDA DATA_0486DB,y       ; $04:866F: B9 DB 86
...
CODE_0486B8:
LDA DATA_0486D9,y       ; $04:86B8: B9 D9 86
TAX                     ; $04:86BB: AA
LDY #$07                ; $04:86BC: A0 07

CODE_0486BE:
STZ $07DA,x             ; $04:86BE: 9E DA 07
...
CODE_0486E7:
LDA DATA_0486FD,x       ; $04:86E7: BD FD 86
...
CODE_0487DC:
STA $7FF000,x           ; $04:87DC: 9F 00 F0 7F

CODE_0487E0:
LDA $96                 ; $04:87E0: A5 96
CLC                     ; $04:87E2: 18
...
CODE_0487F9:
STA $7FF000,x           ; $04:87F9: 9F 00 F0 7F

CODE_0487FD:
INC $90                 ; $04:87FD: E6 90
...
CODE_04880D:
JMP CODE_048750         ; $04:880D: 4C 50 87

CODE_048810:
SEP #$30                ; $04:8810: E2 30
...
CODE_048817:
SEP #$10                ; $04:8817: E2 10
LDX #$00                ; $04:8819: A2 00

CODE_04881B:
STZ $05D0,x             ; $04:881B: 9E D0 05
...
CODE_0488A0:
LDA DATA_048877,x       ; $04:88A0: BD 77 88
...
CODE_0488AE:
LDX #$00                ; $04:88AE: A2 00

CODE_0488B0:
LDA DATA_048886,x       ; $04:88B0: BD 86 88
...
; Flag for vertically extendable objects

CODE_0488BF:
STZ $F6                 ; $04:88BF: 64 F6

; Accumulator 16-bit - Index 16-bit
REP #$30                ; $04:88C1: C2 30
LDA $0EEC               ; $04:88C3: AD EC 0E
STA $F3                 ; $04:88C6: 85 F3
STZ $F7                 ; $04:88C8: 64 F7

CODE_0488CA:
LDX $F3                 ; $04:88CA: A6 F3
...
; The change in position of the flow.
ADC #$0008              ; $04:88F4: 69 08 00
STA $7F2000,x           ; $04:88F7: 9F 00 20 7F
LDA $F3                 ; $04:88FB: A5 F3
CLC                     ; $04:88FD: 18

; The frequency of the waving.
ADC #$0010              ; $04:88FE: 69 10 00
...
; HDMA underwater wavy table

DATA_048949:
dw $0000,$FFFA,$FFF4,$FFEE

; uses one addition-subtraction instruction only
dw $FFE7,$FFE1,$FFDB,$FFD5
...
CODE_048C57:
LDA #$2C2E              ; $04:8C57: A9 2E 2C
LDY #$2C2F              ; $04:8C5A: A0 2F 2C

CODE_048C5D:
STA $1A06,x             ; $04:8C5D: 9D 06 1A
TYA                     ; $04:8C60: 98
...
CODE_048C8F:
LDA #$5C                ; $04:8C8F: A9 5C

CODE_048C91:
STA $F3                 ; $04:8C91: 85 F3
...
; $00,$00,$80,$07. Those byte combinations are unknown

DATA_048C9E:
db $00,$00,$80,$07,$62,$2E,$72,$2E

; Remaining: Tile, properties, tile, properties, etc.
...
LDA $FB                 ; $04:8E1E: A5 FB
STA $F4                 ; $04:8E20: 85 F4
LDA $FC                 ; $04:8E22: A5 FC

; Copy low, high and bank bytes
; of the level objects pointer.
STA $F5                 ; $04:8E24: 85 F5
LDA [$F3],y             ; $04:8E26: B7 F3
REP #$20                ; $04:8E28: C2 20
AND #$007F              ; $04:8E2A: 29 7F 00
TAX                     ; $04:8E2D: AA
...
; to index
; 8-bit A.
SEP #$20                ; $04:8E2E: E2 20
LDA PNTR_048E43,x       ; $04:8E30: BD 43 8E
STA $00                 ; $04:8E33: 85 00
LDA PNTR_048E43+1,x     ; $04:8E35: BD 44 8E
STA $01                 ; $04:8E38: 85 01

; Load indirect pointers for object handling
;
;
; 8-bit XY
SEP #$10                ; $04:8E3A: E2 10

; Sprite index in X
LDX $9E                 ; $04:8E3C: A6 9E
...
; $08 - Vertical rope for pulley lift
dw CODE_048EBB

; $09 - Place an empty tile out of bounds at Y=15 (never used)
dw CODE_048EA5
...
; $14 - Vertically extendable square castle ceiling tiles (caps ceiling edges)
dw CODE_048FD2
...
; $19 - Descending steps at beginning of castle areas
dw CODE_04903E

; $1A - Rectangular ceiling tiles in castles
dw CODE_04907A

; $1B - Right edge for castle floor (recommend L = 0)
dw CODE_0490A0

; $1C - Left edge for castle floor (recommend L = 0)
dw CODE_0490C2

; $1D - Bottom left inverted corner for castle floor (recommend L = 1)
dw CODE_0490EB

; $1E - Bottom right inverted corner for castle floor (L > 0 renders castle floor too)
dw CODE_049121

; $1F - Vertical sea blocks for underwater areas
dw CODE_04915C
...
; $28 - Vertical balls/rope/vine for climbing
dw CODE_0491B3
...
CODE_048EA5:
JSR CODE_0491C0         ; $04:8EA5: 20 C0 91
...
; Place tile into levle
JSL CODE_03AD0B         ; $04:8EC3: 22 0B AD 03
PLA                     ; $04:8EC7: 68
TAX                     ; $04:8EC8: AA
...
CODE_048ECE:
LDA #$40                ; $04:8ECE: A9 40

; Place tile into level
JSL CODE_03AD0B         ; $04:8ED0: 22 0B AD 03
PLB                     ; $04:8ED4: AB
RTL                     ; $04:8ED5: 6B

; small castle/top of big castle map16 tilemap
...
; bottom of big castle tilemap.
db $E5,$E4,$CB,$CA,$C9,$C8,$C7,$C4

; first 2 bytes are for the leftmost flag, which
...
CODE_048F44:
JSR CODE_0491C0         ; $04:8F44: 20 C0 91
...
CODE_048F60:
LDA DATA_048ED6,y       ; $04:8F60: B9 D6 8E
...
; Sprite to generate: Star Flag
STA $1C,x               ; $04:8FB3: 95 1C
...
CODE_048FD2:
JSR CODE_0491C0         ; $04:8FD2: 20 C0 91
...
; Height of the 'cement block stairs' segments.

DATA_049009:
db $07,$07,$06,$05,$04,$03,$02,$01

; Each number defines the amount of cement blocks
db $00

; Y-placement of the cement block stair blocks
...
CODE_04901B:
JSR CODE_0491C0         ; $04:901B: 20 C0 91
...
; Place tile into levle
JSL CODE_03AD0B         ; $04:9038: 22 0B AD 03
PLB                     ; $04:903C: AB
RTL                     ; $04:903D: 6B

CODE_04903E:
JSR CODE_0491C0         ; $04:903E: 20 C0 91
...
CODE_04907A:
JSR CODE_0491C0         ; $04:907A: 20 C0 91
...
CODE_0490A0:
JSR CODE_0491C0         ; $04:90A0: 20 C0 91
...
CODE_0490C2:
JSR CODE_0491C0         ; $04:90C2: 20 C0 91
...
CODE_0490EB:
JSR CODE_0491C0         ; $04:90EB: 20 C0 91
...
CODE_049110:
LDA #$EB                ; $04:9110: A9 EB

CODE_049112:
STA $06A1,y             ; $04:9112: 99 A1 06
...
CODE_049121:
JSR CODE_0491C0         ; $04:9121: 20 C0 91
...
CODE_04913A:
LDA #$F0                ; $04:913A: A9 F0

CODE_04913C:
STA $06A1,y             ; $04:913C: 99 A1 06
...
; > Level X-2 'go to the surface' pipe tilemap
...
; Place tile into level
JSL CODE_03AD0B         ; $04:919E: 22 0B AD 03
CLC                     ; $04:91A2: 18

CODE_0491A3:
LDY $06                 ; $04:91A3: A4 06
...
CODE_0491B3:
JSR CODE_0491C0         ; $04:91B3: 20 C0 91
LDX #$02                ; $04:91B6: A2 02
LDA #$77                ; $04:91B8: A9 77

; Place tile into level
JSL CODE_03AD0B         ; $04:91BA: 22 0B AD 03
PLB                     ; $04:91BE: AB
RTL                     ; $04:91BF: 6B
...
CODE_0491F1:
LDA DATA_049CC7,x       ; $04:91F1: BD C7 9C
...
CODE_049200:
LDA DATA_049C55,x       ; $04:9200: BD 55 9C
...
CODE_04920F:
LDX #$0000              ; $04:920F: A2 00 00

CODE_049212:
LDA DATA_049D59,x       ; $04:9212: BD 59 9D
...
CODE_049418:
LDA DATA_049DAD,x       ; $04:9418: BD AD 9D
...
CODE_049434:
LDA DATA_049DEB,x       ; $04:9434: BD EB 9D
...
CODE_049451:
LDA DATA_04AD6F,x       ; $04:9451: BD 6F AD
...
CODE_049476:
LDA DATA_04AD9B,x       ; $04:9476: BD 9B AD
...
CODE_0494BB:
JSL CODE_049A88         ; $04:94BB: 22 88 9A 04
...
CODE_049513:
LDA $0EFE               ; $04:9513: AD FE 0E
AND #$01                ; $04:9516: 29 01
STA $0EF6               ; $04:9518: 8D F6 0E
STZ $0EFC               ; $04:951B: 9C FC 0E
STZ $0EF8               ; $04:951E: 9C F8 0E

; Load background, hdma, aesthethics, etc
JSL CODE_058000         ; $04:9521: 22 00 80 05
...
; Return if not starry night background flag.
BEQ CODE_049563         ; $04:954F: F0 12
...
; indirect hdma table. points to ram 7F2000 and beyond in continuous mode
...
CODE_04958B:
LDA #$06                ; $04:958B: A9 06
STA $1209               ; $04:958D: 8D 09 12
LDX #$11                ; $04:9590: A2 11
BRA CODE_0495C0         ; $04:9592: 80 2C

; 16-bit A. Start of a DMA code.

CODE_049594:
REP #$20                ; $04:9594: C2 20
LDA #$0F42              ; $04:9596: A9 42 0F
STA $4320               ; $04:9599: 8D 20 43
LDA.w #DATA_049564      ; $04:959C: A9 64 95
STA $4322               ; $04:959F: 8D 22 43
LDX.b #DATA_049564>>16  ; $04:95A2: A2 04
STX $4324               ; $04:95A4: 8E 24 43
LDY #$7F                ; $04:95A7: A0 7F
STY $4327               ; $04:95A9: 8C 27 43

; Indirect HDMA, 1 reg write twice to BG2 horizontal scroll
;
;
; $049564: Pointer to indirect HDMA pointer table
...
CODE_0495C0:
STX $120B               ; $04:95C0: 8E 0B 12
STA $120C               ; $04:95C3: 8D 0C 12
STZ $0ED9               ; $04:95C6: 9C D9 0E
LDA #$1F                ; $04:95C9: A9 1F
STA $0EF2               ; $04:95CB: 8D F2 0E
LDA $0ED1               ; $04:95CE: AD D1 0E

; If starry night BG flag is set
BEQ CODE_0495DD         ; $04:95D1: F0 0A
LDA #$AF                ; $04:95D3: A9 AF

; Set IRQ V-timer to AF
STA $0EF2               ; $04:95D5: 8D F2 0E
LDA #$02                ; $04:95D8: A9 02

; Enable IRQ
STA $0EDE               ; $04:95DA: 8D DE 0E

CODE_0495DD:
JSR CODE_0495E2         ; $04:95DD: 20 E2 95
PLB                     ; $04:95E0: AB
RTL                     ; $04:95E1: 6B

CODE_0495E2:
LDA $0E65               ; $04:95E2: AD 65 0E
...
CODE_049606:
LDA #$19                ; $04:9606: A9 19
STA $DB                 ; $04:9608: 85 DB

CODE_04960A:
REP #$30                ; $04:960A: C2 30
...
CODE_049632:
LDA DATA_04AEC3,y       ; $04:9632: B9 C3 AE
...
CODE_049668:
LDA DATA_049679,y       ; $04:9668: B9 79 96
...
CODE_049703:
JSL CODE_048B49         ; $04:9703: 22 49 8B 04
...
; Background colors, indexed by 0744 or BA

DATA_0499ED:
dw $7FF8,$7FF8,$0000,$0000

; Light blue x2, black, indigo, light blue, indigo * 2
...
; Branch if background color != 00
BNE CODE_049A93         ; $04:9A8F: D0 02

; Get level current background palette and music
LDA $BA                 ; $04:9A91: A5 BA

CODE_049A93:
REP #$30                ; $04:9A93: C2 30
AND #$00FF              ; $04:9A95: 29 FF 00
ASL A                   ; $04:9A98: 0A
TAY                     ; $04:9A99: A8
LDA $0743               ; $04:9A9A: AD 43 07
AND #$00FF              ; $04:9A9D: 29 FF 00

; Bonus game flag
;
; branch if not bonus game
BEQ CODE_049AB7         ; $04:9AA0: F0 15
LDA $0744               ; $04:9AA2: AD 44 07
AND #$0004              ; $04:9AA5: 29 04 00

; Branch if background color is $04
BNE CODE_049AB7         ; $04:9AA8: D0 0D
LDA $075A               ; $04:9AAA: AD 5A 07
AND #$0080              ; $04:9AAD: 29 80 00

; Branch if something with lives
BNE CODE_049AB7         ; $04:9AB0: D0 05
LDA #$522A              ; $04:9AB2: A9 2A 52
BRA CODE_049ABA         ; $04:9AB5: 80 03

CODE_049AB7:
LDA DATA_0499ED,y       ; $04:9AB7: B9 ED 99

CODE_049ABA:
STA $1000               ; $04:9ABA: 8D 00 10
...
CODE_049B15:
REP #$20                ; $04:9B15: C2 20
LDX #$00                ; $04:9B17: A2 00

CODE_049B19:
LDA DATA_0499FD,y       ; $04:9B19: B9 FD 99
...
CODE_049B79:
LDA #$14                ; $04:9B79: A9 14

CODE_049B7B:
STA $01                 ; $04:9B7B: 85 01
...
CODE_049BB7:
LDA #$10                ; $04:9BB7: A9 10

CODE_049BB9:
STA $01                 ; $04:9BB9: 85 01
RTS                     ; $04:9BBB: 60

CODE_049BBC:
REP #$30                ; $04:9BBC: C2 30
LDA #$0004              ; $04:9BBE: A9 04 00

; something related to how many background tiles you load as you scroll
STA $0EFA               ; $04:9BC1: 8D FA 0E
LDA $BA                 ; $04:9BC4: A5 BA
AND #$00FF              ; $04:9BC6: 29 FF 00
CMP #$0003              ; $04:9BC9: C9 03 00

; Branch if not Black background with castle music
BNE CODE_049BD1         ; $04:9BCC: D0 03

; When Black background with castle music, do this
ASL $0EFA               ; $04:9BCE: 0E FA 0E

CODE_049BD1:
LDA $7F0000             ; $04:9BD1: AF 00 00 7F
TAY                     ; $04:9BD5: A8

CODE_049BD6:
LDA $00                 ; $04:9BD6: A5 00
...
CODE_049C0E:
LDX $0EF7               ; $04:9C0E: AE F7 0E
STX $04                 ; $04:9C11: 86 04

CODE_049C13:
LDA $7E2000,x           ; $04:9C13: BF 00 20 7E
TYX                     ; $04:9C17: BB
...
; THIS TABLE AND THE NEXT ONE LOOKS LIKE PALETTE DATA

DATA_04AEC3:
dw $42DD,$7FFF,$1084,$3800
...
; Setup program bank
PLB                     ; $04:C00D: AB
JSL CODE_04C01F         ; $04:C00E: 22 1F C0 04

; Jump to level loading routine
; Store the output (level number) here
STA $0750               ; $04:C012: 8D 50 07

; AND the output with $60 (01100000 c)
AND #$60                ; $04:C015: 29 60

; *2 (11000000 c)
ASL A                   ; $04:C017: 0A

; *2 with carry (10000000 C)
ROL A                   ; $04:C018: 2A

; *2 with carry (00000001 C)
ROL A                   ; $04:C019: 2A

; *2 with carry (00000011 c)
ROL A                   ; $04:C01A: 2A

; Store in map type. This means that bits 6 and 5 are the map type!
STA $5C                 ; $04:C01B: 85 5C
PLB                     ; $04:C01D: AB

; Restore original program bank
RTL                     ; $04:C01E: 6B
...
; Setup program bank again.
PLB                     ; $04:C021: AB
LDY $075F               ; $04:C022: AC 5F 07
CPY #$08                ; $04:C025: C0 08

; Load world.
; If it is smaller than world 08
; go setup normal level.
BCC CODE_04C034         ; $04:C027: 90 0B

; Store zero to current level
STZ $0760               ; $04:C029: 9C 60 07

; Store zero to written number of current level
STZ $075C               ; $04:C02C: 9C 5C 07
LDY #$00                ; $04:C02F: A0 00

; Store zero to current world
STY $075F               ; $04:C031: 8C 5F 07

CODE_04C034:
LDA DATA_04C11C,y       ; $04:C034: B9 1C C1
CLC                     ; $04:C037: 18
ADC $0760               ; $04:C038: 6D 60 07

; Load indices to the level number table
; clear carry flag
; add current level to it
; use it as index
TAY                     ; $04:C03B: A8
LDA DATA_04C124,y       ; $04:C03C: B9 24 C1
PLB                     ; $04:C03F: AB
...
; Store zero to current bg palette and music
STZ $BA                 ; $04:C044: 64 BA
LDA $0750               ; $04:C046: AD 50 07
...
; Load level number
;
; Make bit 5 and 6 of the level number
; into bit 0 and 1.
; Values range from 0-3
; Store into map type
; (00 underwater, 01 ground, 02 underground, 03 castle)
STA $5C                 ; $04:C04F: 85 5C

; Transfer A to Y to use it as an index.
TAY                     ; $04:C051: A8
LDA $0750               ; $04:C052: AD 50 07
AND #$1F                ; $04:C055: 29 1F

; Load level number again
; AND with $1F to get the level number WITHOUT map type
; Store into a RAM address to hold it.
STA $074F               ; $04:C057: 8D 4F 07
LDA DATA_04C148,y       ; $04:C05A: B9 48 C1
CLC                     ; $04:C05D: 18
ADC $074F               ; $04:C05E: 6D 4F 07

; Load the map type offsets
; Add the offsets with level number
; Use it as an index again...
TAY                     ; $04:C061: A8
LDA DATA_04C14C,y       ; $04:C062: B9 4C C1
STA $FD                 ; $04:C065: 85 FD
LDA DATA_04C16E,y       ; $04:C067: B9 6E C1
STA $FE                 ; $04:C06A: 85 FE
LDA.b #DATA_04C14C>>16  ; $04:C06C: A9 04

; Load pointers to enemy data
; in $FD-$FF
;
; $FF is a constant: #$04
STA $FF                 ; $04:C06E: 85 FF
LDY $5C                 ; $04:C070: A4 5C
LDA DATA_04C190,y       ; $04:C072: B9 90 C1
CLC                     ; $04:C075: 18
ADC $074F               ; $04:C076: 6D 4F 07
TAY                     ; $04:C079: A8

; Load map type again
;
; Load something again
; add the level number to it
; Use it as an index
; Store it in the layer 2 background.
STA $DB                 ; $04:C07A: 85 DB
CMP #$1C                ; $04:C07C: C9 1C
...
; Setup the pointer of the level header
; and the level object data.
; 24-bits pointer at $FA
; Bank is constant: $04
STA $FC                 ; $04:C09E: 85 FC
LDY #$00                ; $04:C0A0: A0 00
LDA [$FA],y             ; $04:C0A2: B7 FA

; Load level haeder
; Push it into A
PHA                     ; $04:C0A4: 48
AND #$07                ; $04:C0A5: 29 07
CMP #$04                ; $04:C0A7: C9 04

; Get the background bits.
; If it is 04 or smaller
; Branch
BCC CODE_04C0B2         ; $04:C0A9: 90 07
AND #$04                ; $04:C0AB: 29 04

; Filter bit 2
; Store into "BG is lower than 3" flag
STA $0744               ; $04:C0AD: 8D 44 07
LDA #$00                ; $04:C0B0: A9 00

; If BG is lower than 3, use nothing for layer 1 background

CODE_04C0B2:
STA $0741               ; $04:C0B2: 8D 41 07
PLA                     ; $04:C0B5: 68

; Pull level header's first byte
; ...then push it again.
PHA                     ; $04:C0B6: 48
AND #$38                ; $04:C0B7: 29 38
LSR A                   ; $04:C0B9: 4A
LSR A                   ; $04:C0BA: 4A
LSR A                   ; $04:C0BB: 4A

; Filter Mario's starting Y position
;
; >> 3
; so the value is between 0-7 instead of whatever.
; Store into Mario's starting position.
STA $0710               ; $04:C0BC: 8D 10 07

; Pull level header again.
PLA                     ; $04:C0BF: 68

; Filter the time bits.
AND #$C0                ; $04:C0C0: 29 C0
CLC                     ; $04:C0C2: 18
ROL A                   ; $04:C0C3: 2A
ROL A                   ; $04:C0C4: 2A
ROL A                   ; $04:C0C5: 2A
...
; Clear carry flag
; <<3 so the value is between 0-3.
;
; Store into starting timer
STA $0715               ; $04:C0C6: 8D 15 07

; Increase Y.
INY                     ; $04:C0C9: C8

; Load level header byte 2.
LDA [$FA],y             ; $04:C0CA: B7 FA

; Push it into A.
PHA                     ; $04:C0CC: 48
AND #$0F                ; $04:C0CD: 29 0F

; Filter floor set
; Store it into Floor Set RAM address
STA $0727               ; $04:C0CF: 8D 27 07
...
; Push A
PHA                     ; $04:C0D3: 48
AND #$30                ; $04:C0D4: 29 30
LSR A                   ; $04:C0D6: 4A
LSR A                   ; $04:C0D7: 4A
LSR A                   ; $04:C0D8: 4A
LSR A                   ; $04:C0D9: 4A

; Filter ground set and palette bits
;
; >>4 so that the value ranges from 00-03
CMP #$01                ; $04:C0DA: C9 01

; (If the result is not 01 (Orange and mushroom)
BNE CODE_04C0E0         ; $04:C0DC: D0 02
LDA #$00                ; $04:C0DE: A9 00

; and unnecessary LDA.
; Store bits into ground set and palette RAM address.

CODE_04C0E0:
STA $0742               ; $04:C0E0: 8D 42 07
PLA                     ; $04:C0E3: 68
...
ROL A                   ; $04:C0E8: 2A
ROL A                   ; $04:C0E9: 2A
CMP #$03                ; $04:C0EA: C9 03

; Pull level header byte 2 from the stack.
;
; Filter ground set
; make the last 2 bits the first 2 bits.
;
;
; If ground set is clouds, branch.
BNE CODE_04C0F3         ; $04:C0EC: D0 05

; Store bits into "Cloud terrain type override flag"
STA $0743               ; $04:C0EE: 8D 43 07
LDA #$00                ; $04:C0F1: A9 00

; set ground set to none, if ground set is clouds
; otherwise store as normal.

CODE_04C0F3:
STA $0733               ; $04:C0F3: 8D 33 07

; Handle vine growing in the start of level?
JSR CODE_04C10B         ; $04:C0F6: 20 0B C1
LDA $FA                 ; $04:C0F9: A5 FA
CLC                     ; $04:C0FB: 18
ADC #$02                ; $04:C0FC: 69 02
STA $FA                 ; $04:C0FE: 85 FA
LDA $FB                 ; $04:C100: A5 FB
ADC #$00                ; $04:C102: 69 00

; Increase the pointer by 2 so we don't
; need to bother with Y indexing later.
STA $FB                 ; $04:C104: 85 FB

; Store zero to "Counter for the screen's X-pos in 16x16"
STZ $0EE8               ; $04:C106: 9C E8 0E
...
; if cloud terrain type override flag is set

CODE_04C10B:
LDA $0743               ; $04:C10B: AD 43 07

; branch.
BNE CODE_04C116         ; $04:C10E: D0 06
LDA $DB                 ; $04:C110: A5 DB
CMP #$12                ; $04:C112: C9 12

; If layer 2 background is not "Mushrooms"
; Return.
BNE CODE_04C11B         ; $04:C114: D0 05

CODE_04C116:
LDA #$01                ; $04:C116: A9 01

; Grow a vine in the start of level flag?
...
; World 1 | Relative indices to level numbers grouped by world.

DATA_04C11C:
db DATA_04C124-DATA_04C124

; World 2
db DATA_04C129-DATA_04C124

; World 3
db DATA_04C12E-DATA_04C124

; World 4
db DATA_04C132-DATA_04C124

; World 5
db DATA_04C137-DATA_04C124

; World 6
db DATA_04C13B-DATA_04C124

; World 7
db DATA_04C13F-DATA_04C124

; World 8
db DATA_04C144-DATA_04C124

; "World 1 Levels" They get stored in $7E:0750
...
; Relative indices to level sprite data pointer tables

DATA_04C148:
db DATA_04C16B-DATA_04C14C

; Grouped by level type
db DATA_04C152-DATA_04C14C
db DATA_04C168-DATA_04C14C
db DATA_04C14C-DATA_04C14C

; The castle levels sprite data offset low
...
; The overworld levels sprite data offset low
...
; The underground levels sprite data offset low
...
; The underwater levels sprite data offset low
...
; The castle levels sprite data offset high
...
; The overworld levels sprite data offset high
db DATA_04C2C1>>8
db DATA_04C2E6>>8
db DATA_04C303>>8
db DATA_04C311>>8
...
; The underground levels sprite data offset high
db DATA_04C540>>8
db DATA_04C56D>>8
db DATA_04C59B>>8

; The underwater levels sprite data offset high
db DATA_04C5C8>>8
db DATA_04C5D9>>8
db DATA_04C603>>8

; Relative indices to level object data pointer tables

DATA_04C190:
db DATA_04C194-DATA_04C194

; Grouped by level type
db DATA_04C197-DATA_04C194
db DATA_04C1AD-DATA_04C194
db DATA_04C1B0-DATA_04C194

; Underwater levels objects offset low
...
; Overworld levels objects offset low
...
; Underground levels objects offset low
...
; Castle levels objects offset low
...
; Underwater levels objects offset high
...
; Overworld levels objects offset high
db DATA_04CC0B>>8
db DATA_04CC74>>8
db DATA_04CCC3>>8
db DATA_04CD1B>>8
...
; Underground levels objects offset high
db DATA_04D42D>>8
db DATA_04D4D2>>8
db DATA_04D576>>8

; Castle levels objects offset high
db DATA_04C617>>8
db DATA_04C6D2>>8
db DATA_04C7FA>>8
db DATA_04C8D8>>8
...
DATA_04C303:
db $2E,$C2,$66,$E2,$11,$0F,$07,$02
db $11,$0F,$0C,$12,$11,$FF

; 6-2, Level #23

DATA_04C311:
db $0E,$C2,$A8,$AB,$00,$BB,$8E,$6B
...
DATA_04C4F6:
db $AB,$CE,$DE,$42,$C0,$CB,$CE,$5B
db $8E,$1B,$CE,$4B,$85,$67,$45,$0F
db $07,$2B,$00,$7B,$85,$97,$05,$0F
db $0A,$92,$02,$FF

; Sky Bonus Area (Night), Level #34
...
; Underground Bonus Area, Level #C2

DATA_04C59B:
db $1E,$A5,$0A,$2E,$28,$27,$2E,$33
...
; Underwater Bonus Area, Level #00

DATA_04C5C8:
db $3B,$87,$66,$27,$CC,$27,$EE,$31
...
; 8-4 Underwater, Level #02

DATA_04C603:
db $47,$9B,$CB,$07,$FA,$1D,$86,$9B
...
; 4-2 Warpzone, Level #2F

DATA_04D1A3:
db $10,$51,$4C,$00,$C7,$12,$C6,$42
...
CODE_04D800:
LDA $0BA5               ; $04:D800: AD A5 0B

; If skip player animations flag is set, return
...
CODE_04D810:
LDA $09                 ; $04:D810: A5 09
AND #$07                ; $04:D812: 29 07
BNE CODE_04D820         ; $04:D814: D0 0A
LDA $1601               ; $04:D816: AD 01 16
BNE CODE_04D820         ; $04:D819: D0 05
LDA #$04                ; $04:D81B: A9 04

; Play the "Mario is turning sound"
; Every 7 frames
STA $1601               ; $04:D81D: 8D 01 16

CODE_04D820:
STZ $028E               ; $04:D820: 9C 8E 02
...
CODE_04D860:
REP #$20                ; $04:D860: C2 20

; Load amount of loops for palette upload
LDX #$1E                ; $04:D862: A2 1E

; Load 'current character'

CODE_04D864:
LDA $0753               ; $04:D864: AD 53 07

; If it is Mario, branch.
BEQ CODE_04D86F         ; $04:D867: F0 06

; Load Luigi and princess kiss sequence palette
LDA.l DATA_04D8A3,x     ; $04:D869: BF A3 D8 04

; Upload them
BRA CODE_04D873         ; $04:D86D: 80 04

; Load Mario and princess kiss sequence palette

CODE_04D86F:
LDA.l DATA_04D883,x     ; $04:D86F: BF 83 D8 04

; Upload them. (Sequence is after bowser btw)

CODE_04D873:
STA $1160,x             ; $04:D873: 9D 60 11
DEX                     ; $04:D876: CA
DEX                     ; $04:D877: CA
...
; Mario palette of princess kiss sequence
...
; Luigi palette of princess kiss sequence
...
CODE_04D911:
LDA DATA_04D92E,y       ; $04:D911: B9 2E D9
...
; Upload the stripe image message of princess peach to the player
; Exact same copy of 00C0C3. Please refer to bank 00.
BRA CODE_04D911         ; $04:D91C: 80 F3

CODE_04D91E:
STX $1700               ; $04:D91E: 8E 00 17
SEP #$10                ; $04:D921: E2 10
PLX                     ; $04:D923: FA
PLB                     ; $04:D924: AB
RTS                     ; $04:D925: 60

; Relative indices to next table

DATA_04D926:
dw DATA_04D92E-DATA_04D92E
...
CODE_04DC02:
LDA.l DATA_04DC3F,x     ; $04:DC02: BF 3F DC 04
...
; Mario rescued peach movements duration.

DATA_04DC3F:
db $18,$A0,$08,$01,$28,$10,$03,$00

; Note to self: look deeper in this
...
CODE_04DC76:
LDA.l DATA_04DCB4,x     ; $04:DC76: BF B4 DC 04
STA $0F88               ; $04:DC7A: 8D 88 0F

CODE_04DC7D:
LDA $0F87               ; $04:DC7D: AD 87 0F
ASL A                   ; $04:DC80: 0A
TAX                     ; $04:DC81: AA
...
CODE_04DCE9:
LDA.l DATA_04DD4E,x     ; $04:DCE9: BF 4E DD 04

CODE_04DCED:
STA $08B2               ; $04:DCED: 8D B2 08
CLC                     ; $04:DCF0: 18
...
CODE_04DE54:
LDA $70000F             ; $04:DE54: AF 0F 00 70
...
CODE_04DE64:
LDA $075F               ; $04:DE64: AD 5F 07

; Load current world into stack
PHA                     ; $04:DE67: 48
LDA $0E24               ; $04:DE68: AD 24 0E

; Load loaded level into stack
; (always 0 because it's impossible to specify the level number
PHA                     ; $04:DE6B: 48
LDA $07FC               ; $04:DE6C: AD FC 07

; Branch if more difficult flag is set
BNE CODE_04DE77         ; $04:DE6F: D0 06

; set loaded level to 0
STZ $0E24               ; $04:DE71: 9C 24 0E

; Set world to 1
STZ $075F               ; $04:DE74: 9C 5F 07

CODE_04DE77:
PLA                     ; $04:DE77: 68

; Recover loaded level from stack
STA $0E24               ; $04:DE78: 8D 24 0E
PLA                     ; $04:DE7B: 68

; Recover world from stack
STA $075F               ; $04:DE7C: 8D 5F 07

CODE_04DE7F:
LDA #$01                ; $04:DE7F: A9 01
STA $0F82               ; $04:DE81: 8D 82 0F
STZ $0F83               ; $04:DE84: 9C 83 0F

; Clear current demo action being executed
STZ $0717               ; $04:DE87: 9C 17 07
RTL                     ; $04:DE8A: 6B

CODE_04DE8B:
LDA $70000F             ; $04:DE8B: AF 0F 00 70
...
CODE_04DEB8:
LDA #$08                ; $04:DEB8: A9 08
STA $0F80               ; $04:DEBA: 8D 80 0F

CODE_04DEBD:
INC $0F81               ; $04:DEBD: EE 81 0F
...
CODE_04DED5:
LDA DATA_04E2FA,x       ; $04:DED5: BD FA E2
...
CODE_04DEFF:
LDA DATA_04E2FA,x       ; $04:DEFF: BD FA E2
...
CODE_04DF15:
LDX $ED                 ; $04:DF15: A6 ED

CODE_04DF17:
LDA DATA_04E2FA,x       ; $04:DF17: BD FA E2
...
CODE_04DF4E:
LDA DATA_04E2FA,x       ; $04:DF4E: BD FA E2
...
CODE_04DFB8:
SEP #$10                ; $04:DFB8: E2 10
JSR CODE_04E221         ; $04:DFBA: 20 21 E2
PLB                     ; $04:DFBD: AB
RTL                     ; $04:DFBE: 6B

CODE_04DFBF:
LDA $075F               ; $04:DFBF: AD 5F 07
...
CODE_04E00C:
LDA DATA_04E2FA,x       ; $04:E00C: BD FA E2
...
CODE_04E036:
LDA DATA_04E2FA,x       ; $04:E036: BD FA E2
...
CODE_04E04C:
LDX $ED                 ; $04:E04C: A6 ED

CODE_04E04E:
LDA DATA_04E2FA,x       ; $04:E04E: BD FA E2
...
CODE_04E085:
LDA DATA_04E2FA,x       ; $04:E085: BD FA E2
...
CODE_04E11A:
LDA #$09                ; $04:E11A: A9 09
STA $0F80               ; $04:E11C: 8D 80 0F

CODE_04E11F:
INC $0F81               ; $04:E11F: EE 81 0F
...
CODE_04E137:
LDA DATA_04E2FA,x       ; $04:E137: BD FA E2
...
CODE_04E161:
LDA DATA_04E2FA,x       ; $04:E161: BD FA E2
...
CODE_04E177:
LDX $ED                 ; $04:E177: A6 ED

CODE_04E179:
LDA DATA_04E2FA,x       ; $04:E179: BD FA E2
...
; Load char palette
LDA $0753               ; $04:E1AB: AD 53 07

; Store in scratch RAM
STA $00                 ; $04:E1AE: 85 00

; Load data

CODE_04E1B0:
LDA DATA_04E2FA,x       ; $04:E1B0: BD FA E2

; ORA with char palette. 01 = luigi
ORA $00                 ; $04:E1B3: 05 00

; ORA #$20
ORA #$20                ; $04:E1B5: 09 20
...
CODE_04E21A:
SEP #$10                ; $04:E21A: E2 10
JSR CODE_04E221         ; $04:E21C: 20 21 E2
PLB                     ; $04:E21F: AB
RTL                     ; $04:E220: 6B

CODE_04E221:
LDA $0753               ; $04:E221: AD 53 07
...
; These tables are for the Princess kiss Mario-
; Sequence. This is table 0, next one is 1 etc
; The even-numbered tables are for the Princess
; The odd-numbered tables are for Mario/Luigi.
; The format of these bytes are the following:
; $XX,$YY,$TT,$PP
; XX = Xpos, YY = Ypos, TT = Tile, PP = Priority
; basically the OAM format.
db $FF

; These huge tables took ages to sort out...
...
CODE_04ECED:
LDA #$C000              ; $04:ECED: A9 00 C0

CODE_04ECF0:
STA $0285               ; $04:ECF0: 8D 85 02
...
CODE_04EDAA:
LDA #$00                ; $04:EDAA: A9 00
STA $0F7D               ; $04:EDAC: 8D 7D 0F

CODE_04EDAF:
STA $00                 ; $04:EDAF: 85 00
...
CODE_04EDDD:
LDA #$80                ; $04:EDDD: A9 80

CODE_04EDDF:
STA $0902               ; $04:EDDF: 8D 02 09
INC A                   ; $04:EDE2: 1A
...
CODE_04EE38:
LDA PNTR_04EE45,x       ; $04:EE38: BD 45 EE
...
CODE_04EEC7:
DEC $0B9F               ; $04:EEC7: CE 9F 0B

CODE_04EECA:
LDA $03AE               ; $04:EECA: AD AE 03
...
CODE_04EF04:
JSR CODE_04FD66         ; $04:EF04: 20 66 FD
...
CODE_04EF4C:
DEC $0B9F               ; $04:EF4C: CE 9F 0B

CODE_04EF4F:
LDA $03AE               ; $04:EF4F: AD AE 03
...
CODE_04EFF7:
JSR CODE_04F031         ; $04:EFF7: 20 31 F0
JMP CODE_04F9D5         ; $04:EFFA: 4C D5 F9

CODE_04EFFD:
LDY #$A0                ; $04:EFFD: A0 A0
...
CODE_04F00C:
JSR CODE_04F0ED         ; $04:F00C: 20 ED F0
BRA CODE_04F014         ; $04:F00F: 80 03

CODE_04F011:
JSR CODE_04F124         ; $04:F011: 20 24 F1

CODE_04F014:
INC $0BA0               ; $04:F014: EE A0 0B

CODE_04F017:
LDA $03AE               ; $04:F017: AD AE 03
...
CODE_04F065:
JSR CODE_04F9FC         ; $04:F065: 20 FC F9
TYA                     ; $04:F068: 98
CLC                     ; $04:F069: 18
...
CODE_04F085:
JSR CODE_04F9FC         ; $04:F085: 20 FC F9
...
CODE_04F19C:
JSR CODE_04F1D7         ; $04:F19C: 20 D7 F1
JMP CODE_04F9D5         ; $04:F19F: 4C D5 F9

CODE_04F1A2:
LDA $0BA1               ; $04:F1A2: AD A1 0B
...
CODE_04F1AE:
JSR CODE_04FD29         ; $04:F1AE: 20 29 FD
LDA #$02                ; $04:F1B1: A9 02

CODE_04F1B3:
STA $0B9E               ; $04:F1B3: 8D 9E 0B
LDX #$03                ; $04:F1B6: A2 03
LDY #$00                ; $04:F1B8: A0 00

CODE_04F1BA:
LDA $0BB0,x             ; $04:F1BA: BD B0 0B
...
CODE_04F1D7:
JSR CODE_04FD66         ; $04:F1D7: 20 66 FD
...
CODE_04F260:
DEC $0BB2               ; $04:F260: CE B2 0B

CODE_04F263:
STA $01                 ; $04:F263: 85 01
TYA                     ; $04:F265: 98
CLC                     ; $04:F266: 18
...
CODE_04F297:
INC $0BB3               ; $04:F297: EE B3 0B

CODE_04F29A:
STA $01                 ; $04:F29A: 85 01
TYA                     ; $04:F29C: 98
CLC                     ; $04:F29D: 18
...
CODE_04F2AB:
LDY #$B0                ; $04:F2AB: A0 B0
LDX #$00                ; $04:F2AD: A2 00

CODE_04F2AF:
LDA $03AE               ; $04:F2AF: AD AE 03
...
CODE_04F2EB:
LDA DATA_04F388,x       ; $04:F2EB: BD 88 F3
...
; SMW cape dive sound
STA $1600               ; $04:F350: 8D 00 16
RTS                     ; $04:F353: 60

CODE_04F354:
STA $0DB0               ; $04:F354: 8D B0 0D
...
CODE_04F361:
STA $0DB0               ; $04:F361: 8D B0 0D
STA $0DC8               ; $04:F364: 8D C8 0D
STA $0DCC               ; $04:F367: 8D CC 0D
LDA #$09                ; $04:F36A: A9 09

; SMW cape dive sound
STA $1600               ; $04:F36C: 8D 00 16
RTS                     ; $04:F36F: 60

CODE_04F370:
STA $0DC8               ; $04:F370: 8D C8 0D
...
CODE_04F3EA:
STA $00A1               ; $04:F3EA: 8D A1 00

CODE_04F3ED:
INC $0B9F               ; $04:F3ED: EE 9F 0B
...
; Reset highscore sound
STA $1600               ; $04:F3FB: 8D 00 16

CODE_04F3FE:
LDA #$45                ; $04:F3FE: A9 45
...
CODE_04F40C:
JSR CODE_04F586         ; $04:F40C: 20 86 F5
JMP CODE_04F9D5         ; $04:F40F: 4C D5 F9

CODE_04F412:
LDA $03AE               ; $04:F412: AD AE 03
CLC                     ; $04:F415: 18
...
CODE_04F556:
LDX #$03                ; $04:F556: A2 03

CODE_04F558:
LDA $0BB8,x             ; $04:F558: BD B8 0B
LSR A                   ; $04:F55B: 4A
LSR A                   ; $04:F55C: 4A
LSR A                   ; $04:F55D: 4A
TAY                     ; $04:F55E: A8
...
CODE_04F5BF:
LDA DATA_04F5DA,x       ; $04:F5BF: BD DA F5
...
CODE_04F69B:
JSR CODE_04F74C         ; $04:F69B: 20 4C F7
...
LDA #$0E                ; $04:F841: A9 0E

; Swimming sound
STA $1600               ; $04:F843: 8D 00 16

CODE_04F846:
LDA $0BA0               ; $04:F846: AD A0 0B
...
; SMB2 pick up vegetable sound
STA $1600               ; $04:F8D3: 8D 00 16
STA $0BA4               ; $04:F8D6: 8D A4 0B

CODE_04F8D9:
JMP CODE_04F9D5         ; $04:F8D9: 4C D5 F9
...
CODE_04F917:
LDA DATA_04F9B5,x       ; $04:F917: BD B5 F9
...
CODE_04F945:
LDA #$C0                ; $04:F945: A9 C0

CODE_04F947:
STA $091D               ; $04:F947: 8D 1D 09
...
CODE_04FBA4:
LDA #$0F                ; $04:FBA4: A9 0F

; SMW hit during cape flight sound
STA $1600               ; $04:FBA6: 8D 00 16
...
CODE_04FD61:
JSL CODE_048600         ; $04:FD61: 22 00 86 04
RTS                     ; $04:FD65: 60

CODE_04FD66:
LDA $0BA4               ; $04:FD66: AD A4 0B
...
CODE_04FD74:
REP #$20                ; $04:FD74: C2 20
PHD                     ; $04:FD76: 0B
LDA #$1700              ; $04:FD77: A9 00 17
...
LDA #$0019              ; $04:FD85: A9 19 00
STA $06                 ; $04:FD88: 85 06

; "U" With no properties
LDA #$001E              ; $04:FD8A: A9 1E 00
STA $08                 ; $04:FD8D: 85 08

; "S" With no properties
LDA #$001C              ; $04:FD8F: A9 1C 00
STA $0A                 ; $04:FD92: 85 0A

; "H" With no properties
LDA #$0011              ; $04:FD94: A9 11 00
STA $0C                 ; $04:FD97: 85 0C

; " " With no properties
LDA #$0028              ; $04:FD99: A9 28 00
STA $0E                 ; $04:FD9C: 85 0E

; "S" With no properties
LDA #$001C              ; $04:FD9E: A9 1C 00
STA $10                 ; $04:FDA1: 85 10

; "T" With no properties
LDA #$001D              ; $04:FDA3: A9 1D 00
STA $12                 ; $04:FDA6: 85 12

; "A" With no properties
LDA #$000A              ; $04:FDA8: A9 0A 00
STA $14                 ; $04:FDAB: 85 14

; "R" With no properties
LDA #$001B              ; $04:FDAD: A9 1B 00
STA $16                 ; $04:FDB0: 85 16

; "T" With no properties
LDA #$001D              ; $04:FDB2: A9 1D 00
STA $18                 ; $04:FDB5: 85 18
SEP #$20                ; $04:FDB7: E2 20

; "End of tilemap marker" byte (?)
LDA #$FF                ; $04:FDB9: A9 FF
STA $1A                 ; $04:FDBB: 85 1A
PLD                     ; $04:FDBD: 2B
LDA #$15                ; $04:FDBE: A9 15
...
; Store zero to BG1 X-scrolling

CODE_04FDC4:
STZ $073F               ; $04:FDC4: 9C 3F 07

; Store zero to BG1 Y-scrolling
STZ $0740               ; $04:FDC7: 9C 40 07

; Store zero to BG1 X-scrolling
STZ $210D               ; $04:FDCA: 9C 0D 21

; Store zero to BG1 X-scrolling
STZ $210D               ; $04:FDCD: 9C 0D 21

; Store zero to BG1 Y-scrolling
STZ $210E               ; $04:FDD0: 9C 0E 21

; Store zero to BG1 Y-scrolling
STZ $210E               ; $04:FDD3: 9C 0E 21

; Store zero to BG2 X-scrolling
STZ $210F               ; $04:FDD6: 9C 0F 21

; Store zero to BG2 X-scrolling
STZ $210F               ; $04:FDD9: 9C 0F 21

; Store zero to BG2 Y-scrolling
STZ $2110               ; $04:FDDC: 9C 10 21

; Store zero to BG2 Y-scrolling
STZ $2110               ; $04:FDDF: 9C 10 21

; Store zero to BG3 X-scrolling
STZ $2111               ; $04:FDE2: 9C 11 21

; Store zero to BG3 X-scrolling
STZ $2111               ; $04:FDE5: 9C 11 21

; Store zero to BG3 Y-scrolling
STZ $2112               ; $04:FDE8: 9C 12 21

; Store zero to BG3 Y-scrolling
STZ $2112               ; $04:FDEB: 9C 12 21
