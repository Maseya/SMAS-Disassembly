...
CODE_048286:        TAY                       ;
CODE_048287:        PHY                       ;
CODE_048288:        LDA $824E,y               ;
CODE_04828B:        STA $01                   ;
CODE_04828D:        LDX $823E,y               ;
CODE_048290:        LDY #$00                  ;
CODE_048292:        LDA $83AC,x               ;\
CODE_048295:        STA $1520,y               ; |
CODE_048298:        LDA $840E,x               ; |
CODE_04829B:        STA $1560,y               ; |Copy indirect HDMA pointers to RAM until you're done
CODE_04829E:        LDA $8470,x               ; |
...
CODE_0482AA:        PLY                       ;
CODE_0482AB:        LDA $8256,y               ;
CODE_0482AE:        STA $01                   ;
CODE_0482B0:        LDX $8246,y               ;
CODE_0482B3:        LDY #$00                  ;
CODE_0482B5:        LDA $84D2,x               ;
CODE_0482B8:        STA $1400,y               ;
CODE_0482BB:        LDA $8512,x               ;
CODE_0482BE:        STA $1460,y               ;
CODE_0482C1:        LDA $8552,x               ;
...
CODE_048383:        LDA $8368,x               ;
CODE_048386:        STA $15E0                 ;
CODE_048389:        LDY $8360,x               ;
CODE_04838C:        LDA $1520,y               ;
CODE_04838F:        CLC                       ;
CODE_048390:        ADC $8370,x               ;
...
CODE_0488CA:        LDX $F3                   ;
CODE_0488CC:        SEP #$20                  ;
CODE_0488CE:        LDA $048949,x             ;
CODE_0488D2:        CLC                       ;
CODE_0488D3:        ROL A                     ;
CODE_0488D4:        ROL A                     ;
CODE_0488D5:        AND #$01                  ;
CODE_0488D7:        STA $F5                   ;
CODE_0488D9:        LDA $04894A,x             ;
CODE_0488DD:        ASL A                     ;
CODE_0488DE:        REP #$21                  ;
CODE_0488E0:        LDX $F7                   ;
CODE_0488E2:        ADC $F5                   ;
...
CODE_048BB1:        TAY                       ;
CODE_048BB2:        PLX                       ;
CODE_048BB3:        LDA $BD09,y               ;
CODE_048BB6:        STA $7F2004,x             ;
CODE_048BBA:        LDA $BD0B,y               ;
CODE_048BBD:        STA $7F2006,x             ;
CODE_048BC1:        LDA $BD0D,y               ;
CODE_048BC4:        STA $7F203E,x             ;
CODE_048BC8:        LDA $BD0F,y               ;
...
CODE_04902F:        LDX $9012,y               ;
CODE_049032:        LDA $9009,y               ;
CODE_049035:        TAY                       ;
CODE_049036:        LDA #$64                  ;
...
CODE_0491A2:        CLC                       ;
CODE_0491A3:        LDY $06                   ;
CODE_0491A5:        LDA $9176,y               ;
CODE_0491A8:        STA $06A1,x               ;
CODE_0491AB:        LDA $917A,y               ;
...
CODE_04942E:        ASL A                     ;
CODE_04942F:        TAX                       ;
CODE_049430:        LDA $927E,x               ;
CODE_049433:        TAX                       ;
CODE_049434:        LDA $9DEB,x               ;
...
CODE_049618:        STZ $02                   ;
CODE_04961A:        LDY $06                   ;
CODE_04961C:        LDA $97CD,y               ;
CODE_04961F:        AND #$00FF                ;
CODE_049622:        INY                       ;
CODE_049623:        STY $06                   ;
CODE_049625:        ASL A                     ;
CODE_049626:        TAX                       ;
CODE_049627:        LDA $AE3F,x               ;
CODE_04962A:        TAY                       ;
CODE_04962B:        LDX $02                   ;
CODE_04962D:        LDA #$0007                ;
CODE_049630:        STA $04                   ;
CODE_049632:        LDA $AEC3,y               ;
CODE_049635:        STA $1000,x               ;
CODE_049638:        LDA $AED3,y               ;
...
CODE_049B15:        REP #$20                  ;
CODE_049B17:        LDX #$00                  ;
CODE_049B19:        LDA $99FD,y               ;
CODE_049B1C:        STA $11E0,x               ;
CODE_049B1F:        LDA $9A0D,y               ;
...
CODE_04C090:        INC $BA                   ;/
CODE_04C092:        LDA $C194,y               ;\
CODE_04C095:        STA $FA                   ; |
CODE_04C097:        LDA $C1B6,y               ; |Setup the pointer of the level header
...
CODE_04D869:        LDA $04D8A3,x             ;Load Luigi and princess kiss sequence palette
CODE_04D86D:        BRA CODE_04D873           ;Upload them

CODE_04D86F:        LDA $04D883,x             ;Load Mario and princess kiss sequence palette
...
CODE_04D90A:        LDX $D926,y               ; |
CODE_04D90D:        TXY                       ; |
CODE_04D90E:        LDX $1700                 ; |
CODE_04D911:        LDA $D92E,y               ; |
...
CODE_04DC76:        LDA $04DCB4,x             ;
CODE_04DC7A:        STA $0F88                 ;
CODE_04DC7D:        LDA $0F87                 ;
CODE_04DC80:        ASL A                     ;
CODE_04DC81:        TAX                       ;
CODE_04DC82:        LDA $04DC91,x             ;
CODE_04DC86:        STA $00                   ;
CODE_04DC88:        LDA $04DC92,x             ;
CODE_04DC8C:        STA $01                   ;
...
CODE_04DCE1:        LDA $04DD4E,x             ;
CODE_04DCE5:        INC A                     ;
CODE_04DCE6:        INC A                     ;
CODE_04DCE7:        BRA CODE_04DCED           ;

CODE_04DCE9:        LDA $04DD4E,x             ;
...
CODE_04DEC7:        REP #$10                  ;
CODE_04DEC9:        TAY                       ;
CODE_04DECA:        LDX $E2B4,y               ;
CODE_04DECD:        STX $ED                   ;
CODE_04DECF:        LDX $E280,y               ;
CODE_04DED2:        LDY #$0004                ;
CODE_04DED5:        LDA $E2FA,x               ;
CODE_04DED8:        CMP #$FF                  ;
...
CODE_04DEE2:        INX                       ;
CODE_04DEE3:        LDA $E2FA,x               ;
CODE_04DEE6:        CLC                       ;
CODE_04DEE7:        ADC #$C0                  ;
CODE_04DEE9:        STA $0800,y               ;
CODE_04DEEC:        INX                       ;
CODE_04DEED:        LDA $E2FA,x               ;
...
CODE_04DFFE:        REP #$10                  ;
CODE_04E000:        TAY                       ;
CODE_04E001:        LDX $E2C6,y               ;
CODE_04E004:        STX $ED                   ;
CODE_04E006:        LDX $E280,y               ;
CODE_04E009:        LDY #$0004                ;
CODE_04E00C:        LDA $E2FA,x               ;
CODE_04E00F:        CMP #$FF                  ;
...
CODE_04E019:        INX                       ;
CODE_04E01A:        LDA $E2FA,x               ;
CODE_04E01D:        CLC                       ;
CODE_04E01E:        ADC #$C0                  ;
CODE_04E020:        STA $0800,y               ;
CODE_04E023:        INX                       ;
CODE_04E024:        LDA $E2FA,x               ;
...
CODE_04E129:        REP #$10                  ;
CODE_04E12B:        TAY                       ;
CODE_04E12C:        LDX $E2E6,y               ;
CODE_04E12F:        STX $ED                   ;
CODE_04E131:        LDX $E2A0,y               ;
CODE_04E134:        LDY #$0004                ;
CODE_04E137:        LDA $E2FA,x               ;
CODE_04E13A:        CMP #$FF                  ;
...
CODE_04E144:        INX                       ;
CODE_04E145:        LDA $E2FA,x               ;
CODE_04E148:        CLC                       ;
CODE_04E149:        ADC #$C0                  ;
CODE_04E14B:        STA $0800,y               ;
CODE_04E14E:        INX                       ;
CODE_04E14F:        LDA $E2FA,x               ;
...
CODE_04E1B0:        LDA $E2FA,x               ;Load data
...
CODE_04EE38:        LDA $EE45,x               ;
CODE_04EE3B:        STA $00                   ;
CODE_04EE3D:        LDA $EE46,x               ;
CODE_04EE40:        STA $01                   ;
...
CODE_04F2B5:        LDA $F38F,x               ;
CODE_04F2B8:        STA $0901,y               ;
CODE_04F2BB:        LDA $F390,x               ;
...
CODE_04F2F9:        ASL A                     ;
CODE_04F2FA:        TAX                       ;
CODE_04F2FB:        LDA $F37A,x               ;
CODE_04F2FE:        STA $00                   ;
CODE_04F300:        LDA $F37B,x               ;
CODE_04F303:        STA $01                   ;
CODE_04F305:        LDA #$01                  ;
...
CODE_04F5BB:        LDA #$04                  ;
CODE_04F5BD:        STA $00                   ;
CODE_04F5BF:        LDA $F5DA,x               ;
CODE_04F5C2:        STA $0902,y               ;
CODE_04F5C5:        LDA $F5EA,x               ;
...
CODE_04FA20:        LDA $FA4B,x               ;
CODE_04FA23:        STA $0902,y               ;
CODE_04FA26:        LDA $FA4C,x               ;
CODE_04FA29:        STA $0906,y               ;
CODE_04FA2C:        LDA $FA4D,x               ;
CODE_04FA2F:        STA $090A,y               ;
CODE_04FA32:        LDA $FA63,x               ;
CODE_04FA35:        STA $0903,y               ;
CODE_04FA38:        LDA $FA64,x               ;
CODE_04FA3B:        STA $0907,y               ;
CODE_04FA3E:        LDA $FA65,x               ;
...
CODE_04FA98:        ASL A                     ;
CODE_04FA99:        TAX                       ;
CODE_04FA9A:        LDA $FAA7,x               ;
CODE_04FA9D:        STA $00                   ;
CODE_04FA9F:        LDA $FAA8,x               ;
CODE_04FAA2:        STA $01                   ;
...
CODE_04FBD5:        ASL A                     ;
CODE_04FBD6:        TAX                       ;
CODE_04FBD7:        LDA $FBE4,x               ;
CODE_04FBDA:        STA $00                   ;
CODE_04FBDC:        LDA $FBE5,x               ;
CODE_04FBDF:        STA $01                   ;
